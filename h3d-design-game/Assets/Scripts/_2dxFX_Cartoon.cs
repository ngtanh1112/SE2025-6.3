	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_ColorLevel", this._ColorLevel);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_EdgeSize", this._EdgeSize);
				return;
			}
