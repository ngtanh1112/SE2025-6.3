  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord3 = (in_v.color * float4(float4(_Color, _Color, _Color, _Color)));
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = ((u_xlat16_0 * 0.333333343) + (-_Distortion));
          u_xlat0_d.x = (u_xlat0_d.x * 10000);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat3 = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat1_d.xyz = (u_xlat0_d.xxx * float3(u_xlat3, u_xlat3, u_xlat3));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord.xy = TRANSFORM_TEX(in_v.texcoord.xy, _MainTex);
          out_v.texcoord2 = (in_v.color * float4(float4(_Color, _Color, _Color, _Color)));
