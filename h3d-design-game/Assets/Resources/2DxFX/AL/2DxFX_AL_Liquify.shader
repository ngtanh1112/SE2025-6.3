Shader "2DxFX/AL/Liquify"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (in_f.texcoord.x * 16);
          u_xlat4_d.x = (TurnToLiquid + 1);
          u_xlat0_d.x = (u_xlat4_d.x * u_xlat0_d.x);
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * TurnToLiquid);
          u_xlat4_d.x = ((u_xlat0_d.x * 0.5) + 1);
          u_xlat0_d.x = (u_xlat0_d.x * 0.5);
          u_xlat8 = (((-TurnToLiquid) * 2) + 1);
          u_xlat8 = ((-u_xlat8) + 1.03999996);
          u_xlat4_d.x = (u_xlat4_d.x / u_xlat8);
          u_xlat8 = ((-in_f.texcoord.y) + 1);
          u_xlat0_d.x = ((u_xlat4_d.x * u_xlat8) + (-u_xlat0_d.x));
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat4_d.x = (in_f.texcoord.x * _Distortion);
          u_xlat4_d.x = sin(u_xlat4_d.x);
          u_xlat4_d.x = (u_xlat4_d.x * TurnToLiquid);
          u_xlat0_d.x = ((u_xlat4_d.x * 0.333333343) + u_xlat0_d.x);
          u_xlat0_d.x = ((TurnToLiquid * 0.5) + u_xlat0_d.x);
          u_xlat1_d.w = (u_xlat0_d.x + in_f.texcoord.y);
          u_xlat4_d.x = (in_f.texcoord.y + TurnToLiquid);
          u_xlat1_d.y = (u_xlat4_d.x + (-0.5));
          u_xlat1_d.xz = in_f.texcoord.xx;
          u_xlat4_d.xy = (u_xlat1_d.xy * float2(0.333333343, 0.333333343));
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat4_d.xy).xyz;
          u_xlat1_d.x = (TurnToLiquid * 20);
          u_xlat4_d.xyz = (u_xlat10_4.xyz * u_xlat1_d.xxx);
          u_xlat1_d.xy = ((u_xlat4_d.xy * float2(0.0625, 0.0625)) + u_xlat1_d.zw);
          u_xlat1_d.xy = (u_xlat1_d.xy + (-float2(float2(TurnToLiquid, TurnToLiquid))));
          u_xlat9 = (u_xlat1_d.y + 0.400000006);
          u_xlat10_2 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat2 = (u_xlat10_2 * in_f.texcoord3);
          u_xlat1_d.x = dot(float2(u_xlat9, u_xlat9), float2(float2(TurnToLiquid, TurnToLiquid)));
          u_xlat1_d.x = ((-u_xlat1_d.x) + 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat2.w);
          u_xlat5.xyz = ((u_xlat0_d.xxx * float3(0.5, 0.5, 0.5)) + u_xlat2.xyz);
          u_xlat0_d.xyz = ((u_xlat4_d.xyz * float3(0.125, 0.125, 0.125)) + u_xlat5.xyz);
          u_xlat12 = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat1_d.x * u_xlat12) + (-0.0500000007));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (in_f.texcoord.x * 16);
          u_xlat4.x = (TurnToLiquid + 1);
          u_xlat0_d.x = (u_xlat4.x * u_xlat0_d.x);
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * TurnToLiquid);
          u_xlat4.x = ((u_xlat0_d.x * 0.5) + 1);
          u_xlat0_d.x = (u_xlat0_d.x * 0.5);
          u_xlat8 = (((-TurnToLiquid) * 2) + 1);
          u_xlat8 = ((-u_xlat8) + 1.03999996);
          u_xlat4.x = (u_xlat4.x / u_xlat8);
          u_xlat8 = ((-in_f.texcoord.y) + 1);
          u_xlat0_d.x = ((u_xlat4.x * u_xlat8) + (-u_xlat0_d.x));
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat4.x = (in_f.texcoord.x * _Distortion);
          u_xlat4.x = sin(u_xlat4.x);
          u_xlat4.x = (u_xlat4.x * TurnToLiquid);
          u_xlat0_d.x = ((u_xlat4.x * 0.333333343) + u_xlat0_d.x);
          u_xlat0_d.x = ((TurnToLiquid * 0.5) + u_xlat0_d.x);
          u_xlat1_d.w = (u_xlat0_d.x + in_f.texcoord.y);
          u_xlat4.x = (in_f.texcoord.y + TurnToLiquid);
          u_xlat1_d.y = (u_xlat4.x + (-0.5));
          u_xlat1_d.xz = in_f.texcoord.xx;
          u_xlat4.xy = (u_xlat1_d.xy * float2(0.333333343, 0.333333343));
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz;
          u_xlat1_d.x = (TurnToLiquid * 20);
          u_xlat4.xyz = (u_xlat10_4.xyz * u_xlat1_d.xxx);
          u_xlat1_d.xy = ((u_xlat4.xy * float2(0.0625, 0.0625)) + u_xlat1_d.zw);
          u_xlat1_d.xy = (u_xlat1_d.xy + (-float2(float2(TurnToLiquid, TurnToLiquid))));
          u_xlat9 = (u_xlat1_d.y + 0.400000006);
          u_xlat10_2 = tex2D(_MainTex, u_xlat1_d.xy);
          ...
          u_xlat1_d.x = dot(float2(u_xlat9, u_xlat9), float2(float2(TurnToLiquid, TurnToLiquid)));
          u_xlat1_d.x = ((-u_xlat1_d.x) + 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat2_d.w);
          u_xlat5.xyz = ((u_xlat0_d.xxx * float3(0.5, 0.5, 0.5)) + u_xlat2_d.xyz);
          u_xlat0_d.xyz = ((u_xlat4.xyz * float3(0.125, 0.125, 0.125)) + u_xlat5.xyz);
          u_xlat12 = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat1_d.x * u_xlat12) + (-0.0500000007));
          u_xlat12 = (u_xlat12 * u_xlat1_d.x);
          u_xlatb1 = (u_xlat16_3.x<0);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * TurnToLiquid);
          u_xlat3 = ((u_xlat0_d.x * 0.5) + 1);
          u_xlat0_d.x = (u_xlat0_d.x * 0.5);
          u_xlat6_d = (((-TurnToLiquid) * 2) + 1);
          u_xlat6_d = ((-u_xlat6_d) + 1.03999996);
          u_xlat3 = (u_xlat3 / u_xlat6_d);
          u_xlat6_d = ((-in_f.texcoord.y) + 1);
          u_xlat0_d.x = ((u_xlat3 * u_xlat6_d) + (-u_xlat0_d.x));
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat3 = (in_f.texcoord.x * _Distortion);
          u_xlat3 = sin(u_xlat3);
          u_xlat3 = (u_xlat3 * TurnToLiquid);
          u_xlat0_d.x = ((u_xlat3 * 0.333333343) + u_xlat0_d.x);
          u_xlat0_d.x = ((TurnToLiquid * 0.5) + u_xlat0_d.x);
          u_xlat0_d.w = (u_xlat0_d.x + in_f.texcoord.y);
          u_xlat1_d = (in_f.texcoord.y + TurnToLiquid);
          u_xlat0_d.y = (u_xlat1_d + (-0.5));
          u_xlat0_d.xz = in_f.texcoord.xx;
          u_xlat0_d.xy = (u_xlat0_d.xy * float2(0.333333343, 0.333333343));
          u_xlat10_0.xy = tex2D(_MainTex2, u_xlat0_d.xy).xy;
          u_xlat1_d = (TurnToLiquid * 20);
          u_xlat0_d.xy = (u_xlat10_0.xy * float2(u_xlat1_d, u_xlat1_d));
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.0625, 0.0625)) + u_xlat0_d.zw);
          u_xlat0_d.xy = (u_xlat0_d.xy + (-float2(float2(TurnToLiquid, TurnToLiquid))));
          u_xlat6_d = (u_xlat0_d.y + 0.400000006);
          u_xlat10_0.x = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0.x * in_f.texcoord3.w);
          u_xlat3 = dot(float2(u_xlat6_d, u_xlat6_d), float2(float2(TurnToLiquid, TurnToLiquid)));
          u_xlat3 = ((-u_xlat3) + 1);
          u_xlat0_d.x = (u_xlat3 * u_xlat0_d.x);
          u_xlat3 = ((-_Alpha) + 1);
          u_xlat16_2 = ((u_xlat0_d.x * u_xlat3) + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.x = ((u_xlat0_d.x * 0.5) + 1);
          u_xlat0_d.x = (u_xlat0_d.x * 0.5);
          u_xlat8_d = (((-TurnToLiquid) * 2) + 1);
          u_xlat8_d = ((-u_xlat8_d) + 1.03999996);
          u_xlat4.x = (u_xlat4.x / u_xlat8_d);
          u_xlat8_d = ((-in_f.texcoord.y) + 1);
          u_xlat0_d.x = ((u_xlat4.x * u_xlat8_d) + (-u_xlat0_d.x));
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat4.x = (in_f.texcoord.x * _Distortion);
          u_xlat4.x = sin(u_xlat4.x);
          ...
          u_xlat0_d.xyz = ((u_xlat4.xyz * float3(0.125, 0.125, 0.125)) + u_xlat5.xyz);
          u_xlat12_d = ((-_Alpha) + 1);
          u_xlat16_3_d.x = ((u_xlat1_d.x * u_xlat12_d) + (-0.0500000007));
          u_xlat12_d = (u_xlat12_d * u_xlat1_d.x);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = ((u_xlat4_d.xyz * float3(0.125, 0.125, 0.125)) + u_xlat5.xyz);
          u_xlat12 = ((-_Alpha) + 1);
          u_xlat16_3 = ((u_xlat1_d.x * u_xlat12) + (-0.0500000007));
          u_xlat12 = (u_xlat12 * u_xlat1_d.x);
          u_xlat0_d.xyz = (float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat3_d * u_xlat0_d.x);
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * TurnToLiquid);
          u_xlat3_d = ((u_xlat0_d.x * 0.5) + 1);
          u_xlat0_d.x = (u_xlat0_d.x * 0.5);
          u_xlat6 = (((-TurnToLiquid) * 2) + 1);
          u_xlat6 = ((-u_xlat6) + 1.03999996);
          u_xlat3_d = (u_xlat3_d / u_xlat6);
          u_xlat6 = ((-in_f.texcoord1.y) + 1);
          u_xlat0_d.x = ((u_xlat3_d * u_xlat6) + (-u_xlat0_d.x));
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat3_d = (in_f.texcoord1.x * _Distortion);
          u_xlat3_d = sin(u_xlat3_d);
          u_xlat3_d = (u_xlat3_d * TurnToLiquid);
          u_xlat0_d.x = ((u_xlat3_d * 0.333333343) + u_xlat0_d.x);
          u_xlat0_d.x = ((TurnToLiquid * 0.5) + u_xlat0_d.x);
          u_xlat0_d.w = (u_xlat0_d.x + in_f.texcoord1.y);
          u_xlat1_d = (in_f.texcoord1.y + TurnToLiquid);
          u_xlat0_d.y = (u_xlat1_d + (-0.5));
          u_xlat0_d.xz = in_f.texcoord1.xx;
          u_xlat0_d.xy = (u_xlat0_d.xy * float2(0.333333343, 0.333333343));
          u_xlat10_0.xy = tex2D(_MainTex2, u_xlat0_d.xy).xy;
          u_xlat1_d = (TurnToLiquid * 20);
          u_xlat0_d.xy = (u_xlat10_0.xy * float2(u_xlat1_d, u_xlat1_d));
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.0625, 0.0625)) + u_xlat0_d.zw);
          u_xlat0_d.xy = (u_xlat0_d.xy + (-float2(float2(TurnToLiquid, TurnToLiquid))));
          u_xlat6 = (u_xlat0_d.y + 0.400000006);
          u_xlat10_0.x = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0.x * in_f.texcoord3.w);
          u_xlat3_d = dot(float2(u_xlat6, u_xlat6), float2(float2(TurnToLiquid, TurnToLiquid)));
          u_xlat3_d = ((-u_xlat3_d) + 1);
          u_xlat0_d.x = (u_xlat3_d * u_xlat0_d.x);
          u_xlat3_d = ((-_Alpha) + 1);
          u_xlat16_2 = ((u_xlat0_d.x * u_xlat3_d) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_2<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
