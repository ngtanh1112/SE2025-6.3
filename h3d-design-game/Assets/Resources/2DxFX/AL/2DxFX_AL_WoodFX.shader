  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = (in_f.texcoord.xy + float2(-0.0500000007, 0.0199999996));
          u_xlat10 = (((-u_xlat2.x) * 20) + 46.0999985);
          u_xlat10 = sin(u_xlat10);
          u_xlat3.xyz = ((u_xlat2.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat10_2.xyw = tex2D(_MainTex, u_xlat2.xy).xyz;
          u_xlat16_2 = dot(u_xlat10_2.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat3.xyz = sin(u_xlat3.xyz);
          u_xlat6_d.x = (u_xlat10 + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x + 5);
          u_xlat10 = (u_xlat6_d.x * 0.200000003);
          u_xlat10 = floor(u_xlat10);
          u_xlat6_d.x = ((u_xlat6_d.x * 0.200000003) + (-u_xlat10));
          u_xlat2.x = ((u_xlat6_d.x * _Deep) + u_xlat16_2);
          u_xlat6_d.x = (u_xlat2.x * _Deep);
          u_xlat6_d.x = floor(u_xlat6_d.x);
          u_xlat2.x = ((u_xlat2.x * _Deep) + (-u_xlat6_d.x));
          u_xlat6_d.x = ((u_xlat2.x * 6) + (-2));
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat2.x = (((-u_xlat2.x) * 6) + 2);
          u_xlat2.x = clamp(u_xlat2.x, 0, 1);
          u_xlat2.x = (u_xlat2.x + u_xlat6_d.x);
          u_xlat6_d.x = (((-in_f.texcoord.x) * 20) + 46.0999985);
          u_xlat6_d.x = sin(u_xlat6_d.x);
          u_xlat3.xyz = ((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat3.xyz = sin(u_xlat3.xyz);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x + 5);
          u_xlat10 = (u_xlat6_d.x * 0.200000003);
          u_xlat10 = floor(u_xlat10);
          u_xlat6_d.x = ((u_xlat6_d.x * 0.200000003) + (-u_xlat10));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          u_xlat16_10 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat6_d.x = ((u_xlat6_d.x * _Deep) + u_xlat16_10);
          u_xlat10 = (u_xlat6_d.x * _Deep);
          u_xlat10 = floor(u_xlat10);
          u_xlat6_d.x = ((u_xlat6_d.x * _Deep) + (-u_xlat10));
          u_xlat10 = ((u_xlat6_d.x * 6) + (-2));
          u_xlat10 = clamp(u_xlat10, 0, 1);
          u_xlat6_d.x = (((-u_xlat6_d.x) * 6) + 2);
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat10);
          u_xlat2.x = (((-u_xlat2.x) * 0.5) + u_xlat6_d.x);
          u_xlat2.x = ((-u_xlat2.x) + 1);
          u_xlat6_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlat3.x = dot(u_xlat6_d.xyz, float3(0.219999999, 0.170000002, 0.57099998));
          ...
          u_xlat3.xyz = (u_xlat2.xxx + float3(0.25, 0, (-0.150000006)));
          u_xlat0_d.xyz = (((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + u_xlat3.xyz);
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat6_d.xyz);
          ...
          u_xlat16_13 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xy = (in_f.texcoord.xy + float2(-0.0500000007, 0.0199999996));
          u_xlat10_d = (((-u_xlat2_d.x) * 20) + 46.0999985);
          u_xlat10_d = sin(u_xlat10_d);
          u_xlat3.xyz = ((u_xlat2_d.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat10_2.xyw = tex2D(_MainTex, u_xlat2_d.xy).xyz;
          u_xlat16_2 = dot(u_xlat10_2.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat3.xyz = sin(u_xlat3.xyz);
          u_xlat6_d.x = (u_xlat10_d + u_xlat3.x);
          u_xlat6_d.x = (u_xlat3.y + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat3.z + u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x + 5);
          u_xlat10_d = (u_xlat6_d.x * 0.200000003);
          u_xlat10_d = floor(u_xlat10_d);
          u_xlat6_d.x = ((u_xlat6_d.x * 0.200000003) + (-u_xlat10_d));
          u_xlat2_d.x = ((u_xlat6_d.x * _Deep) + u_xlat16_2);
          u_xlat6_d.x = (u_xlat2_d.x * _Deep);
          u_xlat6_d.x = floor(u_xlat6_d.x);
          u_xlat2_d.x = ((u_xlat2_d.x * _Deep) + (-u_xlat6_d.x));
          u_xlat6_d.x = ((u_xlat2_d.x * 6) + (-2));
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat2_d.x = (((-u_xlat2_d.x) * 6) + 2);
          u_xlat2_d.x = clamp(u_xlat2_d.x, 0, 1);
          u_xlat2_d.x = (u_xlat2_d.x + u_xlat6_d.x);
          u_xlat6_d.x = (((-in_f.texcoord.x) * 20) + 46.0999985);
          u_xlat6_d.x = sin(u_xlat6_d.x);
          u_xlat3.xyz = ((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat3.xyz = sin(u_xlat3.xyz);
          ...
          u_xlat16_10 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat6_d.x = ((u_xlat6_d.x * _Deep) + u_xlat16_10);
          u_xlat10_d = (u_xlat6_d.x * _Deep);
          u_xlat10_d = floor(u_xlat10_d);
          u_xlat6_d.x = ((u_xlat6_d.x * _Deep) + (-u_xlat10_d));
          u_xlat10_d = ((u_xlat6_d.x * 6) + (-2));
          u_xlat10_d = clamp(u_xlat10_d, 0, 1);
          u_xlat6_d.x = (((-u_xlat6_d.x) * 6) + 2);
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat10_d);
          u_xlat2_d.x = (((-u_xlat2_d.x) * 0.5) + u_xlat6_d.x);
          ...
          u_xlatb7 = (u_xlat3.x<0.300000012);
          u_xlat3.x = (u_xlatb7)?(0.300000012):(u_xlat3.x);
          u_xlat2_d.x = (((-u_xlat2_d.x) * 0.125) + u_xlat3.x);
          u_xlat3.xyz = (u_xlat2_d.xxx + float3(0.25, 0, (-0.150000006)));
          u_xlat0_d.xyz = (((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + u_xlat3.xyz);
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat6_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat12;
          ...
          u_xlat16_1.xyz = (float3(u_xlat12, u_xlat12, u_xlat12) * _LightColor0.xyz);
          u_xlat16_1.xyz = (u_xlat0_d.xyz * u_xlat16_1.xyz);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d.x + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = (u_xlat0_d.xy + in_f.texcoord.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat12_d = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat16_1_d.x = (u_xlat12_d + (-0.0500000007));
          u_xlatb2 = (u_xlat16_1_d.x<0);
          if(((int(u_xlatb2) * (-1))!=0))
          {
              discard;
          }
          ...
          u_xlat3.xyz = ((u_xlat2.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat10_2.xyw = tex2D(_MainTex, u_xlat2.xy).xyz;
          u_xlat16_2_d = dot(u_xlat10_2.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat3.xyz = sin(u_xlat3.xyz);
          ...
          u_xlat10 = ((u_xlat6.x * 6) + (-2));
          u_xlat10 = clamp(u_xlat10, 0, 1);
          u_xlat6.x = (((-u_xlat6.x) * 6) + 2);
          u_xlat6.x = clamp(u_xlat6.x, 0, 1);
          u_xlat6.x = (u_xlat6.x + u_xlat10);
          u_xlat2.x = (((-u_xlat2.x) * 0.5) + u_xlat6.x);
          u_xlat2.x = ((-u_xlat2.x) + 1);
          u_xlat6.xyz = (u_xlat10_0.xyz * in_f.texcoord2.xyz);
          u_xlat3.x = dot(u_xlat6.xyz, float3(0.219999999, 0.170000002, 0.57099998));
          u_xlat3.x = ((u_xlat3.x * 0.699999988) + 0.150000006);
          u_xlatb7 = (0.600000024<u_xlat3.x);
          u_xlat3.x = (u_xlatb7)?(0.600000024):(u_xlat3.x);
          u_xlatb7 = (u_xlat3.x<0.300000012);
          ...
          u_xlat2.x = (((-u_xlat2.x) * 0.125) + u_xlat3.x);
          u_xlat3.xyz = (u_xlat2.xxx + float3(0.25, 0, (-0.150000006)));
          u_xlat0_d.xyz = (((-u_xlat10_0.xyz) * in_f.texcoord2.xyz) + u_xlat3.xyz);
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat6.xyz);
          ...
          u_xlat16_1_d.xyz = max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005));
          u_xlat16_1_d.xyz = log2(u_xlat16_1_d.xyz);
          u_xlat2.xyz = ((-u_xlat16_1_d.xyz) + in_f.texcoord5.xyz);
