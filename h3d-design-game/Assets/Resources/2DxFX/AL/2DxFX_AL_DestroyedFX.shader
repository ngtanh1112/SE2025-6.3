  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.xyz = (u_xlat0_d.yzw * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d));
          u_xlat7.x = (u_xlat6_d.x * 15);
          u_xlat13.x = (((-u_xlat0_d.x) * u_xlat1_d) + 1);
          u_xlat7.x = (u_xlat13.x * u_xlat7.x);
          u_xlat7.x = ((u_xlat7.x * 8) + (-u_xlat6_d.x));
          u_xlat2.x = ((_Distortion * u_xlat7.x) + u_xlat6_d.x);
          u_xlat7.xy = (u_xlat6_d.yz * u_xlat13.xx);
          u_xlat7.xy = ((u_xlat7.xy * float2(40, 5)) + (-u_xlat6_d.yz));
          u_xlat2.yz = ((float2(_Distortion, _Distortion) * u_xlat7.xy) + u_xlat6_d.yz);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat1_d) + (-_Alpha));
          u_xlat6_d.xyz = (u_xlat0_d.xxx * u_xlat2.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat21 = (u_xlat21 * u_xlat2_d.x);
          u_xlat8.xyz = (float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat1_d.yzw);
          u_xlat2_d.x = (u_xlat8.x * 15);
          u_xlat9.x = (((-u_xlat1_d.x) * u_xlat21) + 1);
          u_xlat2_d.x = (u_xlat9.x * u_xlat2_d.x);
          u_xlat2_d.x = ((u_xlat2_d.x * 8) + (-u_xlat8.x));
          u_xlat3.x = ((_Distortion * u_xlat2_d.x) + u_xlat8.x);
          u_xlat2_d.xy = (u_xlat8.yz * u_xlat9.xx);
          u_xlat2_d.xy = ((u_xlat2_d.xy * float2(40, 5)) + (-u_xlat8.yz));
          u_xlat3.yz = ((float2(_Distortion, _Distortion) * u_xlat2_d.xy) + u_xlat8.yz);
          u_xlat21 = ((u_xlat1_d.x * u_xlat21) + (-_Alpha));
          u_xlat1_d.xyz = (float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat3.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xyz = (u_xlat0_d.yzw * u_xlat1_d.xxx);
          u_xlat7.x = (u_xlat6.x * 15);
          u_xlat13.x = (((-u_xlat0_d.x) * u_xlat1_d.x) + 1);
          u_xlat7.x = (u_xlat13.x * u_xlat7.x);
          u_xlat7.x = ((u_xlat7.x * 8) + (-u_xlat6.x));
          u_xlat2.x = ((_Distortion * u_xlat7.x) + u_xlat6.x);
          u_xlat7.xy = (u_xlat6.yz * u_xlat13.xx);
          u_xlat7.xy = ((u_xlat7.xy * float2(40, 5)) + (-u_xlat6.yz));
          u_xlat2.yz = ((float2(_Distortion, _Distortion) * u_xlat7.xy) + u_xlat6.yz);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat1_d.x) + (-_Alpha));
          u_xlat6.xyz = (u_xlat0_d.xxx * u_xlat2.xyz);
