  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = ((u_xlat6_d.x * 0.5) + u_xlat1_d.w);
          u_xlat10_12 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat6_d.x = (u_xlat10_12 * u_xlat6_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat6_d.x);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = ((u_xlat0_d.x * 0.0769230798) + u_xlat5.x);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.x = ((u_xlat6.x * 0.5) + u_xlat1_d.w);
          u_xlat10_12 = tex2D(_MainTex, in_f.texcoord.xy).w;
