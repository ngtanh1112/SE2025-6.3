  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat21 = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_1 = (u_xlat21 + (-0.0500000007));
          u_xlatb2.x = (u_xlat16_1<0);
          if(((int(u_xlatb2.x) * (-1))!=0))
          {
              discard;
          }
          u_xlat2.xyz = ((u_xlat10_0.xyz * in_f.texcoord3.xyz) + (-_ColorX.xyz));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlatb2.xyz = bool4(abs(u_xlat2.xyzx) < float4(float4(_Tolerance, _Tolerance, _Tolerance, _Tolerance))).xyz;
          u_xlatb2.x = (u_xlatb2.y || u_xlatb2.x);
          u_xlatb2.x = (u_xlatb2.z || u_xlatb2.x);
          u_xlat9 = (_HueShift * 0.0174532942);
          u_xlat3.x = sin(u_xlat9);
          u_xlat4_d.x = cos(u_xlat9);
          u_xlat9 = (_Sat * _Val);
          u_xlat16.x = (u_xlat4_d.x * u_xlat9);
          u_xlat9 = (u_xlat3.x * u_xlat9);
          u_xlat1_d = (u_xlat16.xxxx * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (u_xlat16.xxxx * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat16.xy = ((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz));
          ...
          u_xlat23 = (u_xlat0_d.y * u_xlat23);
          u_xlat16.x = ((u_xlat16.x * u_xlat0_d.x) + u_xlat23);
          u_xlat23 = (((-u_xlat9) * 0.202999994) + u_xlat4_d.y);
          u_xlat4_d.x = ((u_xlat9 * 0.0350000001) + u_xlat4_d.x);
          u_xlat5.z = ((u_xlat23 * u_xlat0_d.z) + u_xlat16.x);
          ...
          u_xlat23 = (u_xlat0_d.y * u_xlat23);
          u_xlat16.x = ((u_xlat16.x * u_xlat0_d.x) + u_xlat23);
          u_xlat3.xz = (((-float2(u_xlat9, u_xlat9)) * float2(0.497000009, 0.328000009)) + u_xlat3.yz);
          u_xlat9 = ((u_xlat9 * 0.291999996) + u_xlat3.y);
          u_xlat5.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat16.x);
          u_xlat16.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat16.x = ((u_xlat4_d.x * u_xlat0_d.y) + u_xlat16.x);
          u_xlat5.y = ((u_xlat9 * u_xlat0_d.z) + u_xlat16.x);
          u_xlat0_d.xyz = (u_xlatb2.x)?(u_xlat5.xyz):(u_xlat0_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat21;
          u_xlat16_6.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xyz = ((u_xlat10_0.xyz * in_f.texcoord3.xyz) + (-_ColorX.xyz));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlatb2.xyz = bool4(abs(u_xlat2_d.xyzx) < float4(float4(_Tolerance, _Tolerance, _Tolerance, _Tolerance))).xyz;
          u_xlatb2.x = (u_xlatb2.y || u_xlatb2.x);
          u_xlatb2.x = (u_xlatb2.z || u_xlatb2.x);
          u_xlat9 = (_HueShift * 0.0174532942);
          u_xlat3.x = sin(u_xlat9);
          ...
          u_xlat5.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat16.x);
          u_xlat16.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat16.x = ((u_xlat4.x * u_xlat0_d.y) + u_xlat16.x);
          u_xlat5.y = ((u_xlat9 * u_xlat0_d.z) + u_xlat16.x);
          u_xlat0_d.xyz = (u_xlatb2.x)?(u_xlat5.xyz):(u_xlat0_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat21;
          ...
          u_xlat16_6.xyz = (float3(u_xlat21, u_xlat21, u_xlat21) * _LightColor0.xyz);
          u_xlat16_6.xyz = (u_xlat0_d.xyz * u_xlat16_6.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat21 = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat16_1_d = (u_xlat21 + (-0.0500000007));
          u_xlatb2.x = (u_xlat16_1_d<0);
          if(((int(u_xlatb2.x) * (-1))!=0))
          {
              discard;
          }
          u_xlat2.xyz = ((u_xlat10_0.xyz * in_f.texcoord2.xyz) + (-_ColorX.xyz));
          ...
          u_xlat16_6.xyz = max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005));
          u_xlat16_6.xyz = log2(u_xlat16_6.xyz);
          u_xlat2.xyz = ((-u_xlat16_6.xyz) + in_f.texcoord5.xyz);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4_d.x = cos(u_xlat8);
          u_xlat8 = (_Sat * _Val);
          u_xlat14.x = (u_xlat4_d.x * u_xlat8);
          u_xlat8 = (u_xlat3.x * u_xlat8);
          u_xlat1_d = (u_xlat14.xxxx * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (u_xlat14.xxxx * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat14.xy = ((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz));
          u_xlat4_d.xy = ((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw);
          u_xlat14.x = ((u_xlat8 * 1.25) + u_xlat14.x);
          u_xlat20 = (((-u_xlat8) * 1.04999995) + u_xlat14.y);
          u_xlat20 = (u_xlat0_d.y * u_xlat20);
          u_xlat14.x = ((u_xlat14.x * u_xlat0_d.x) + u_xlat20);
          u_xlat20 = (((-u_xlat8) * 0.202999994) + u_xlat4_d.y);
          u_xlat4_d.x = ((u_xlat8 * 0.0350000001) + u_xlat4_d.x);
          u_xlat5.z = ((u_xlat20 * u_xlat0_d.z) + u_xlat14.x);
          ...
          u_xlat20 = (u_xlat0_d.y * u_xlat20);
          u_xlat14.x = ((u_xlat14.x * u_xlat0_d.x) + u_xlat20);
          u_xlat3.xz = (((-float2(u_xlat8, u_xlat8)) * float2(0.497000009, 0.328000009)) + u_xlat3.yz);
          u_xlat8 = ((u_xlat8 * 0.291999996) + u_xlat3.y);
          u_xlat5.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat14.x);
          u_xlat14.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat14.x = ((u_xlat4_d.x * u_xlat0_d.y) + u_xlat14.x);
          u_xlat5.y = ((u_xlat8 * u_xlat0_d.z) + u_xlat14.x);
          u_xlat0_d.xyz = (u_xlatb2.x)?(u_xlat5.xyz):(u_xlat0_d.xyz);
