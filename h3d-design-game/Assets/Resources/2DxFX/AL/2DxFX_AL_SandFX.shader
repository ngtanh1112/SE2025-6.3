  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = (u_xlat0_d.xx * float2(41.9400024, 10.4666672));
          u_xlat0_d.xy = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat1_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat12 = ((-_Alpha) + 1);
          u_xlat16_2.x = ((u_xlat1_d.w * u_xlat12) + (-0.0500000007));
          u_xlat12 = (u_xlat12 * u_xlat1_d.w);
          u_xlatb13 = (u_xlat16_2.x<0);
          if(((int(u_xlatb13) * (-1))!=0))
          {
              discard;
          }
          u_xlat13 = dot(in_f.texcoord.xy, float2(12.9898005, 78.2330017));
          u_xlat13 = sin(u_xlat13);
          u_xlat13 = (u_xlat13 * 43758.5469);
          u_xlat13 = frac(u_xlat13);
          u_xlat3.x = dot(u_xlat1_d.xyz, float3(0.222000003, 0.707000017, 0.0710000023));
          ...
          u_xlat3.xyz = float3((float3(u_xlat13, u_xlat13, u_xlat13) + float3(0.5, 0.300000012, (-0.300000012))));
          u_xlat0_d.xyz = (((-u_xlat10_0.xyz) * in_f.texcoord3.xyz) + u_xlat3.xyz);
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat1_d.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat1_d = (u_xlat10_0 * in_f.texcoord2);
          u_xlat12_d = ((-_Alpha) + 1);
          u_xlat16_2_d.x = ((u_xlat1_d.w * u_xlat12_d) + (-0.0500000007));
          u_xlat12_d = (u_xlat12_d * u_xlat1_d.w);
          u_xlatb13 = (u_xlat16_2_d.x<0);
          if(((int(u_xlatb13) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat12 = ((-_Alpha) + 1);
          u_xlat16_2 = ((u_xlat1_d.w * u_xlat12) + (-0.0500000007));
          u_xlat12 = (u_xlat12 * u_xlat1_d.w);
          u_xlatb13 = (u_xlat16_2<0);
          if(((int(u_xlatb13) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = (u_xlat0_d.xx * float2(41.9400024, 10.4666672));
          u_xlat0_d.xy = sin(u_xlat0_d.xy);
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.00714285718, 0.0250000004)) + in_f.texcoord1.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat2_d = ((-_Alpha) + 1);
