  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = (((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985));
          u_xlat2.xy = sin(u_xlat2.xy);
          u_xlat1_d = ((in_f.texcoord.xyyx * float4(30, 30, 75, 75)) + float4(46.0999985, 46.0999985, 46.0999985, 46.0999985));
          u_xlat1_d = sin(u_xlat1_d);
          u_xlat2.xy = (u_xlat2.xy + u_xlat1_d.xy);
          u_xlat2.xy = (u_xlat1_d.yx + u_xlat2.xy);
          u_xlat2.xy = (u_xlat1_d.zw + u_xlat2.xy);
          u_xlat2.xy = (u_xlat2.xy + float2(5, 5));
          u_xlat12.xy = (u_xlat2.xy * float2(0.200000003, 0.200000003));
          u_xlat12.xy = floor(u_xlat12.xy);
          u_xlat2.xy = ((u_xlat2.xy * float2(0.200000003, 0.200000003)) + (-u_xlat12.xy));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat2.x = (u_xlat16_12 + u_xlat2.x);
          u_xlat12.x = (u_xlat2.x * _Deep);
          u_xlat12.x = floor(u_xlat12.x);
          u_xlat2.x = ((u_xlat2.x * _Deep) + (-u_xlat12.x));
          u_xlat12.x = ((u_xlat2.x * 6) + (-2));
          u_xlat12.x = clamp(u_xlat12.x, 0, 1);
          u_xlat2.x = (((-u_xlat2.x) * 6) + 2);
          u_xlat2.x = clamp(u_xlat2.x, 0, 1);
          u_xlat2.x = (u_xlat2.x + u_xlat12.x);
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.yx).xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat7 = (u_xlat16_12 + u_xlat2.y);
          u_xlat12.x = (u_xlat7 * _Deep);
          u_xlat12.x = floor(u_xlat12.x);
          u_xlat7 = ((u_xlat7 * _Deep) + (-u_xlat12.x));
          u_xlat12.x = ((u_xlat7 * 6) + (-2));
          u_xlat12.x = clamp(u_xlat12.x, 0, 1);
          u_xlat7 = (((-u_xlat7) * 6) + 2);
          ...
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat2.xyz) + u_xlat10_0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xy = (((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985));
          u_xlat2_d.xy = sin(u_xlat2_d.xy);
          u_xlat1_d = ((in_f.texcoord.xyyx * float4(30, 30, 75, 75)) + float4(46.0999985, 46.0999985, 46.0999985, 46.0999985));
          u_xlat1_d = sin(u_xlat1_d);
          u_xlat2_d.xy = (u_xlat2_d.xy + u_xlat1_d.xy);
          u_xlat2_d.xy = (u_xlat1_d.yx + u_xlat2_d.xy);
          u_xlat2_d.xy = (u_xlat1_d.zw + u_xlat2_d.xy);
          u_xlat2_d.xy = (u_xlat2_d.xy + float2(5, 5));
          u_xlat12.xy = (u_xlat2_d.xy * float2(0.200000003, 0.200000003));
          u_xlat12.xy = floor(u_xlat12.xy);
          u_xlat2_d.xy = ((u_xlat2_d.xy * float2(0.200000003, 0.200000003)) + (-u_xlat12.xy));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat2_d.x = (u_xlat16_12 + u_xlat2_d.x);
          u_xlat12.x = (u_xlat2_d.x * _Deep);
          u_xlat12.x = floor(u_xlat12.x);
          u_xlat2_d.x = ((u_xlat2_d.x * _Deep) + (-u_xlat12.x));
          u_xlat12.x = ((u_xlat2_d.x * 6) + (-2));
          u_xlat12.x = clamp(u_xlat12.x, 0, 1);
          u_xlat2_d.x = (((-u_xlat2_d.x) * 6) + 2);
          u_xlat2_d.x = clamp(u_xlat2_d.x, 0, 1);
          u_xlat2_d.x = (u_xlat2_d.x + u_xlat12.x);
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.yx).xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat7 = (u_xlat16_12 + u_xlat2_d.y);
          u_xlat12.x = (u_xlat7 * _Deep);
          u_xlat12.x = floor(u_xlat12.x);
          u_xlat7 = ((u_xlat7 * _Deep) + (-u_xlat12.x));
          u_xlat12.x = ((u_xlat7 * 6) + (-2));
          ...
          u_xlat7 = clamp(u_xlat7, 0, 1);
          u_xlat7 = (u_xlat7 + u_xlat12.x);
          u_xlat2_d.x = (u_xlat7 + u_xlat2_d.x);
          ...
          u_xlatb12 = (u_xlat7<0.200000003);
          u_xlat7 = (u_xlatb12)?(0.200000003):(u_xlat7);
          u_xlat2_d.x = (((-u_xlat2_d.x) * 0.125) + u_xlat7);
          u_xlat2_d.xyz = ((-u_xlat10_0.xyz) + u_xlat2_d.xxx);
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat2_d.xyz) + u_xlat10_0.xyz);
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat15;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat15 = (u_xlat10_0.w + (-_Alpha));
          u_xlat16_1_d = (u_xlat15 + (-0.0500000007));
          ...
          u_xlat2.xy = (u_xlat1_d.zw + u_xlat2.xy);
          u_xlat2.xy = (u_xlat2.xy + float2(5, 5));
          u_xlat12_d.xy = (u_xlat2.xy * float2(0.200000003, 0.200000003));
          u_xlat12_d.xy = floor(u_xlat12_d.xy);
          u_xlat2.xy = ((u_xlat2.xy * float2(0.200000003, 0.200000003)) + (-u_xlat12_d.xy));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat2.x = (u_xlat16_12 + u_xlat2.x);
          u_xlat12_d.x = (u_xlat2.x * _Deep);
          u_xlat12_d.x = floor(u_xlat12_d.x);
          u_xlat2.x = ((u_xlat2.x * _Deep) + (-u_xlat12_d.x));
          u_xlat12_d.x = ((u_xlat2.x * 6) + (-2));
          u_xlat12_d.x = clamp(u_xlat12_d.x, 0, 1);
          u_xlat2.x = (((-u_xlat2.x) * 6) + 2);
          u_xlat2.x = clamp(u_xlat2.x, 0, 1);
          u_xlat2.x = (u_xlat2.x + u_xlat12_d.x);
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.yx).xyz;
          u_xlat16_12 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat7 = (u_xlat16_12 + u_xlat2.y);
          u_xlat12_d.x = (u_xlat7 * _Deep);
          u_xlat12_d.x = floor(u_xlat12_d.x);
          u_xlat7 = ((u_xlat7 * _Deep) + (-u_xlat12_d.x));
          u_xlat12_d.x = ((u_xlat7 * 6) + (-2));
          u_xlat12_d.x = clamp(u_xlat12_d.x, 0, 1);
          u_xlat7 = (((-u_xlat7) * 6) + 2);
          u_xlat7 = clamp(u_xlat7, 0, 1);
          u_xlat7 = (u_xlat7 + u_xlat12_d.x);
          u_xlat2.x = (u_xlat7 + u_xlat2.x);
          u_xlat2.x = ((-u_xlat2.x) + 1);
          u_xlat16_7 = (u_xlat10_0.z + u_xlat10_0.x);
          u_xlat16_7 = (u_xlat10_0.y + u_xlat16_7);
          ...
          u_xlat16_4.xyz = max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005));
          u_xlat16_4.xyz = log2(u_xlat16_4.xyz);
          u_xlat2.xyz = ((-u_xlat16_4.xyz) + in_f.texcoord5.xyz);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xy = (u_xlat1_d.zw + u_xlat2.xy);
          u_xlat2.xy = (u_xlat2.xy + float2(5, 5));
          u_xlat10.xy = (u_xlat2.xy * float2(0.200000003, 0.200000003));
          u_xlat10.xy = floor(u_xlat10.xy);
          u_xlat2.xy = ((u_xlat2.xy * float2(0.200000003, 0.200000003)) + (-u_xlat10.xy));
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.xy).xyz;
          ...
          u_xlat10_3.xyz = tex2D(_MainTex, in_f.texcoord.yx).xyz;
          u_xlat16_10 = dot(u_xlat10_3.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat6_d = (u_xlat16_10 + u_xlat2.y);
          u_xlat10.x = (u_xlat6_d * _Deep);
          u_xlat10.x = floor(u_xlat10.x);
          u_xlat6_d = ((u_xlat6_d * _Deep) + (-u_xlat10.x));
          u_xlat10.x = ((u_xlat6_d * 6) + (-2));
          u_xlat10.x = clamp(u_xlat10.x, 0, 1);
          u_xlat6_d = (((-u_xlat6_d) * 6) + 2);
          u_xlat6_d = clamp(u_xlat6_d, 0, 1);
          u_xlat6_d = (u_xlat6_d + u_xlat10.x);
          u_xlat2.x = (u_xlat6_d + u_xlat2.x);
          u_xlat2.x = ((-u_xlat2.x) + 1);
          u_xlat16_6 = (u_xlat10_0.z + u_xlat10_0.x);
          u_xlat16_6 = (u_xlat10_0.y + u_xlat16_6);
          u_xlat6_d = ((u_xlat16_6 * 0.266666681) + 0.100000001);
          u_xlatb10 = (0.600000024<u_xlat6_d);
          u_xlat6_d = (u_xlatb10)?(0.600000024):(u_xlat6_d);
          u_xlatb10 = (u_xlat6_d<0.200000003);
          u_xlat6_d = (u_xlatb10)?(0.200000003):(u_xlat6_d);
          u_xlat2.x = (((-u_xlat2.x) * 0.125) + u_xlat6_d);
          u_xlat2.xyz = ((-u_xlat10_0.xyz) + u_xlat2.xxx);
          u_xlat0_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat2.xyz) + u_xlat10_0.xyz);
