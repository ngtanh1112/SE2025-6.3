  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.x = sin(u_xlat5.x);
          u_xlat2.x = cos(u_xlat5.x);
          u_xlat3.z = u_xlat1_d.x;
          u_xlat5.xy = (in_f.texcoord.xy + float2(-0.5, (-0.5)));
          u_xlat5.xy = (u_xlat5.xy * float2(1.24600005, 1.24600005));
          u_xlat3.y = u_xlat2.x;
          u_xlat3.x = (-u_xlat1_d.x);
          u_xlat1_d.y = dot(u_xlat5.xy, u_xlat3.xy);
          u_xlat1_d.x = dot(u_xlat5.xy, u_xlat3.yz);
          u_xlat5.x = length(u_xlat1_d.xy);
          ...
          u_xlat0_d.xy = (int(u_xlatb5))?(u_xlat2.xy):(u_xlat1_d.xy);
          u_xlat10.xy = (u_xlat1_d.xy + float2(0.5, 0.5));
          u_xlat10.xy = ((-u_xlat10.xy) + float2(0.5, 0.5));
          u_xlat10.x = length(u_xlat10.xy);
          ...
          u_xlat5.xy = (u_xlat5.xy * float2(4, 6.66666651));
          u_xlat5.xy = clamp(u_xlat5.xy, 0, 1);
          u_xlat15 = ((u_xlat5.x * (-2)) + 3);
          u_xlat5.x = (u_xlat5.x * u_xlat5.x);
          u_xlat5.x = (((-u_xlat15) * u_xlat5.x) + 1);
          u_xlat15 = ((u_xlat5.y * (-2)) + 3);
          u_xlat10.x = (u_xlat5.y * u_xlat5.y);
          u_xlat10.x = (((-u_xlat15) * u_xlat10.x) + 1);
          u_xlat10.x = ((-u_xlat10.x) + 1);
          u_xlat5.x = (u_xlat10.x * u_xlat5.x);
          u_xlat1_d.xyz = (u_xlat10.xxx * u_xlat10_1.xyz);
          u_xlat16_4.x = ((u_xlat0_d.x * u_xlat5.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat5.x * u_xlat0_d.x);
          u_xlatb5 = (u_xlat16_4.x<0);
          if(((int(u_xlatb5) * (-1))!=0))
          {
              discard;
          }
          u_xlat5.xyz = (u_xlat0_d.xxx * u_xlat1_d.xyz);
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_4.xyz = (u_xlat5.xyz * _LightColor0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb5 = (u_xlat5.x<0.5);
          u_xlat10_d.x = (u_xlat10_d.x + u_xlat10_d.x);
          u_xlat10_d.x = (u_xlat10_d.x * u_xlat10_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat10_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * 16);
          u_xlat2_d.x = cos(u_xlat0_d.x);
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat3.x = (-u_xlat0_d.x);
          u_xlat3.y = u_xlat2_d.x;
          u_xlat3.z = u_xlat0_d.x;
          u_xlat2_d.y = dot(u_xlat1_d.yx, u_xlat3.yz);
          u_xlat2_d.x = dot(u_xlat1_d.yx, u_xlat3.xy);
          u_xlat0_d.xy = (int(u_xlatb5))?(u_xlat2_d.xy):(u_xlat1_d.xy);
          u_xlat10_d.xy = (u_xlat1_d.xy + float2(0.5, 0.5));
          u_xlat10_d.xy = ((-u_xlat10_d.xy) + float2(0.5, 0.5));
          u_xlat10_d.x = length(u_xlat10_d.xy);
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(0.5, 0.5));
          u_xlat10_1 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat0_d.x = ((-_Alpha) + 1);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat10_1.w);
          u_xlat5.x = (u_xlat10_d.x + (-0.25));
          u_xlat5.y = (u_xlat10_d.x + (-_Hole));
          u_xlat5.xy = (u_xlat5.xy * float2(4, 6.66666651));
          u_xlat5.xy = clamp(u_xlat5.xy, 0, 1);
          u_xlat15 = ((u_xlat5.x * (-2)) + 3);
          u_xlat5.x = (u_xlat5.x * u_xlat5.x);
          u_xlat5.x = (((-u_xlat15) * u_xlat5.x) + 1);
          u_xlat15 = ((u_xlat5.y * (-2)) + 3);
          u_xlat10_d.x = (u_xlat5.y * u_xlat5.y);
          u_xlat10_d.x = (((-u_xlat15) * u_xlat10_d.x) + 1);
          u_xlat10_d.x = ((-u_xlat10_d.x) + 1);
          u_xlat5.x = (u_xlat10_d.x * u_xlat5.x);
          u_xlat1_d.xyz = (u_xlat10_d.xxx * u_xlat10_1.xyz);
          u_xlat16_4.x = ((u_xlat0_d.x * u_xlat5.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat5.x * u_xlat0_d.x);
          u_xlatb5 = (u_xlat16_4.x<0);
          if(((int(u_xlatb5) * (-1))!=0))
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.x = ((-_Alpha) + 1);
          u_xlat0_d.x = (u_xlat5.x * u_xlat10_0);
          u_xlat5.x = (u_xlat10.x + (-_Hole));
          u_xlat5.y = (u_xlat10.x + (-0.25));
          u_xlat5.xy = (u_xlat5.xy * float2(6.66666651, 4));
          u_xlat5.xy = clamp(u_xlat5.xy, 0, 1);
          u_xlat15 = ((u_xlat5.x * (-2)) + 3);
          u_xlat5.x = (u_xlat5.x * u_xlat5.x);
          u_xlat5.x = (((-u_xlat15) * u_xlat5.x) + 1);
          ...
          u_xlat16_4 = ((u_xlat0_d.x * u_xlat5.x) + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          out_f.color.xyz = (u_xlat5.xyz * u_xlat1_d.xyz);
          return out_f;
      }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.x = sin(u_xlat5.x);
          u_xlat2_d.x = cos(u_xlat5.x);
          u_xlat3_d.z = u_xlat1_d.x;
          u_xlat5.xy = (in_f.texcoord1.xy + float2(-0.5, (-0.5)));
          u_xlat5.xy = (u_xlat5.xy * float2(1.24600005, 1.24600005));
          u_xlat3_d.y = u_xlat2_d.x;
          u_xlat3_d.x = (-u_xlat1_d.x);
          u_xlat1_d.y = dot(u_xlat5.xy, u_xlat3_d.xy);
          u_xlat1_d.x = dot(u_xlat5.xy, u_xlat3_d.yz);
          u_xlat5.x = length(u_xlat1_d.xy);
          u_xlat10.x = ((-u_xlat5.x) + 0.5);
          u_xlatb5 = (u_xlat5.x<0.5);
          u_xlat10.x = (u_xlat10.x + u_xlat10.x);
          ...
          u_xlat2_d.x = cos(u_xlat0_d.x);
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat3_d.x = (-u_xlat0_d.x);
          u_xlat3_d.y = u_xlat2_d.x;
          u_xlat3_d.z = u_xlat0_d.x;
          u_xlat2_d.y = dot(u_xlat1_d.yx, u_xlat3_d.yz);
          u_xlat2_d.x = dot(u_xlat1_d.yx, u_xlat3_d.xy);
          u_xlat0_d.xy = (int(u_xlatb5))?(u_xlat2_d.xy):(u_xlat1_d.xy);
          u_xlat10.xy = (u_xlat1_d.xy + float2(0.5, 0.5));
          u_xlat10.xy = ((-u_xlat10.xy) + float2(0.5, 0.5));
          u_xlat10.x = length(u_xlat10.xy);
