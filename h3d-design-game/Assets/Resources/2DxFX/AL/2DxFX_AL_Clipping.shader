  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb3.xy = bool4(float4(_ClipUp, _ClipRight, _ClipUp, _ClipUp) < in_f.texcoord.yxyy).xy;
          u_xlatb0 = (u_xlatb0 || u_xlatb3.x);
          u_xlatb0 = (u_xlatb3.y || u_xlatb0);
          u_xlat3 = ((-_ClipLeft) + 1);
          u_xlatb3.x = (in_f.texcoord.x<u_xlat3);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = ((-_ClipDown) + 1);
          u_xlatb0 = (in_f.texcoord.y<u_xlat0_d);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = ((-_ClipDown) + 1);
          u_xlatb0 = (in_f.texcoord1.y<u_xlat0_d);
          u_xlatb2.xy = bool4(float4(_ClipUp, _ClipRight, _ClipUp, _ClipUp) < in_f.texcoord1.yxyy).xy;
          u_xlatb0 = (u_xlatb0 || u_xlatb2.x);
          u_xlatb0 = (u_xlatb2.y || u_xlatb0);
          u_xlat2_d = ((-_ClipLeft) + 1);
          u_xlatb2.x = (in_f.texcoord1.x<u_xlat2_d);
          u_xlatb0 = (u_xlatb2.x || u_xlatb0);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord1.xy).w;
          u_xlat2_d = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d = (u_xlatb0)?(0):(u_xlat2_d);
          u_xlat0_d = (u_xlat0_d + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
          if(((int(u_xlatb0) * (-1))!=0))
