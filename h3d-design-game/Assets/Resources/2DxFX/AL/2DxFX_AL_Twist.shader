  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4_d.xy = (in_f.texcoord.xy + (-float2(_PosX, _PosY)));
          ...
          u_xlat0_d.xy = (int(u_xlatb12))?(u_xlat1_d.xy):(u_xlat4_d.xy);
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(_PosX, _PosY));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = sin(_Distortion);
          u_xlat4.xy = (in_f.texcoord.xy + (-float2(_PosX, _PosY)));
          ...
          u_xlat0_d.xy = (int(u_xlatb12))?(u_xlat1_d.xy):(u_xlat4.xy);
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(_PosX, _PosY));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat0_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat1_d.x = ((-_Alpha) + 1);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = sin(_Distortion);
          u_xlat4.xy = (in_f.texcoord1.xy + (-float2(_PosX, _PosY)));
          u_xlat12_d = length(u_xlat4.xy);
          u_xlat1_d.x = ((-u_xlat12_d) + 0.5);
          u_xlatb12_d = (u_xlat12_d<0.5);
          u_xlat1_d.x = (u_xlat1_d.x + u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat1_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat1_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * 16);
          ...
          u_xlat1_d.y = dot(u_xlat4.yx, u_xlat2_d.yz);
          u_xlat1_d.x = dot(u_xlat4.yx, u_xlat2_d.xy);
          u_xlat0_d.xy = (int(u_xlatb12_d))?(u_xlat1_d.xy):(u_xlat4.xy);
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(_PosX, _PosY));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat4.x = ((-_Alpha) + 1);
