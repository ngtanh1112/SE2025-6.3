  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat27 = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          ...
          u_xlat2.x = ((_Distortion * 9) + 1);
          u_xlat11.x = (_Distortion * 9);
          u_xlat1_d = (in_f.texcoord.xyxy + float4(-0.00390625, (-0), 0.00390625, 0));
          u_xlat10_3.xyz = tex2D(_MainTex, u_xlat1_d.xy).xyz;
          u_xlat10_4.xyz = tex2D(_MainTex, u_xlat1_d.zw).xyz;
          u_xlat16_5.xyz = (u_xlat10_0.xyz + u_xlat10_3.xyz);
          u_xlat16_5.xyz = (u_xlat10_4.xyz + u_xlat16_5.xyz);
          u_xlat1_d = (in_f.texcoord.xyxy + float4(0, (-0.00390625), 0, 0.00390625));
          u_xlat10_6.xyz = tex2D(_MainTex, u_xlat1_d.xy).xyz;
          u_xlat10_7.xyz = tex2D(_MainTex, u_xlat1_d.zw).xyz;
          ...
          u_xlat0_d.xyz = min(u_xlat16_0.xyz, u_xlat2.xyz);
          u_xlat0_d.xyz = (u_xlat0_d.xyz * in_f.texcoord3.xyz);
          u_xlat0_d.xyz = (float3(u_xlat27, u_xlat27, u_xlat27) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat27;
          u_xlat16_8.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
          u_xlat16_35 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_35 = max(u_xlat16_35, 0);
          out_f.color.xyz = (float3(u_xlat16_35, u_xlat16_35, u_xlat16_35) * u_xlat16_8.xyz);
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat11.xyz = (u_xlat11.xxx * u_xlat16_5.xyz);
          u_xlat11.xyz = (u_xlat11.xyz * float3(0.200000003, 0.200000003, 0.200000003));
          u_xlat2_d.xyz = ((u_xlat2_d.xxx * u_xlat10_0.xyz) + (-u_xlat11.xyz));
          u_xlat16_5.xyz = min(u_xlat10_0.xyz, u_xlat10_3.xyz);
          u_xlat16_0.xyz = max(u_xlat10_0.xyz, u_xlat10_3.xyz);
          u_xlat16_0.xyz = max(u_xlat10_4.xyz, u_xlat16_0.xyz);
          u_xlat16_3.xyz = min(u_xlat10_4.xyz, u_xlat16_5.xyz);
          ...
          u_xlat16_0.xyz = max(u_xlat10_7.xyz, u_xlat16_0.xyz);
          u_xlat16_3.xyz = min(u_xlat10_7.xyz, u_xlat16_3.xyz);
          u_xlat2_d.xyz = max(u_xlat2_d.xyz, u_xlat16_3.xyz);
          u_xlat0_d.xyz = min(u_xlat16_0.xyz, u_xlat2_d.xyz);
          u_xlat0_d.xyz = (u_xlat0_d.xyz * in_f.texcoord3.xyz);
          u_xlat0_d.xyz = (float3(u_xlat27, u_xlat27, u_xlat27) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat27;
          ...
          u_xlat27 = dot(u_xlat2_d.xyz, u_xlat2_d.xyz);
          u_xlat27 = tex2D(_LightTexture0, float2(u_xlat27, u_xlat27)).x;
          u_xlat16_8.xyz = (float3(u_xlat27, u_xlat27, u_xlat27) * _LightColor0.xyz);
          u_xlat16_8.xyz = (u_xlat0_d.xyz * u_xlat16_8.xyz);
          u_xlat0_d.xyz = ((-in_f.texcoord2.xyz) + _WorldSpaceLightPos0.xyz);
          u_xlat0_d.xyz = normalize(u_xlat0_d.xyz);
          u_xlat16_35 = dot(in_f.texcoord1.xyz, u_xlat0_d.xyz);
          u_xlat16_35 = max(u_xlat16_35, 0);
          out_f.color.xyz = (float3(u_xlat16_35, u_xlat16_35, u_xlat16_35) * u_xlat16_8.xyz);
          return out_f;
      }
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat27 = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat16_1_d = (u_xlat27 + (-0.0500000007));
          ...
          u_xlat16_0.xyz = max(u_xlat10_0.xyz, u_xlat10_3.xyz);
          u_xlat16_0.xyz = max(u_xlat10_4.xyz, u_xlat16_0.xyz);
          u_xlat16_3_d.xyz = min(u_xlat10_4.xyz, u_xlat16_5.xyz);
          u_xlat16_3_d.xyz = min(u_xlat10_6.xyz, u_xlat16_3_d.xyz);
          u_xlat16_0.xyz = max(u_xlat10_6.xyz, u_xlat16_0.xyz);
          u_xlat16_0.xyz = max(u_xlat10_7.xyz, u_xlat16_0.xyz);
          u_xlat16_3_d.xyz = min(u_xlat10_7.xyz, u_xlat16_3_d.xyz);
          u_xlat2.xyz = max(u_xlat2.xyz, u_xlat16_3_d.xyz);
          u_xlat0_d.xyz = min(u_xlat16_0.xyz, u_xlat2.xyz);
          u_xlat0_d.xyz = (u_xlat0_d.xyz * in_f.texcoord2.xyz);
          u_xlat0_d.xyz = (float3(u_xlat27, u_xlat27, u_xlat27) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat27;
          u_xlat2.xy = (in_f.texcoord3.xy / in_f.texcoord3.ww);
          u_xlat10_2.xyz = tex2D(_LightBuffer, u_xlat2.xy).xyz;
          u_xlat16_8.xyz = max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005));
          u_xlat16_8.xyz = log2(u_xlat16_8.xyz);
          u_xlat2.xyz = ((-u_xlat16_8.xyz) + in_f.texcoord5.xyz);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat24 = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          ...
          u_xlat16_5.xyz = (u_xlat16_5.xyz + u_xlat10_6.xyz);
          u_xlat16_5.xyz = (u_xlat10_7.xyz + u_xlat16_5.xyz);
          u_xlat10.xyz = (u_xlat10.xxx * u_xlat16_5.xyz);
          u_xlat10.xyz = (u_xlat10.xyz * float3(0.200000003, 0.200000003, 0.200000003));
          u_xlat2.xyz = ((u_xlat2.xxx * u_xlat10_0.xyz) + (-u_xlat10.xyz));
          u_xlat16_5.xyz = min(u_xlat10_0.xyz, u_xlat10_3.xyz);
          u_xlat16_0.xyz = max(u_xlat10_0.xyz, u_xlat10_3.xyz);
          u_xlat16_0.xyz = max(u_xlat10_4.xyz, u_xlat16_0.xyz);
          u_xlat16_3.xyz = min(u_xlat10_4.xyz, u_xlat16_5.xyz);
