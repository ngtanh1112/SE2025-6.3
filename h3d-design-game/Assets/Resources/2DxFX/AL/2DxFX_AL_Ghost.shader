  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.x = (_offset + 1);
          u_xlat6_d.xy = float2(((-float2(_ClipUp, _ClipDown)) + float2(1, 1)));
          u_xlat1_d.xy = (u_xlat3.xx / u_xlat6_d.xy);
          u_xlatb6 = (in_f.texcoord.y<u_xlat6_d.y);
          u_xlat7.xy = ((-in_f.texcoord.yx) + float2(1, 1));
          u_xlat9 = ((u_xlat1_d.x * u_xlat7.x) + (-_offset));
          u_xlat9 = clamp(u_xlat9, 0, 1);
          u_xlat1_d.x = ((u_xlat1_d.y * in_f.texcoord.y) + (-_offset));
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0, 1);
          u_xlat0_d = (u_xlatb0)?(u_xlat9):(1);
          u_xlat9 = (u_xlat1_d.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb6)?(u_xlat9):(u_xlat0_d);
          u_xlat6_d.xy = float2(((-float2(_ClipRight, _ClipLeft)) + float2(1, 1)));
          u_xlat3.xy = (u_xlat3.xx / u_xlat6_d.xy);
          u_xlatb9 = (in_f.texcoord.x<u_xlat6_d.y);
          u_xlat3.x = ((u_xlat3.x * u_xlat7.y) + (-_offset));
          u_xlat3.x = clamp(u_xlat3.x, 0, 1);
          u_xlat6_d.x = ((u_xlat3.y * in_f.texcoord.x) + (-_offset));
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat3.x = (u_xlat3.x * u_xlat0_d);
          u_xlatb1 = (_ClipRight<in_f.texcoord.x);
          u_xlat0_d = (u_xlatb1)?(u_xlat3.x):(u_xlat0_d);
          u_xlat3.x = (u_xlat6_d.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb9)?(u_xlat3.x):(u_xlat0_d);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d = ((u_xlat1_d.w * u_xlat0_d) + (-_Alpha));
          u_xlat3.xyz = (float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * u_xlat1_d.xyz);
          u_xlat16_2.xyz = (u_xlat3.xyz * _LightColor0.xyz);
          u_xlat16_11 = (u_xlat0_d + (-0.0500000007));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.x = ((u_xlat1_d.y * in_f.texcoord.y) + (-_offset));
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0, 1);
          u_xlat0_d.x = (u_xlatb0)?(u_xlat9):(1);
          u_xlat9 = (u_xlat1_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlatb6)?(u_xlat9):(u_xlat0_d.x);
          u_xlat6_d.xy = float2(((-float2(_ClipRight, _ClipLeft)) + float2(1, 1)));
          u_xlat3.xy = (u_xlat3.xx / u_xlat6_d.xy);
          u_xlatb9 = (in_f.texcoord.x<u_xlat6_d.y);
          u_xlat3.x = ((u_xlat3.x * u_xlat7.y) + (-_offset));
          ...
          u_xlat6_d.x = ((u_xlat3.y * in_f.texcoord.x) + (-_offset));
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat3.x = (u_xlat3.x * u_xlat0_d.x);
          u_xlatb1 = (_ClipRight<in_f.texcoord.x);
          u_xlat0_d.x = (u_xlatb1)?(u_xlat3.x):(u_xlat0_d.x);
          u_xlat3.x = (u_xlat6_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlatb9)?(u_xlat3.x):(u_xlat0_d.x);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d.x = ((u_xlat1_d.w * u_xlat0_d.x) + (-_Alpha));
          u_xlat3.xyz = (u_xlat0_d.xxx * u_xlat1_d.xyz);
          u_xlat16_2.x = (u_xlat0_d.x + (-0.0500000007));
          out_f.color.w = u_xlat0_d.x;
          u_xlatb0 = (u_xlat16_2.x<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.x = (u_xlat6_d.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb9)?(u_xlat3.x):(u_xlat0_d);
          u_xlat10_3 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat3.x = (u_xlat10_3 * in_f.texcoord3.w);
          u_xlat0_d = ((u_xlat3.x * u_xlat0_d) + (-_Alpha));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb0 = (_ClipUp<in_f.texcoord.y);
          u_xlat3.x = (_offset + 1);
          u_xlat6.xy = float2(((-float2(_ClipUp, _ClipDown)) + float2(1, 1)));
          u_xlat1_d.xy = (u_xlat3.xx / u_xlat6.xy);
          u_xlatb6 = (in_f.texcoord.y<u_xlat6.y);
          u_xlat7.xy = ((-in_f.texcoord.yx) + float2(1, 1));
          u_xlat9 = ((u_xlat1_d.x * u_xlat7.x) + (-_offset));
          u_xlat9 = clamp(u_xlat9, 0, 1);
          u_xlat1_d.x = ((u_xlat1_d.y * in_f.texcoord.y) + (-_offset));
          ...
          u_xlat9 = (u_xlat1_d.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb6)?(u_xlat9):(u_xlat0_d);
          u_xlat6.xy = float2(((-float2(_ClipRight, _ClipLeft)) + float2(1, 1)));
          u_xlat3.xy = (u_xlat3.xx / u_xlat6.xy);
          u_xlatb9 = (in_f.texcoord.x<u_xlat6.y);
          u_xlat3.x = ((u_xlat3.x * u_xlat7.y) + (-_offset));
          u_xlat3.x = clamp(u_xlat3.x, 0, 1);
          u_xlat6.x = ((u_xlat3.y * in_f.texcoord.x) + (-_offset));
          u_xlat6.x = clamp(u_xlat6.x, 0, 1);
          u_xlat3.x = (u_xlat3.x * u_xlat0_d);
          u_xlatb1 = (_ClipRight<in_f.texcoord.x);
          u_xlat0_d = (u_xlatb1)?(u_xlat3.x):(u_xlat0_d);
          u_xlat3.x = (u_xlat6.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb9)?(u_xlat3.x):(u_xlat0_d);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlatb0 = (_ClipUp<in_f.texcoord1.y);
          u_xlat3_d.x = (_offset + 1);
          u_xlat6.xy = float2(((-float2(_ClipUp, _ClipDown)) + float2(1, 1)));
          u_xlat1_d.xy = (u_xlat3_d.xx / u_xlat6.xy);
          u_xlatb6 = (in_f.texcoord1.y<u_xlat6.y);
          u_xlat7.xy = ((-in_f.texcoord1.yx) + float2(1, 1));
          u_xlat9_d = ((u_xlat1_d.x * u_xlat7.x) + (-_offset));
          u_xlat9_d = clamp(u_xlat9_d, 0, 1);
          u_xlat1_d.x = ((u_xlat1_d.y * in_f.texcoord1.y) + (-_offset));
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0, 1);
          u_xlat0_d = (u_xlatb0)?(u_xlat9_d):(1);
          u_xlat9_d = (u_xlat1_d.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb6)?(u_xlat9_d):(u_xlat0_d);
          u_xlat6.xy = float2(((-float2(_ClipRight, _ClipLeft)) + float2(1, 1)));
          u_xlat3_d.xy = (u_xlat3_d.xx / u_xlat6.xy);
          u_xlatb9 = (in_f.texcoord1.x<u_xlat6.y);
          u_xlat3_d.x = ((u_xlat3_d.x * u_xlat7.y) + (-_offset));
          u_xlat3_d.x = clamp(u_xlat3_d.x, 0, 1);
          u_xlat6.x = ((u_xlat3_d.y * in_f.texcoord1.x) + (-_offset));
          u_xlat6.x = clamp(u_xlat6.x, 0, 1);
          u_xlat3_d.x = (u_xlat3_d.x * u_xlat0_d);
          u_xlatb1 = (_ClipRight<in_f.texcoord1.x);
          u_xlat0_d = (u_xlatb1)?(u_xlat3_d.x):(u_xlat0_d);
          u_xlat3_d.x = (u_xlat6.x * u_xlat0_d);
          u_xlat0_d = (u_xlatb9)?(u_xlat3_d.x):(u_xlat0_d);
          u_xlat10_3 = tex2D(_MainTex, in_f.texcoord1.xy).w;
          u_xlat3_d.x = (u_xlat10_3 * in_f.texcoord3.w);
          u_xlat0_d = ((u_xlat3_d.x * u_xlat0_d) + (-_Alpha));
          u_xlat16_2 = (u_xlat0_d + (-0.0500000007));
          u_xlatb0 = (u_xlat16_2<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
