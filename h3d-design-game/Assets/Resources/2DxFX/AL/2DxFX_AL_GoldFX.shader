  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = ((_Time.x * 45) + 1.10000002);
          ...
          u_xlat15 = ((u_xlat6_d.x * u_xlat0_d.w) + (-_Alpha));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.715200007, 0.0722000003));
          u_xlat5 = ((-u_xlat15) + 1);
          ...
          u_xlat15 = ((-u_xlat0_d.x) + u_xlat15);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat4_d.z = (u_xlat15 * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.z * u_xlat0_d.x);
          u_xlat4_d.x = (u_xlat0_d.x * 0.5);
          u_xlat4_d.y = 2;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat15 = ((-u_xlat0_d.x) + u_xlat15);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat4.z = (u_xlat15 * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.z * u_xlat0_d.x);
          u_xlat4.x = (u_xlat0_d.x * 0.5);
          u_xlat4.y = 2;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.x = ((_Time.x * 45) + 1.10000002);
          ...
          u_xlat15 = ((u_xlat6.x * u_xlat0_d.w) + (-_Alpha));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.715200007, 0.0722000003));
          u_xlat5 = ((-u_xlat15) + 1);
          u_xlat10 = (((-u_xlat0_d.x) * 0.115896732) + 1);
          u_xlat15 = (u_xlat0_d.x * u_xlat0_d.x);
