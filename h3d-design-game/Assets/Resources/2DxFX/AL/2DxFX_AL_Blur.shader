  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = in_f.texcoord3.xyz;
          u_xlat2.w = 0.0625;
          u_xlat0_d = (u_xlat16_0 * u_xlat2);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat10_1.w);
          u_xlat0_d.w = (u_xlat0_d.w * u_xlat1_d.x);
          u_xlat1_d.w = in_f.texcoord3.w;
          u_xlat16_4.x = ((u_xlat0_d.w * u_xlat1_d.w) + (-0.0500000007));
          u_xlatb6 = (u_xlat16_4.x<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
              discard;
          }
          u_xlat1_d.x = 0.0625;
          u_xlat0_d = (u_xlat0_d * u_xlat1_d.xxxw);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat16_0 = ((u_xlat10_1 * float4(4, 4, 4, 4)) + u_xlat16_0);
          u_xlat2_d.x = in_f.texcoord.x;
          u_xlat2_d.yz = ((float2(_Distortion, _Distortion) * float2(0.00390625, 0.00390625)) + in_f.texcoord.yx);
          u_xlat10_3 = tex2D(_MainTex, u_xlat2_d.xy);
          u_xlat16_0 = ((u_xlat10_3 * float4(2, 2, 2, 2)) + u_xlat16_0);
          u_xlat2_d.w = (((-_Distortion) * 0.00390625) + in_f.texcoord.y);
          u_xlat10_2 = tex2D(_MainTex, u_xlat2_d.zw);
          u_xlat16_0 = (u_xlat16_0 + u_xlat10_2);
          u_xlat1_d.x = ((_Distortion * 0.00390625) + in_f.texcoord.x);
          u_xlat1_d.y = in_f.texcoord.y;
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat16_0 = ((u_xlat10_3 * float4(2, 2, 2, 2)) + u_xlat16_0);
          u_xlat16_0 = (u_xlat10_2 + u_xlat16_0);
          u_xlat2_d.xyz = in_f.texcoord3.xyz;
          u_xlat2_d.w = 0.0625;
          u_xlat0_d = (u_xlat16_0 * u_xlat2_d);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat10_1.w);
          u_xlat0_d.w = (u_xlat0_d.w * u_xlat1_d.x);
          u_xlat1_d.w = in_f.texcoord3.w;
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.w = in_f.texcoord.y;
          u_xlat0_d.xyz = (((-float3(_Distortion, _Distortion, _Distortion)) * float3(0.00390625, 0.00390625, 0.00390625)) + in_f.texcoord.xyx);
          u_xlat10_6 = tex2D(_MainTex, u_xlat0_d.zw).w;
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat16_0 = ((u_xlat10_6 * 2) + u_xlat10_0);
          u_xlat1_d.y = ((_Distortion * 0.00390625) + in_f.texcoord.y);
          u_xlat1_d.xw = (((-float2(_Distortion, _Distortion)) * float2(0.00390625, 0.00390625)) + in_f.texcoord.xy);
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.xy).w;
          u_xlat16_0 = (u_xlat10_3 + u_xlat16_0);
          u_xlat1_d.xz = in_f.texcoord.xx;
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.zw).w;
          u_xlat16_0 = ((u_xlat10_3 * 2) + u_xlat16_0);
          u_xlat10_3 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat16_0 = ((u_xlat10_3 * 4) + u_xlat16_0);
          u_xlat1_d.yz = ((float2(_Distortion, _Distortion) * float2(0.00390625, 0.00390625)) + in_f.texcoord.yx);
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.xy).w;
          u_xlat16_0 = ((u_xlat10_6 * 2) + u_xlat16_0);
          u_xlat1_d.w = (((-_Distortion) * 0.00390625) + in_f.texcoord.y);
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.zw).w;
          u_xlat16_0 = (u_xlat10_6 + u_xlat16_0);
          u_xlat1_d.x = ((_Distortion * 0.00390625) + in_f.texcoord.x);
          u_xlat1_d.y = in_f.texcoord.y;
          u_xlat10_9 = tex2D(_MainTex, u_xlat1_d.xy).w;
          u_xlat16_0 = ((u_xlat10_9 * 2) + u_xlat16_0);
          u_xlat16_0 = (u_xlat10_6 + u_xlat16_0);
          u_xlat16_0 = (u_xlat16_0 * 0.0625);
          u_xlat6_d = ((-_Alpha) + 1);
          u_xlat3 = (u_xlat6_d * u_xlat10_3);
          u_xlat0_d.x = (u_xlat3 * u_xlat16_0);
          u_xlat16_2 = ((u_xlat0_d.x * in_f.texcoord3.w) + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = ((u_xlat10_3 * float4(2, 2, 2, 2)) + u_xlat16_0);
          u_xlat16_0 = (u_xlat10_2 + u_xlat16_0);
          u_xlat2.xyz = in_f.texcoord2.xyz;
          u_xlat2.w = 0.0625;
          u_xlat0_d = (u_xlat16_0 * u_xlat2);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat10_1.w);
          u_xlat0_d.w = (u_xlat0_d.w * u_xlat1_d.x);
          u_xlat1_d.w = in_f.texcoord2.w;
          u_xlat16_4.x = ((u_xlat0_d.w * u_xlat1_d.w) + (-0.0500000007));
          u_xlatb6 = (u_xlat16_4.x<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.w = (u_xlat0_d.w * u_xlat1_d.x);
          u_xlat1_d.w = in_f.texcoord3.w;
          u_xlat16_4 = ((u_xlat0_d.w * u_xlat1_d.w) + (-0.0500000007));
          u_xlatb6 = (u_xlat16_4<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.w = in_f.texcoord1.y;
          u_xlat0_d.xyz = (((-float3(_Distortion, _Distortion, _Distortion)) * float3(0.00390625, 0.00390625, 0.00390625)) + in_f.texcoord1.xyx);
          u_xlat10_6 = tex2D(_MainTex, u_xlat0_d.zw).w;
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat16_0 = ((u_xlat10_6 * 2) + u_xlat10_0);
          u_xlat1_d.y = ((_Distortion * 0.00390625) + in_f.texcoord1.y);
          u_xlat1_d.xw = (((-float2(_Distortion, _Distortion)) * float2(0.00390625, 0.00390625)) + in_f.texcoord1.xy);
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.xy).w;
          u_xlat16_0 = (u_xlat10_3 + u_xlat16_0);
          u_xlat1_d.xz = in_f.texcoord1.xx;
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.zw).w;
          u_xlat16_0 = ((u_xlat10_3 * 2) + u_xlat16_0);
          u_xlat10_3 = tex2D(_MainTex, in_f.texcoord1.xy).w;
          u_xlat16_0 = ((u_xlat10_3 * 4) + u_xlat16_0);
          u_xlat1_d.yz = ((float2(_Distortion, _Distortion) * float2(0.00390625, 0.00390625)) + in_f.texcoord1.yx);
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.xy).w;
          u_xlat16_0 = ((u_xlat10_6 * 2) + u_xlat16_0);
          u_xlat1_d.w = (((-_Distortion) * 0.00390625) + in_f.texcoord1.y);
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.zw).w;
          u_xlat16_0 = (u_xlat10_6 + u_xlat16_0);
          u_xlat1_d.x = ((_Distortion * 0.00390625) + in_f.texcoord1.x);
          ...
          u_xlat16_0 = (u_xlat16_0 * 0.0625);
          u_xlat6 = ((-_Alpha) + 1);
          u_xlat3_d = (u_xlat6 * u_xlat10_3);
          u_xlat0_d.x = (u_xlat3_d * u_xlat16_0);
          u_xlat16_2 = ((u_xlat0_d.x * in_f.texcoord3.w) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_2<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
