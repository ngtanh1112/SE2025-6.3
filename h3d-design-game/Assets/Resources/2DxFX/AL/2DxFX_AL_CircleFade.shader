  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (u_xlat0_d.x + (-_Offset));
          u_xlat0_d.x = (u_xlat0_d.x * 6.66666651);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat3.x = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (((-u_xlat3.x) * u_xlat0_d.x) + 1);
          u_xlat3.x = ((-u_xlat0_d.x) + 1);
          u_xlatb6 = (_InOut==0);
          u_xlat0_d.x = (u_xlatb6)?(u_xlat0_d.x):(u_xlat3.x);
          ...
          u_xlat16_11 = (u_xlat0_d.x + (-0.0500000007));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2 = ((-u_xlat0_d.x) + 1);
          u_xlatb4 = (_InOut==0);
          u_xlat0_d.x = (u_xlatb4)?(u_xlat0_d.x):(u_xlat2);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat2 = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d.x = ((u_xlat2 * u_xlat0_d.x) + (-_Alpha));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = ((-in_f.texcoord1.xy) + float2(0.5, 0.5));
          u_xlat0_d.x = length(u_xlat0_d.xy);
          u_xlat0_d.x = (u_xlat0_d.x + (-_Offset));
          u_xlat0_d.x = (u_xlat0_d.x * 6.66666651);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          ...
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (((-u_xlat2_d) * u_xlat0_d.x) + 1);
          u_xlat2_d = ((-u_xlat0_d.x) + 1);
          u_xlatb4 = (_InOut==0);
          u_xlat0_d.x = (u_xlatb4)?(u_xlat0_d.x):(u_xlat2_d);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord1.xy).w;
          u_xlat2_d = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d.x = ((u_xlat2_d * u_xlat0_d.x) + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d.x + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
