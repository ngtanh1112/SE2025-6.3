  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = (((-_Value2) * 0.400000006) + 1);
          u_xlat12.xy = ((in_f.texcoord.xy * u_xlat6_d.xx) + u_xlat0_d.xx);
          u_xlat0_d.xy = ((u_xlat12.xy * u_xlat6_d.xx) + u_xlat0_d.xx);
          u_xlat10_12 = tex2D(_MainTex2, u_xlat12.xy).x;
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z;
          u_xlat6_d.x = (u_xlat10_0 * _Value2);
          u_xlat16_0 = (u_xlat10_0 + u_xlat10_0);
          u_xlat6_d.xz = ((u_xlat6_d.xx * float2(0.0299999993, 0.0299999993)) + in_f.texcoord.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat6_d.xz);
          u_xlat2 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat6_d.x = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat2.w * u_xlat6_d.x) + (-0.0500000007));
          u_xlat6_d.x = (u_xlat6_d.x * u_xlat2.w);
          u_xlatb18 = (u_xlat16_3.x<0);
          if(((int(u_xlatb18) * (-1))!=0))
          {
              discard;
          }
          u_xlat18 = (u_xlat2.y + u_xlat2.x);
          u_xlat18 = ((u_xlat10_1.z * in_f.texcoord3.z) + u_xlat18);
          u_xlatb19 = (u_xlat18<1.5);
          u_xlat20 = (((-u_xlat18) * 0.333333343) + 1);
          u_xlat20 = (u_xlat20 + u_xlat20);
          u_xlat16_4.xy = float2((((-float2(u_xlat10_12, u_xlat10_12)) * float2(0.100000001, 0.666666687)) + float2(1, 1)));
          u_xlat4_d.xy = (((-float2(u_xlat20, u_xlat20)) * u_xlat16_4.xy) + float2(1, 1));
          u_xlat16 = (u_xlat18 * 0.666666687);
          u_xlat18 = ((u_xlat18 * 0.333333343) + (-_Value1));
          u_xlat18 = (u_xlat18 * 10);
          u_xlat18 = clamp(u_xlat18, 0, 1);
          u_xlat16_5.xy = float2((float2(u_xlat10_12, u_xlat10_12) * float2(0.100000001, 0.666666687)));
          u_xlat5.xy = (float2(u_xlat16, u_xlat16) * u_xlat16_5.xy);
          u_xlat16 = (u_xlat10_12 * u_xlat16);
          u_xlat5.xy = (int(u_xlatb19))?(u_xlat5.xy):(u_xlat4_d.xy);
          u_xlat16_4.x = ((-u_xlat10_12) + 1);
          u_xlat20 = (((-u_xlat20) * u_xlat16_4.x) + 1);
          u_xlat5.z = (u_xlatb19)?(u_xlat16):(u_xlat20);
          u_xlat19 = ((u_xlat18 * (-2)) + 3);
          u_xlat18 = (u_xlat18 * u_xlat18);
          u_xlat18 = ((u_xlat19 * u_xlat18) + 0.200000003);
          u_xlat18 = (u_xlat18 * u_xlat10_12);
          u_xlat4_d.xyz = ((float3(u_xlat18, u_xlat18, u_xlat18) * float3(u_xlat16_0, u_xlat16_0, u_xlat16_0)) + u_xlat5.xyz);
          u_xlat5.x = (((-_Time.x) * 2) + (-_Value2));
          u_xlat5.y = 0;
          u_xlat0_d.xw = (u_xlat5.xy + in_f.texcoord.xy);
          u_xlat0_d.xz = (float2(u_xlat10_12, u_xlat10_12) + u_xlat0_d.xw);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xz).y;
          u_xlat0_d.xzw = ((float3(u_xlat10_0, u_xlat10_0, u_xlat10_0) * float3(0.5, 0.5, 0.5)) + u_xlat4_d.xyz);
          u_xlat0_d.xzw = (((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + u_xlat0_d.xzw);
          u_xlat0_d.xzw = ((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xzw) + u_xlat2.xyz);
          u_xlat0_d.xzw = (u_xlat6_d.xxx * u_xlat0_d.xzw);
          out_f.color.w = u_xlat6_d.x;
          u_xlat16_3.xyz = (u_xlat0_d.xzw * _LightColor0.xyz);
          u_xlat16_21 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_21 = max(u_xlat16_21, 0);
          out_f.color.xyz = (float3(u_xlat16_21, u_xlat16_21, u_xlat16_21) * u_xlat16_3.xyz);
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat2_d.w * u_xlat6_d.x) + (-0.0500000007));
          u_xlat6_d.x = (u_xlat6_d.x * u_xlat2_d.w);
          u_xlatb18 = (u_xlat16_3.x<0);
          if(((int(u_xlatb18) * (-1))!=0))
          {
              discard;
          }
          u_xlat18 = (u_xlat2_d.y + u_xlat2_d.x);
          u_xlat18 = ((u_xlat10_1.z * in_f.texcoord3.z) + u_xlat18);
          u_xlatb19 = (u_xlat18<1.5);
          u_xlat20 = (((-u_xlat18) * 0.333333343) + 1);
          u_xlat20 = (u_xlat20 + u_xlat20);
          u_xlat16_4.xy = float2((((-float2(u_xlat10_12, u_xlat10_12)) * float2(0.100000001, 0.666666687)) + float2(1, 1)));
          u_xlat4.xy = (((-float2(u_xlat20, u_xlat20)) * u_xlat16_4.xy) + float2(1, 1));
          u_xlat16 = (u_xlat18 * 0.666666687);
          u_xlat18 = ((u_xlat18 * 0.333333343) + (-_Value1));
          u_xlat18 = (u_xlat18 * 10);
          u_xlat18 = clamp(u_xlat18, 0, 1);
          ...
          u_xlat5.xy = (float2(u_xlat16, u_xlat16) * u_xlat16_5.xy);
          u_xlat16 = (u_xlat10_12 * u_xlat16);
          u_xlat5.xy = (int(u_xlatb19))?(u_xlat5.xy):(u_xlat4.xy);
          u_xlat16_4.x = ((-u_xlat10_12) + 1);
          u_xlat20 = (((-u_xlat20) * u_xlat16_4.x) + 1);
          u_xlat5.z = (u_xlatb19)?(u_xlat16):(u_xlat20);
          u_xlat19 = ((u_xlat18 * (-2)) + 3);
          ...
          u_xlat18 = ((u_xlat19 * u_xlat18) + 0.200000003);
          u_xlat18 = (u_xlat18 * u_xlat10_12);
          u_xlat4.xyz = ((float3(u_xlat18, u_xlat18, u_xlat18) * float3(u_xlat16_0, u_xlat16_0, u_xlat16_0)) + u_xlat5.xyz);
          u_xlat5.x = (((-_Time.x) * 2) + (-_Value2));
          u_xlat5.y = 0;
          u_xlat0_d.xw = (u_xlat5.xy + in_f.texcoord.xy);
          u_xlat0_d.xz = (float2(u_xlat10_12, u_xlat10_12) + u_xlat0_d.xw);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xz).y;
          u_xlat0_d.xzw = ((float3(u_xlat10_0, u_xlat10_0, u_xlat10_0) * float3(0.5, 0.5, 0.5)) + u_xlat4.xyz);
          u_xlat0_d.xzw = (((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + u_xlat0_d.xzw);
          u_xlat0_d.xzw = ((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xzw) + u_xlat2_d.xyz);
          u_xlat0_d.xzw = (u_xlat6_d.xxx * u_xlat0_d.xzw);
          out_f.color.w = u_xlat6_d.x;
          ...
          u_xlat6_d.x = dot(u_xlat1_d.xyz, u_xlat1_d.xyz);
          u_xlat6_d.x = tex2D(_LightTexture0, u_xlat6_d.xx).x;
          u_xlat16_3.xyz = (u_xlat6_d.xxx * _LightColor0.xyz);
          u_xlat16_3.xyz = (u_xlat0_d.xzw * u_xlat16_3.xyz);
          u_xlat0_d.xyz = ((-in_f.texcoord2.xyz) + _WorldSpaceLightPos0.xyz);
          u_xlat0_d.xyz = normalize(u_xlat0_d.xyz);
          u_xlat16_21 = dot(in_f.texcoord1.xyz, u_xlat0_d.xyz);
          u_xlat16_21 = max(u_xlat16_21, 0);
          out_f.color.xyz = (float3(u_xlat16_21, u_xlat16_21, u_xlat16_21) * u_xlat16_3.xyz);
          return out_f;
      }
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (_Value2 * 0.200000003);
          u_xlat2 = (((-_Value2) * 0.400000006) + 1);
          u_xlat4_d.xy = ((in_f.texcoord.xy * float2(u_xlat2, u_xlat2)) + u_xlat0_d.xx);
          u_xlat0_d.xy = ((u_xlat4_d.xy * float2(u_xlat2, u_xlat2)) + u_xlat0_d.xx);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z;
          u_xlat0_d.x = (u_xlat10_0 * _Value2);
          u_xlat0_d.xy = ((u_xlat0_d.xx * float2(0.0299999993, 0.0299999993)) + in_f.texcoord.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat2 = ((-_Alpha) + 1);
          u_xlat16_1 = ((u_xlat0_d.x * u_xlat2) + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (_Value2 * 0.200000003);
          u_xlat6.x = (((-_Value2) * 0.400000006) + 1);
          u_xlat12_d.xy = ((in_f.texcoord.xy * u_xlat6.xx) + u_xlat0_d.xx);
          u_xlat0_d.xy = ((u_xlat12_d.xy * u_xlat6.xx) + u_xlat0_d.xx);
          u_xlat10_12 = tex2D(_MainTex2, u_xlat12_d.xy).x;
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z;
          u_xlat6.x = (u_xlat10_0 * _Value2);
          u_xlat16_0 = (u_xlat10_0 + u_xlat10_0);
          u_xlat6.xz = ((u_xlat6.xx * float2(0.0299999993, 0.0299999993)) + in_f.texcoord.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat6.xz);
          u_xlat2 = (u_xlat10_1 * in_f.texcoord2);
          u_xlat6.x = ((-_Alpha) + 1);
          u_xlat16_3_d.x = ((u_xlat2.w * u_xlat6.x) + (-0.0500000007));
          u_xlat6.x = (u_xlat6.x * u_xlat2.w);
          u_xlatb18 = (u_xlat16_3_d.x<0);
          if(((int(u_xlatb18) * (-1))!=0))
          {
              discard;
          }
          u_xlat18 = (u_xlat2.y + u_xlat2.x);
          u_xlat18 = ((u_xlat10_1.z * in_f.texcoord2.z) + u_xlat18);
          u_xlatb19 = (u_xlat18<1.5);
          u_xlat20 = (((-u_xlat18) * 0.333333343) + 1);
          u_xlat20 = (u_xlat20 + u_xlat20);
          u_xlat16_4.xy = float2((((-float2(u_xlat10_12, u_xlat10_12)) * float2(0.100000001, 0.666666687)) + float2(1, 1)));
          ...
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xz).y;
          u_xlat0_d.xzw = ((float3(u_xlat10_0, u_xlat10_0, u_xlat10_0) * float3(0.5, 0.5, 0.5)) + u_xlat4.xyz);
          u_xlat0_d.xzw = (((-u_xlat10_1.xyz) * in_f.texcoord2.xyz) + u_xlat0_d.xzw);
          u_xlat0_d.xzw = ((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xzw) + u_xlat2.xyz);
          u_xlat0_d.xzw = (u_xlat6.xxx * u_xlat0_d.xzw);
          out_f.color.w = u_xlat6.x;
          ...
          out_f.color.xyz = (u_xlat0_d.xzw * u_xlat1_d.xyz);
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat6_d.x = ((-_Alpha) + 1);
          u_xlat16_3 = ((u_xlat2.w * u_xlat6_d.x) + (-0.0500000007));
          u_xlat6_d.x = (u_xlat6_d.x * u_xlat2.w);
          u_xlatb18 = (u_xlat16_3<0);
          if(((int(u_xlatb18) * (-1))!=0))
          {
              discard;
          }
          ...
          u_xlat0_d.xzw = (((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + u_xlat0_d.xzw);
          u_xlat0_d.xzw = ((float3(float3(_Value2, _Value2, _Value2)) * u_xlat0_d.xzw) + u_xlat2.xyz);
          u_xlat0_d.xyz = (u_xlat6_d.xxx * u_xlat0_d.xzw);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (_Value2 * 0.200000003);
          u_xlat2_d = (((-_Value2) * 0.400000006) + 1);
          u_xlat4.xy = ((in_f.texcoord1.xy * float2(u_xlat2_d, u_xlat2_d)) + u_xlat0_d.xx);
          u_xlat0_d.xy = ((u_xlat4.xy * float2(u_xlat2_d, u_xlat2_d)) + u_xlat0_d.xx);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).z;
          u_xlat0_d.x = (u_xlat10_0 * _Value2);
          u_xlat0_d.xy = ((u_xlat0_d.xx * float2(0.0299999993, 0.0299999993)) + in_f.texcoord1.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat2_d = ((-_Alpha) + 1);
          u_xlat16_1 = ((u_xlat0_d.x * u_xlat2_d) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
