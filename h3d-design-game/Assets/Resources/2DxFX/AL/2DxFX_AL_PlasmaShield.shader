  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.x = (u_xlat0_d.y + u_xlat0_d.z);
          u_xlat3.x = (u_xlat0_d.w + u_xlat3.x);
          ...
          u_xlat16_2.x = ((u_xlat0_d.x * in_f.texcoord3.w) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat0_d.x * in_f.texcoord3.w);
          u_xlatb3 = (u_xlat16_2.x<0);
          if(((int(u_xlatb3) * (-1))!=0))
          {
              discard;
          }
          u_xlat3.xyz = (in_f.texcoord3.xyz * _ColorX.xyz);
          u_xlat3.xyz = (u_xlat0_d.xxx * u_xlat3.xyz);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = ((in_f.texcoord.y * 5) + u_xlat0_d.x);
          u_xlat0_d = sin(u_xlat0_d);
          u_xlat3 = (u_xlat0_d.y + u_xlat0_d.z);
          u_xlat3 = (u_xlat0_d.w + u_xlat3);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat3);
          u_xlat0_d.x = (u_xlat0_d.x + 5);
          u_xlat3 = (u_xlat0_d.x * 0.200000003);
          u_xlat3 = floor(u_xlat3);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.200000003) + (-u_xlat3));
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat16_3 = dot(u_xlat10_1.xzy, float3(0.200000003, 0.200000003, 0.400000006));
          u_xlat0_d.x = (u_xlat16_3 + u_xlat0_d.x);
          u_xlat3 = floor(u_xlat0_d.x);
          u_xlat0_d.x = ((-u_xlat3) + u_xlat0_d.x);
          u_xlat3 = ((u_xlat0_d.x * _Size) + (-2));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = ((u_xlat0_d.x * 0.200000003) + (-u_xlat3.x));
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat16_3_d = dot(u_xlat10_1.xzy, float3(0.200000003, 0.200000003, 0.400000006));
          u_xlat0_d.x = (u_xlat16_3_d + u_xlat0_d.x);
          u_xlat3.x = floor(u_xlat0_d.x);
          u_xlat0_d.x = ((-u_xlat3.x) + u_xlat0_d.x);
          u_xlat3.x = ((u_xlat0_d.x * _Size) + (-2));
          u_xlat3.x = clamp(u_xlat3.x, 0, 1);
          ...
          u_xlat0_d.x = (u_xlat0_d.x + 1);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat10_1.w) + (-_Alpha));
          u_xlat16_2_d.x = ((u_xlat0_d.x * in_f.texcoord2.w) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat0_d.x * in_f.texcoord2.w);
          u_xlatb3 = (u_xlat16_2_d.x<0);
          if(((int(u_xlatb3) * (-1))!=0))
          {
              discard;
          }
          u_xlat3.xyz = (in_f.texcoord2.xyz * _ColorX.xyz);
          u_xlat3.xyz = (u_xlat0_d.xxx * u_xlat3.xyz);
          out_f.color.w = u_xlat0_d.x;
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = ((_Time.y * 2.25) + _Offset);
          u_xlat0_d.x = (u_xlat0_d.x + 1.10000002);
          u_xlat0_d.y = (((-in_f.texcoord1.x) * 2) + u_xlat0_d.x);
          u_xlat0_d.zw = ((in_f.texcoord1.xy * float2(2, 2)) + u_xlat0_d.xx);
          u_xlat0_d.x = ((in_f.texcoord1.y * 5) + u_xlat0_d.x);
          u_xlat0_d = sin(u_xlat0_d);
          u_xlat3_d = (u_xlat0_d.y + u_xlat0_d.z);
          u_xlat3_d = (u_xlat0_d.w + u_xlat3_d);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat3_d);
          u_xlat0_d.x = (u_xlat0_d.x + 5);
          u_xlat3_d = (u_xlat0_d.x * 0.200000003);
          u_xlat3_d = floor(u_xlat3_d);
          u_xlat0_d.x = ((u_xlat0_d.x * 0.200000003) + (-u_xlat3_d));
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord1.xy);
          u_xlat16_3 = dot(u_xlat10_1.xzy, float3(0.200000003, 0.200000003, 0.400000006));
          u_xlat0_d.x = (u_xlat16_3 + u_xlat0_d.x);
          u_xlat3_d = floor(u_xlat0_d.x);
          u_xlat0_d.x = ((-u_xlat3_d) + u_xlat0_d.x);
          u_xlat3_d = ((u_xlat0_d.x * _Size) + (-2));
