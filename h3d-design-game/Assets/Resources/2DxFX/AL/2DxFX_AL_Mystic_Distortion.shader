  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = max(abs(u_xlat0_d.y), 1);
          u_xlat6_d.x = (float(1) / u_xlat6_d.x);
          u_xlat9 = min(abs(u_xlat0_d.y), 1);
          u_xlat6_d.x = (u_xlat6_d.x * u_xlat9);
          u_xlat9 = (u_xlat6_d.x * u_xlat6_d.x);
          ...
          u_xlat1_d.x = (u_xlat9 * u_xlat6_d.x);
          u_xlat1_d.x = ((u_xlat1_d.x * (-2)) + 1.57079637);
          u_xlatb4 = (1<abs(u_xlat0_d.y));
          u_xlat1_d.x = (u_xlatb4)?(u_xlat1_d.x):(float(0));
          u_xlat6_d.x = ((u_xlat6_d.x * u_xlat9) + u_xlat1_d.x);
          u_xlat3 = min(u_xlat0_d.y, 1);
          u_xlatb3 = (u_xlat3<(-u_xlat3));
          u_xlat3 = (u_xlatb3)?((-u_xlat6_d.x)):(u_xlat6_d.x);
          u_xlat6_d.x = ((in_f.texcoord.y * _OffsetX) + _WaveTimeX);
          u_xlat6_d.x = sin(u_xlat6_d.x);
          u_xlat1_d.x = ((u_xlat6_d.x * _DistanceX) + in_f.texcoord.x);
          u_xlat6_d.x = ((u_xlat1_d.x * _OffsetY) + _WaveTimeY);
          u_xlat6_d.x = cos(u_xlat6_d.x);
          u_xlat1_d.y = ((u_xlat6_d.x * _DistanceY) + in_f.texcoord.y);
          u_xlat6_d.xy = (u_xlat1_d.xy + float2(-0.5, (-0.5)));
          u_xlat4_d = length(u_xlat6_d.xy);
          u_xlat1_d.x = rsqrt(u_xlat1_d.x);
          u_xlat6_d.xy = (u_xlat6_d.xy * u_xlat1_d.xx);
          ...
          u_xlat4_d = min(abs(u_xlat0_d.x), 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat4_d);
          u_xlat4_d = (u_xlat1_d.x * u_xlat1_d.x);
          u_xlat7 = ((u_xlat4_d * 0.0208350997) + (-0.0851330012));
          u_xlat7 = ((u_xlat4_d * u_xlat7) + 0.180141002);
          u_xlat7 = ((u_xlat4_d * u_xlat7) + (-0.330299497));
          u_xlat4_d = ((u_xlat4_d * u_xlat7) + 0.999866009);
          u_xlat7 = (u_xlat4_d * u_xlat1_d.x);
          u_xlat7 = ((u_xlat7 * (-2)) + 1.57079637);
          u_xlatb10 = (1<abs(u_xlat0_d.x));
          u_xlat0_d.x = min(u_xlat0_d.x, 1);
          u_xlatb0 = (u_xlat0_d.x<(-u_xlat0_d.x));
          u_xlat7 = (u_xlatb10)?(u_xlat7):(float(0));
          u_xlat1_d.x = ((u_xlat1_d.x * u_xlat4_d) + u_xlat7);
          u_xlat0_d.x = (u_xlatb0)?((-u_xlat1_d.x)):(u_xlat1_d.x);
          u_xlat0_d.xz = (u_xlat0_d.xx * u_xlat6_d.xy);
          u_xlat0_d.xz = (u_xlat0_d.xz * float2(0.5, 0.5));
          u_xlat0_d.xy = (u_xlat0_d.xz / float2(u_xlat3, u_xlat3));
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(0.5, 0.5));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat9 = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.x = max(abs(u_xlat0_d.x), 1);
          u_xlat1_d.x = (float(1) / u_xlat1_d.x);
          u_xlat4 = min(abs(u_xlat0_d.x), 1);
          u_xlat1_d.x = (u_xlat1_d.x * u_xlat4);
          u_xlat4 = (u_xlat1_d.x * u_xlat1_d.x);
          ...
          u_xlat7 = (u_xlat4 * u_xlat1_d.x);
          u_xlat7 = ((u_xlat7 * (-2)) + 1.57079637);
          u_xlatb10 = (1<abs(u_xlat0_d.x));
          u_xlat0_d.x = min(u_xlat0_d.x, 1);
          u_xlatb0 = (u_xlat0_d.x<(-u_xlat0_d.x));
          u_xlat7 = (u_xlatb10)?(u_xlat7):(float(0));
          u_xlat1_d.x = ((u_xlat1_d.x * u_xlat4) + u_xlat7);
          u_xlat0_d.x = (u_xlatb0)?((-u_xlat1_d.x)):(u_xlat1_d.x);
          u_xlat0_d.xz = (u_xlat0_d.xx * u_xlat6_d.xy);
          u_xlat0_d.xz = (u_xlat0_d.xz * float2(0.5, 0.5));
          u_xlat0_d.xy = (u_xlat0_d.xz / float2(u_xlat3, u_xlat3));
          ...
          u_xlat9 = tex2D(_LightTexture0, float2(u_xlat9, u_xlat9)).x;
          u_xlat16_2.xyz = (float3(u_xlat9, u_xlat9, u_xlat9) * _LightColor0.xyz);
          ...
          u_xlat16_11 = dot(in_f.texcoord1.xyz, u_xlat0_d.xyz);
          u_xlat16_11 = max(u_xlat16_11, 0);
          out_f.color.xyz = (float3(u_xlat16_11, u_xlat16_11, u_xlat16_11) * u_xlat16_2.xyz);
          return out_f;
      }
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (_Pitch + (-0.5));
          u_xlat0_d.xy = (u_xlat0_d.xx * float2(4.44289351, (-22.214468)));
          u_xlat6.x = max(abs(u_xlat0_d.y), 1);
          ...
          u_xlat6.x = ((in_f.texcoord.y * _OffsetX) + _WaveTimeX);
          u_xlat6.x = sin(u_xlat6.x);
          u_xlat1_d.x = ((u_xlat6.x * _DistanceX) + in_f.texcoord.x);
          u_xlat6.x = ((u_xlat1_d.x * _OffsetY) + _WaveTimeY);
          u_xlat6.x = cos(u_xlat6.x);
          u_xlat1_d.y = ((u_xlat6.x * _DistanceY) + in_f.texcoord.y);
          u_xlat6.xy = (u_xlat1_d.xy + float2(-0.5, (-0.5)));
          u_xlat4 = length(u_xlat6.xy);
          u_xlat1_d.x = rsqrt(u_xlat1_d.x);
          u_xlat6.xy = (u_xlat6.xy * u_xlat1_d.xx);
          u_xlat0_d.x = ((-u_xlat0_d.x) * u_xlat4);
          u_xlat0_d.x = (u_xlat0_d.x * 10);
          u_xlat1_d.x = max(abs(u_xlat0_d.x), 1);
          u_xlat1_d.x = (float(1) / u_xlat1_d.x);
          ...
          u_xlat1_d.x = ((u_xlat1_d.x * u_xlat4) + u_xlat7);
          u_xlat0_d.x = (u_xlatb0)?((-u_xlat1_d.x)):(u_xlat1_d.x);
          u_xlat0_d.xz = (u_xlat0_d.xx * u_xlat6.xy);
          u_xlat0_d.xz = (u_xlat0_d.xz * float2(0.5, 0.5));
          u_xlat0_d.xy = (u_xlat0_d.xz / float2(u_xlat3, u_xlat3));
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(0.5, 0.5));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat9 = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord2.xyz);
          u_xlat0_d.xyz = (float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz);
          u_xlat16_2_d.x = (u_xlat9 + (-0.0500000007));
          out_f.color.w = u_xlat9;
          u_xlatb9 = (u_xlat16_2_d.x<0);
          if(((int(u_xlatb9) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlat0_d.xyz = (float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz);
          u_xlat16_2 = (u_xlat9 + (-0.0500000007));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.x = max(abs(u_xlat0_d.y), 1);
          u_xlat6.x = (float(1) / u_xlat6.x);
          u_xlat9_d = min(abs(u_xlat0_d.y), 1);
          u_xlat6.x = (u_xlat6.x * u_xlat9_d);
          u_xlat9_d = (u_xlat6.x * u_xlat6.x);
          u_xlat1_d.x = ((u_xlat9_d * 0.0208350997) + (-0.0851330012));
          u_xlat1_d.x = ((u_xlat9_d * u_xlat1_d.x) + 0.180141002);
          u_xlat1_d.x = ((u_xlat9_d * u_xlat1_d.x) + (-0.330299497));
          u_xlat9_d = ((u_xlat9_d * u_xlat1_d.x) + 0.999866009);
          u_xlat1_d.x = (u_xlat9_d * u_xlat6.x);
          u_xlat1_d.x = ((u_xlat1_d.x * (-2)) + 1.57079637);
          u_xlatb4 = (1<abs(u_xlat0_d.y));
          u_xlat1_d.x = (u_xlatb4)?(u_xlat1_d.x):(float(0));
          u_xlat6.x = ((u_xlat6.x * u_xlat9_d) + u_xlat1_d.x);
          u_xlat3_d = min(u_xlat0_d.y, 1);
          u_xlatb3 = (u_xlat3_d<(-u_xlat3_d));
          u_xlat3_d = (u_xlatb3)?((-u_xlat6.x)):(u_xlat6.x);
          u_xlat6.x = ((in_f.texcoord1.y * _OffsetX) + _WaveTimeX);
          u_xlat6.x = sin(u_xlat6.x);
          u_xlat1_d.x = ((u_xlat6.x * _DistanceX) + in_f.texcoord1.x);
          u_xlat6.x = ((u_xlat1_d.x * _OffsetY) + _WaveTimeY);
          u_xlat6.x = cos(u_xlat6.x);
          u_xlat1_d.y = ((u_xlat6.x * _DistanceY) + in_f.texcoord1.y);
          u_xlat6.xy = (u_xlat1_d.xy + float2(-0.5, (-0.5)));
          u_xlat4 = length(u_xlat6.xy);
          u_xlat1_d.x = rsqrt(u_xlat1_d.x);
          u_xlat6.xy = (u_xlat6.xy * u_xlat1_d.xx);
          ...
          u_xlat0_d.xz = (u_xlat0_d.xx * u_xlat6.xy);
          u_xlat0_d.xz = (u_xlat0_d.xz * float2(0.5, 0.5));
          u_xlat0_d.xy = (u_xlat0_d.xz / float2(u_xlat3_d, u_xlat3_d));
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(0.5, 0.5));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_2 = (u_xlat0_d.x + (-0.0500000007));
