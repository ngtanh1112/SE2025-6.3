  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_2.x = (u_xlat1_d + (-0.0500000007));
          u_xlatb6 = (u_xlat16_2.x<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
              discard;
          }
          u_xlat6_d.x = ((_Time.x * 11.25) + 1.10000002);
          u_xlat11 = (((-in_f.texcoord.x) * 5) + u_xlat6_d.x);
          u_xlat3.xyz = ((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6_d.xxx);
          u_xlat3.xyz = sin(u_xlat3.xyz);
          u_xlat6_d.x = sin(u_xlat11);
          ...
          u_xlat11 = (u_xlat6_d.x * 0.200000003);
          u_xlat11 = floor(u_xlat11);
          u_xlat6_d.x = ((u_xlat6_d.x * 0.200000003) + (-u_xlat11));
          u_xlat16_11 = dot(u_xlat10_0.xzy, float3(0.200000003, 0.200000003, 0.400000006));
          u_xlat6_d.x = (u_xlat16_11 + u_xlat6_d.x);
          u_xlat11 = floor(u_xlat6_d.x);
          u_xlat6_d.x = ((-u_xlat11) + u_xlat6_d.x);
          u_xlat11 = ((u_xlat6_d.x * 6) + (-2));
          u_xlat11 = clamp(u_xlat11, 0, 1);
          u_xlat6_d.x = (((-u_xlat6_d.x) * 6) + 2);
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat6_d.x = (u_xlat6_d.x + u_xlat11);
          u_xlat15 = ((u_xlat6_d.x * u_xlat10_0.w) + (-_Alpha));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.412600011, 0.815199971, 0.172199994));
          u_xlat5 = ((-u_xlat15) + 1);
          u_xlat10 = (((-u_xlat0_d.x) * 0.115896732) + 1);
          u_xlat15 = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat10 = ((u_xlat15 * 2.58329701) + u_xlat10);
          u_xlat6_d.xyz = ((u_xlat0_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727));
          u_xlat3.xyz = (u_xlat0_d.xxx * float3(2.4000001, 1.5999999, 1.5999999));
          u_xlat3.xyz = (u_xlat3.xyz * u_xlat3.xyz);
          u_xlat3.xyz = (u_xlat3.xyz * u_xlat3.xyz);
          u_xlat6_d.xyz = ((float3(u_xlat15, u_xlat15, u_xlat15) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat6_d.xyz);
          u_xlat0_d.x = (u_xlat6_d.z / u_xlat10);
          u_xlat10 = (u_xlat6_d.x / u_xlat6_d.y);
          u_xlat15 = (u_xlat10 + u_xlat10);
          u_xlat0_d.z = (u_xlat10 * 3);
          u_xlat15 = (((-u_xlat0_d.x) * 8) + u_xlat15);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat0_d.x);
          u_xlat15 = (u_xlat15 + 4);
          u_xlat0_d.xz = (u_xlat0_d.xz / float2(u_xlat15, u_xlat15));
          u_xlat15 = ((-u_xlat0_d.z) + 1);
          u_xlat0_d.w = ((-u_xlat0_d.x) + u_xlat15);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat4_d.xz = (u_xlat0_d.wz * u_xlat0_d.xx);
          u_xlat4_d.y = 1;
          u_xlat0_d.xzw = (u_xlat4_d.xyz / float3(_Distortion, _Distortion, _Distortion));
          u_xlat0_d.xyz = ((u_xlat0_d.xzw * u_xlat3.xyz) + float3(u_xlat5, u_xlat5, u_xlat5));
          u_xlat6_d.xyz = ((u_xlat0_d.xyz * float3(0.5, 0.5, 0.5)) + float3(0.100000001, 0.100000001, 0.100000001));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d.x = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.412600011, 0.815199971, 0.172199994));
          u_xlat5 = ((-u_xlat15) + 1);
          u_xlat10_d = (((-u_xlat0_d.x) * 0.115896732) + 1);
          u_xlat15 = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat10_d = ((u_xlat15 * 2.58329701) + u_xlat10_d);
          u_xlat6_d.xyz = ((u_xlat0_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727));
          u_xlat3.xyz = (u_xlat0_d.xxx * float3(2.4000001, 1.5999999, 1.5999999));
          u_xlat3.xyz = (u_xlat3.xyz * u_xlat3.xyz);
          u_xlat3.xyz = (u_xlat3.xyz * u_xlat3.xyz);
          u_xlat6_d.xyz = ((float3(u_xlat15, u_xlat15, u_xlat15) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat6_d.xyz);
          u_xlat0_d.x = (u_xlat6_d.z / u_xlat10_d);
          u_xlat10_d = (u_xlat6_d.x / u_xlat6_d.y);
          u_xlat15 = (u_xlat10_d + u_xlat10_d);
          u_xlat0_d.z = (u_xlat10_d * 3);
          u_xlat15 = (((-u_xlat0_d.x) * 8) + u_xlat15);
          u_xlat0_d.x = (u_xlat0_d.x + u_xlat0_d.x);
          u_xlat15 = (u_xlat15 + 4);
          u_xlat0_d.xz = (u_xlat0_d.xz / float2(u_xlat15, u_xlat15));
          ...
          u_xlat0_d.w = ((-u_xlat0_d.x) + u_xlat15);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat4.xz = (u_xlat0_d.wz * u_xlat0_d.xx);
          u_xlat4.y = 1;
          u_xlat0_d.xzw = (u_xlat4.xyz / float3(_Distortion, _Distortion, _Distortion));
          u_xlat0_d.xyz = ((u_xlat0_d.xzw * u_xlat3.xyz) + float3(u_xlat5, u_xlat5, u_xlat5));
          u_xlat6_d.xyz = ((u_xlat0_d.xyz * float3(0.5, 0.5, 0.5)) + float3(0.100000001, 0.100000001, 0.100000001));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.215200007, 0.172199994));
          u_xlat0_d.xyz = (u_xlat0_d.xxx + u_xlat6_d.xyz);
          ...
          u_xlat16_2.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * _LightColor0.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d.x = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat16_2_d.x = (u_xlat1_d.x + (-0.0500000007));
          u_xlatb6 = (u_xlat16_2_d.x<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
              discard;
          }
          u_xlat6.x = ((_Time.x * 11.25) + 1.10000002);
          u_xlat11 = (((-in_f.texcoord.x) * 5) + u_xlat6.x);
          u_xlat3.xyz = ((in_f.texcoord.xyy * float3(5, 5, 12.5)) + u_xlat6.xxx);
          u_xlat3.xyz = sin(u_xlat3.xyz);
          ...
          u_xlat15 = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat10 = ((u_xlat15 * 2.58329701) + u_xlat10);
          u_xlat6.xyz = ((u_xlat0_d.xxx * float3(0.616473019, 3.36968088, 0.169122502)) + float3(0.860117733, 1, 0.317398727));
          u_xlat3.xyz = (u_xlat0_d.xxx * float3(2.4000001, 1.5999999, 1.5999999));
          u_xlat3.xyz = (u_xlat3.xyz * u_xlat3.xyz);
          u_xlat3.xyz = (u_xlat3.xyz * u_xlat3.xyz);
          u_xlat6.xyz = ((float3(u_xlat15, u_xlat15, u_xlat15) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat6.xyz);
          u_xlat0_d.x = (u_xlat6.z / u_xlat10);
          ...
          u_xlat0_d.xzw = (u_xlat4.xyz / float3(_Distortion, _Distortion, _Distortion));
          u_xlat0_d.xyz = ((u_xlat0_d.xzw * u_xlat3.xyz) + float3(u_xlat5, u_xlat5, u_xlat5));
          u_xlat6.xyz = ((u_xlat0_d.xyz * float3(0.5, 0.5, 0.5)) + float3(0.100000001, 0.100000001, 0.100000001));
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.212599993, 0.215200007, 0.172199994));
          u_xlat0_d.xyz = (u_xlat0_d.xxx + u_xlat6.xyz);
          u_xlat0_d.xyz = (u_xlat1_d.xxx * u_xlat0_d.xyz);
          out_f.color.w = u_xlat1_d.x;
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_2 = (u_xlat1_d + (-0.0500000007));
          u_xlatb6 = (u_xlat16_2<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
              discard;
          }
