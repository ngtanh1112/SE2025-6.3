Shader "2DxFX/Standard/GoldFX"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = ((_Time.x * 45) + 1.10000002);
          ...
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat2.w) + (-_Alpha));
          u_xlat3.x = dot(u_xlat2.xyz, float3(0.212599993, 0.715200007, 0.0722000003));
          ...
          u_xlat9 = ((-u_xlat0_d.y) + u_xlat0_d.w);
          u_xlat3.x = (float(1) / u_xlat0_d.y);
          u_xlat1_d.z = (u_xlat9 * u_xlat3.x);
          u_xlat3.x = (u_xlat0_d.z * u_xlat3.x);
          u_xlat1_d.x = (u_xlat3.x * 0.5);
          u_xlat1_d.y = 2;
          u_xlat3.xyz = (u_xlat1_d.xyz / float3(_Distortion, _Distortion, _Distortion));
          out_f.color.xyz = ((u_xlat3.xyz * u_xlat2.xyz) + u_xlat0_d.xxx);
          return out_f;
      }
