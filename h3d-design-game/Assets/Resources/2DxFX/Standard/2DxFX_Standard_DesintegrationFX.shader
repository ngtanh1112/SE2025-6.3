  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xyz = (u_xlat0_d.yzw * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d));
          u_xlat2.x = (((-u_xlat0_d.x) * u_xlat1_d) + 1);
          u_xlat2.xyz = ((u_xlat6.xyz * u_xlat2.xxx) + _ColorX.xyz);
          u_xlat5.xyz = (((-u_xlat0_d.yzw) * float3(u_xlat1_d, u_xlat1_d, u_xlat1_d)) + u_xlat2.xyz);
          out_f.color.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat5.xyz) + u_xlat6.xyz);
