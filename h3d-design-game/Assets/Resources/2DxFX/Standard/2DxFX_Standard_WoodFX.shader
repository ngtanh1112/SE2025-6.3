Shader "2DxFX/Standard/WoodFX"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = (in_f.texcoord.xy + float2(-0.0500000007, 0.0199999996));
          u_xlat4 = (((-u_xlat0_d.x) * 20) + 46.0999985);
          u_xlat4 = sin(u_xlat4);
          u_xlat1_d.xyz = ((u_xlat0_d.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat10_0.xyw = tex2D(_MainTex, u_xlat0_d.xy).xyz;
          u_xlat16_0 = dot(u_xlat10_0.xyw, float3(11.1999998, 8.39999962, 4.19999981));
          u_xlat1_d.xyz = sin(u_xlat1_d.xyz);
          ...
          u_xlat1_d.xyz = ((in_f.texcoord.xyy * float3(20, 20, 50)) + float3(46.0999985, 46.0999985, 46.0999985));
          u_xlat1_d.xyz = sin(u_xlat1_d.xyz);
          ...
          u_xlatb4 = (u_xlat2.x<0.300000012);
          u_xlat2.x = (u_xlatb4)?(0.300000012):(u_xlat2.x);
          u_xlat0_d.x = (((-u_xlat0_d.x) * 0.125) + u_xlat2.x);
          u_xlat0_d.xyz = (u_xlat0_d.xxx + float3(0.25, 0, (-0.150000006)));
          u_xlat0_d.xyz = ((-u_xlat10_1.xyz) + u_xlat0_d.xyz);
