Shader "2DxFX/Standard/Wave"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_Vert out_v;
          u_xlat0.x = ((in_v.texcoord.y * _OffsetX) + _WaveTimeX);
          u_xlat0.x = sin(u_xlat0.x);
          u_xlat0.x = ((u_xlat0.x * _DistanceX) + in_v.texcoord.x);
          u_xlat2 = ((u_xlat0.x * _OffsetY) + _WaveTimeY);
          out_v.texcoord.x = u_xlat0.x;
          u_xlat0.x = cos(u_xlat2);
          out_v.texcoord.y = ((u_xlat0.x * _DistanceY) + in_v.texcoord.y);
