  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat12 = (2 / u_xlat12);
          u_xlat1_d.xy = (u_xlat1_d.xy / float2(u_xlat12, u_xlat12));
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat1_d.xy).xyz;
          u_xlat12 = (u_xlat8 * 20);
          u_xlat1_d = (float4(u_xlat12, u_xlat12, u_xlat12, u_xlat12) * u_xlat10_1.xyxz);
          u_xlat2.xy = ((u_xlat1_d.xx * float2(0.03125, 0.03125)) + in_f.texcoord.xy);
          ...
          out_f.color.y = ((u_xlat1_d.y * 0.125) + u_xlat0_d.z);
          out_f.color.xz = (((-u_xlat1_d.zw) * float2(0.125, 0.125)) + u_xlat0_d.xw);
