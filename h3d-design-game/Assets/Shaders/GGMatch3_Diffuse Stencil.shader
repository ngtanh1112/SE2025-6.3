  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_6.xyz = (u_xlat10_0.xyz * in_f.color.xyz);
          u_xlat16_3 = (u_xlat16_2 * in_f.color.w);
          out_f.color.xyz = (u_xlat16_6.xyz * float3(u_xlat16_3, u_xlat16_3, u_xlat16_3));
