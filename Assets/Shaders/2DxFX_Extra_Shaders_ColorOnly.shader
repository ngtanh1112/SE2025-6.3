Shader "2DxFX_Extra_Shaders/ColorOnly"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      uniform float4 _FillColor_Color_1;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xyz = ((-u_xlat10_0.xyz) + _FillColor_Color_1.xyz);
          u_xlat0_d.xyz = ((_FillColor_Color_1.www * u_xlat1_d.xyz) + u_xlat10_0.xyz);
