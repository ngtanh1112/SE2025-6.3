	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_ColorR", this._ColorR);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_ColorG", this._ColorG);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_ColorB", this._ColorB);
				return;
			}
