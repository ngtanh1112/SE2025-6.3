	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				this.CanvasSpriteRenderer.sharedMaterial.SetColor("TeleportationColor", this.TeleportationColor);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Distortion", this._Distortion);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Fade", this._Fade);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_HDR_Intensity", this._HDR_Intensity);
				return;
			}
