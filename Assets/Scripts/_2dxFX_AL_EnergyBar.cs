	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Value1", this.BarProgress);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Value2", 1f - this._Value2);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Value3", 1f - this._Value3);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Value4", this._Value4);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Value5", this._Value5);
				return;
			}
