	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				if (this.Wind != null)
				{
					this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Wind2", this.Wind.Evaluate(this.WindTime2));
				}
				if (this.Wind != null)
				{
					this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Wind3", this.Wind.Evaluate(this.WindTime3));
				}
				if (this.Wind != null)
				{
					this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Wind4", this.Wind.Evaluate(this.WindTime4));
				}
