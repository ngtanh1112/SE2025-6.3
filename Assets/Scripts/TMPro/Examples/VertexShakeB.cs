...
namespace TMPro.Examples
{
	public class VertexShakeB : MonoBehaviour
	{
		...
		{
			return new VertexShakeB._003CAnimateVertexColors_003Ed__10(0)
			{
		...
		private sealed class _003CAnimateVertexColors_003Ed__10 : IEnumerator<object>, IEnumerator, IDisposable
		{
			...
			bool IEnumerator.MoveNext()
			{
				...
				VertexShakeB vertexShakeB = this._003C_003E4__this;
				switch (num)
				{
				case 0:
					this._003C_003E1__state = -1;
					vertexShakeB.m_TextComponent.ForceMeshUpdate();
					this._003CtextInfo_003E5__2 = vertexShakeB.m_TextComponent.textInfo;
				...
				for (int j = 0; j < lineCount; j++)
				{
					...
					for (int k = firstCharacterIndex; k <= lastCharacterIndex; k++)
					{
						if (this._003CtextInfo_003E5__2.characterInfo[k].isVisible)
						{
							...
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex] = vertices[vertexIndex] - b2;
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 1] = vertices[vertexIndex + 1] - b2;
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 2] = vertices[vertexIndex + 2] - b2;
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 3] = vertices[vertexIndex + 3] - b2;
							...
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex] += b2;
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 1] += b2;
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 2] += b2;
							this._003CcopyOfVertices_003E5__3[materialReferenceIndex][vertexIndex + 3] += b2;
				...
				for (int l = 0; l < this._003CtextInfo_003E5__2.meshInfo.Length; l++)
				{
					...
					vertexShakeB.m_TextComponent.UpdateGeometry(this._003CtextInfo_003E5__2.meshInfo[l].mesh, l);
				}
