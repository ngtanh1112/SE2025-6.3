	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				this.CanvasSpriteRenderer.sharedMaterial.SetColor("_ColorX", this._ColorX);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_OutLineSpread", this._OutLineSpread);
				return;
			}
