	...
	private void XUpdate()
	{
		...
		if (this.ActiveChange)
		{
			if (this.CanvasSpriteRenderer != null)
			{
				...
				this.CanvasSpriteRenderer.sharedMaterial.SetColor("_ColorX", this._Color);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Tolerance", this._Tolerance);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_HueShift", this._HueShift);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Sat", this._Saturation);
				this.CanvasSpriteRenderer.sharedMaterial.SetFloat("_Val", this._ValueBrightness);
				return;
			}
