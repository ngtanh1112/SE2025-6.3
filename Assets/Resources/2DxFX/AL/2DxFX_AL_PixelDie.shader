  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat8.xy = ((u_xlat0_d.xy * float2(-2, (-2))) + float2(3, 3));
          u_xlat0_d.xy = (u_xlat0_d.xy * u_xlat0_d.xy);
          u_xlat0_d.x = (((-u_xlat8.x) * u_xlat0_d.x) + 1);
          u_xlat1_d.xy = (u_xlat0_d.xx * in_f.texcoord.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat8.x = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat2.xy = ((u_xlat0_d.xx * float2(2, 2)) + u_xlat1_d.xy);
          u_xlat0_d.x = ((u_xlat8.y * u_xlat0_d.y) + u_xlat1_d.z);
          u_xlat2.z = ((_Value1 * 4) + u_xlat0_d.x);
          u_xlat0_d.x = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat8.x * u_xlat0_d.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat8.x);
          u_xlatb4 = (u_xlat16_3.x<0);
          if(((int(u_xlatb4) * (-1))!=0))
          {
              discard;
          }
          u_xlat4_d.xyz = (u_xlat0_d.xxx * u_xlat2.xyz);
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_3.xyz = (u_xlat4_d.xyz * _LightColor0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat8.x = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat2_d.xy = ((u_xlat0_d.xx * float2(2, 2)) + u_xlat1_d.xy);
          u_xlat0_d.x = ((u_xlat8.y * u_xlat0_d.y) + u_xlat1_d.z);
          u_xlat2_d.z = ((_Value1 * 4) + u_xlat0_d.x);
          u_xlat0_d.x = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat8.x * u_xlat0_d.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat8.x);
          u_xlatb4 = (u_xlat16_3.x<0);
          ...
          u_xlat4.xyz = (u_xlat0_d.xxx * u_xlat2_d.xyz);
          out_f.color.w = u_xlat0_d.x;
          ...
          u_xlat16_3.xyz = (u_xlat0_d.xxx * _LightColor0.xyz);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((_Value1 * 1.20000005) + (-u_xlat10_0));
          u_xlat0_d = (u_xlat0_d + u_xlat0_d);
          u_xlat0_d = clamp(u_xlat0_d, 0, 1);
          u_xlat2.x = ((u_xlat0_d * (-2)) + 3);
          u_xlat0_d = (u_xlat0_d * u_xlat0_d);
          u_xlat0_d = (((-u_xlat2.x) * u_xlat0_d) + 1);
          u_xlat2.xy = (float2(u_xlat0_d, u_xlat0_d) * in_f.texcoord.xy);
          u_xlat10_2 = tex2D(_MainTex, u_xlat2.xy).w;
          u_xlat2.x = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d = (u_xlat0_d * u_xlat2.x);
          u_xlat2.x = ((-_Alpha) + 1);
          u_xlat16_1 = ((u_xlat0_d * u_xlat2.x) + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = (u_xlat0_d.xy + u_xlat0_d.xy);
          u_xlat0_d.xy = clamp(u_xlat0_d.xy, 0, 1);
          u_xlat8_d.xy = ((u_xlat0_d.xy * float2(-2, (-2))) + float2(3, 3));
          u_xlat0_d.xy = (u_xlat0_d.xy * u_xlat0_d.xy);
          u_xlat0_d.x = (((-u_xlat8_d.x) * u_xlat0_d.x) + 1);
          u_xlat1_d.xy = (u_xlat0_d.xx * in_f.texcoord.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord2);
          u_xlat8_d.x = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = ((-u_xlat0_d.x) + 1);
          u_xlat2.xy = ((u_xlat0_d.xx * float2(2, 2)) + u_xlat1_d.xy);
          u_xlat0_d.x = ((u_xlat8_d.y * u_xlat0_d.y) + u_xlat1_d.z);
          u_xlat2.z = ((_Value1 * 4) + u_xlat0_d.x);
          u_xlat0_d.x = ((-_Alpha) + 1);
          u_xlat16_3_d.x = ((u_xlat8_d.x * u_xlat0_d.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat8_d.x);
          u_xlatb4 = (u_xlat16_3_d.x<0);
          if(((int(u_xlatb4) * (-1))!=0))
          {
              discard;
          }
          u_xlat4.xyz = (u_xlat0_d.xxx * u_xlat2.xyz);
          out_f.color.w = u_xlat0_d.x;
          ...
          out_f.color.xyz = (u_xlat4.xyz * u_xlat1_d.xyz);
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.z = ((_Value1 * 4) + u_xlat0_d.x);
          u_xlat0_d.x = ((-_Alpha) + 1);
          u_xlat16_3 = ((u_xlat8.x * u_xlat0_d.x) + (-0.0500000007));
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat8.x);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex2, in_f.texcoord1.xy).x;
          u_xlat0_d = ((_Value1 * 1.20000005) + (-u_xlat10_0));
          u_xlat0_d = (u_xlat0_d + u_xlat0_d);
          u_xlat0_d = clamp(u_xlat0_d, 0, 1);
          u_xlat2_d.x = ((u_xlat0_d * (-2)) + 3);
          u_xlat0_d = (u_xlat0_d * u_xlat0_d);
          u_xlat0_d = (((-u_xlat2_d.x) * u_xlat0_d) + 1);
          u_xlat2_d.xy = (float2(u_xlat0_d, u_xlat0_d) * in_f.texcoord1.xy);
          u_xlat10_2 = tex2D(_MainTex, u_xlat2_d.xy).w;
          u_xlat2_d.x = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d = (u_xlat0_d * u_xlat2_d.x);
          u_xlat2_d.x = ((-_Alpha) + 1);
          u_xlat16_1 = ((u_xlat0_d * u_xlat2_d.x) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
