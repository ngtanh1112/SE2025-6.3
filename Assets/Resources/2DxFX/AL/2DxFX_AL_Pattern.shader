  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = (in_f.texcoord.xy + float2(_OffsetX, _OffsetY));
          u_xlat10_1 = tex2D(_MainTex2, u_xlat3.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d = ((u_xlat1_d.w * u_xlat10_0) + (-_Alpha));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1 = tex2D(_MainTex2, u_xlat3.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d.x = ((u_xlat1_d.w * u_xlat10_0) + (-_Alpha));
