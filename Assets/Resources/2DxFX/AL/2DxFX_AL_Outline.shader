  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MainTex, u_xlat0_d.zw).w;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          u_xlat4_d.xy = (in_f.texcoord.xy + float2(_OutLineSpread, _OutLineSpread));
          u_xlat10_4 = tex2D(_MainTex, u_xlat4_d.xy).w;
          u_xlat16_0 = (u_xlat10_4 + u_xlat16_0);
          u_xlat4_d.xy = (in_f.texcoord.xy + (-float2(_OutLineSpread, _OutLineSpread)));
          u_xlat10_4 = tex2D(_MainTex, u_xlat4_d.xy).w;
          u_xlat0_d.x = (u_xlat10_4 + u_xlat16_0);
          u_xlatb4 = (0.400000006<u_xlat0_d.x);
          u_xlat0_d.x = (u_xlatb4)?(_ColorX.w):(u_xlat0_d.x);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlatb4 = (0.400000006<u_xlat1_d.w);
          u_xlat2.w = (u_xlatb4)?(u_xlat1_d.w):(u_xlat0_d.x);
          u_xlat2.xyz = (int(u_xlatb4))?(u_xlat1_d.xyz):(_ColorX.xyz);
          u_xlat0_d = (u_xlat2 * in_f.texcoord3.wwww);
          u_xlat16_3.x = ((u_xlat2.w * in_f.texcoord3.w) + (-0.0500000007));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_4 = tex2D(_MainTex, u_xlat0_d.zw).w;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          u_xlat4.xy = (in_f.texcoord.xy + float2(_OutLineSpread, _OutLineSpread));
          ...
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlatb4 = (0.400000006<u_xlat1_d.w);
          u_xlat2_d.w = (u_xlatb4)?(u_xlat1_d.w):(u_xlat0_d.x);
          u_xlat2_d.xyz = (int(u_xlatb4))?(u_xlat1_d.xyz):(_ColorX.xyz);
          u_xlat0_d = (u_xlat2_d * in_f.texcoord3.wwww);
          u_xlat16_3.x = ((u_xlat2_d.w * in_f.texcoord3.w) + (-0.0500000007));
          u_xlatb1 = (u_xlat16_3.x<0);
          if(((int(u_xlatb1) * (-1))!=0))
          {
              discard;
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((float4(_OutLineSpread, _OutLineSpread, _OutLineSpread, _OutLineSpread) * float4(-1, 1, 1, (-1))) + in_f.texcoord.xyxy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat10_2 = tex2D(_MainTex, u_xlat0_d.zw).w;
          u_xlat16_0 = (u_xlat10_2 + u_xlat10_0);
          u_xlat2.xy = (in_f.texcoord.xy + float2(_OutLineSpread, _OutLineSpread));
          u_xlat10_2 = tex2D(_MainTex, u_xlat2.xy).w;
          u_xlat16_0 = (u_xlat10_2 + u_xlat16_0);
          u_xlat2.xy = (in_f.texcoord.xy + (-float2(_OutLineSpread, _OutLineSpread)));
          u_xlat10_2 = tex2D(_MainTex, u_xlat2.xy).w;
          u_xlat0_d.x = (u_xlat10_2 + u_xlat16_0);
          u_xlatb2 = (0.400000006<u_xlat0_d.x);
          u_xlat0_d.x = (u_xlatb2)?(_ColorX.w):(u_xlat0_d.x);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat2.x = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlatb4 = (0.400000006<u_xlat2.x);
          u_xlat0_d.x = (u_xlatb4)?(u_xlat2.x):(u_xlat0_d.x);
          u_xlat16_1 = ((u_xlat0_d.x * in_f.texcoord3.w) + (-0.0500000007));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.w = (u_xlatb4)?(u_xlat1_d.w):(u_xlat0_d.x);
          u_xlat2.xyz = (int(u_xlatb4))?(u_xlat1_d.xyz):(_ColorX.xyz);
          u_xlat0_d = (u_xlat2 * in_f.texcoord2.wwww);
          u_xlat16_3_d.x = ((u_xlat2.w * in_f.texcoord2.w) + (-0.0500000007));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = (int(u_xlatb4))?(u_xlat1_d.xyz):(_ColorX.xyz);
          u_xlat0_d = (u_xlat2 * in_f.texcoord3.wwww);
          u_xlat16_3 = ((u_xlat2.w * in_f.texcoord3.w) + (-0.0500000007));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = ((float4(_OutLineSpread, _OutLineSpread, _OutLineSpread, _OutLineSpread) * float4(-1, 1, 1, (-1))) + in_f.texcoord1.xyxy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat10_2 = tex2D(_MainTex, u_xlat0_d.zw).w;
          u_xlat16_0 = (u_xlat10_2 + u_xlat10_0);
          u_xlat2_d.xy = (in_f.texcoord1.xy + float2(_OutLineSpread, _OutLineSpread));
          u_xlat10_2 = tex2D(_MainTex, u_xlat2_d.xy).w;
          u_xlat16_0 = (u_xlat10_2 + u_xlat16_0);
          u_xlat2_d.xy = (in_f.texcoord1.xy + (-float2(_OutLineSpread, _OutLineSpread)));
          u_xlat10_2 = tex2D(_MainTex, u_xlat2_d.xy).w;
          u_xlat0_d.x = (u_xlat10_2 + u_xlat16_0);
          ...
          u_xlat2_d.x = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlatb4 = (0.400000006<u_xlat2_d.x);
          u_xlat0_d.x = (u_xlatb4)?(u_xlat2_d.x):(u_xlat0_d.x);
          u_xlat16_1 = ((u_xlat0_d.x * in_f.texcoord3.w) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
