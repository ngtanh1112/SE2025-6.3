  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.xyz = sin(u_xlat6_d.xyz);
          ...
          u_xlat3.xyz = (((-u_xlat0_d.xxx) * float3(float3(_Colors, _Colors, _Colors))) + float3(2, 4, 6));
          u_xlat3.xyz = clamp(u_xlat3.xyz, 0, 1);
          u_xlat4_d.xy = ((u_xlat0_d.xx * float2(float2(_Colors, _Colors))) + float2(-4, (-2)));
          u_xlat4_d.xy = clamp(u_xlat4_d.xy, 0, 1);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = (((-u_xlat0_d.xxx) * float3(float3(_Colors, _Colors, _Colors))) + float3(2, 4, 6));
          u_xlat3.xyz = clamp(u_xlat3.xyz, 0, 1);
          u_xlat4.xy = ((u_xlat0_d.xx * float2(float2(_Colors, _Colors))) + float2(-4, (-2)));
