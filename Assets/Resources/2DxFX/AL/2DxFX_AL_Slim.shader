  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat15 = (2 / u_xlat15);
          u_xlat0_d.xy = (u_xlat0_d.xy / float2(u_xlat15, u_xlat15));
          u_xlat10_0.xyw = tex2D(_MainTex2, u_xlat0_d.xy).xyz;
          u_xlat1_d.x = (u_xlat10 * 20);
          u_xlat1_d = (u_xlat10_0.xyxw * u_xlat1_d.xxxx);
          u_xlat0_d.xy = ((u_xlat1_d.xx * float2(0.03125, 0.03125)) + in_f.texcoord.xy);
          ...
          u_xlat5.xyz = ((u_xlat5.xxx * float3(0.5, 0.5, 0.5)) + u_xlat2.xyz);
          u_xlat2.y = ((u_xlat1_d.y * 0.125) + u_xlat5.y);
          u_xlat2.xz = (((-u_xlat1_d.zw) * float2(0.125, 0.125)) + u_xlat5.xz);
          u_xlat5.xyz = (u_xlat0_d.xxx * u_xlat2.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5.x = clamp(u_xlat5.x, 0, 1);
          u_xlat5.x = ((-u_xlat5.x) + 1);
          u_xlat5.xyz = ((u_xlat5.xxx * float3(0.5, 0.5, 0.5)) + u_xlat2_d.xyz);
          u_xlat2_d.y = ((u_xlat1_d.y * 0.125) + u_xlat5.y);
          u_xlat2_d.xz = (((-u_xlat1_d.zw) * float2(0.125, 0.125)) + u_xlat5.xz);
          u_xlat5.xyz = (u_xlat0_d.xxx * u_xlat2_d.xyz);
          out_f.color.w = u_xlat0_d.x;
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.xy = (u_xlat1_d.xy / u_xlat6_d.xx);
          u_xlat10_6 = tex2D(_MainTex2, u_xlat6_d.xy).x;
          u_xlat6_d.x = (u_xlat10_6 * u_xlat3);
          u_xlat6_d.xy = ((u_xlat6_d.xx * float2(0.625, 0.625)) + in_f.texcoord.xy);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.xy = (u_xlat1_d.xy / u_xlat6.xx);
          u_xlat10_6 = tex2D(_MainTex2, u_xlat6.xy).x;
          u_xlat6.x = (u_xlat10_6 * u_xlat3_d);
          u_xlat6.xy = ((u_xlat6.xx * float2(0.625, 0.625)) + in_f.texcoord1.xy);
