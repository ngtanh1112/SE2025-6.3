  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb5.x = (u_xlat0_d.x>=(-u_xlat0_d.x));
          u_xlat10 = frac(abs(u_xlat0_d.x));
          u_xlat0_d.y = (u_xlatb5.x)?(u_xlat10):((-u_xlat10));
          ...
          u_xlat0_d.x = (u_xlatb5.x)?(u_xlat0_d.x):((-u_xlat0_d.x));
          ...
          u_xlatb12.xy = bool4(u_xlat2.xyxy >= (-u_xlat2.xyxy)).xy;
          ...
          u_xlat5.x = (((-u_xlat5.z) * 0.125) + u_xlat0_d.y);
          u_xlat2.x = ((u_xlat12.y * 0.125) + u_xlat0_d.x);
          u_xlat2.y = (u_xlat5.x + 1);
          ...
          u_xlat15 = ((-_Alpha) + 1);
          u_xlat16_4 = ((u_xlat1_d.w * u_xlat15) + (-0.0500000007));
          u_xlat15 = (u_xlat15 * u_xlat1_d.w);
          u_xlat0_d.xyz = ((u_xlat0_d.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat1_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat15;
          u_xlat16_9.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
          u_xlatb0 = (u_xlat16_4<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
          }
          u_xlat16_4 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_4 = max(u_xlat16_4, 0);
          out_f.color.xyz = (float3(u_xlat16_4, u_xlat16_4, u_xlat16_4) * u_xlat16_9.xyz);
          return out_f;
      }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.y = (u_xlatb5.x)?(u_xlat10_d):((-u_xlat10_d));
          u_xlat0_d.xy = (u_xlat0_d.xy * float2(0.125, 8));
          u_xlat5.x = floor(u_xlat0_d.y);
          u_xlat1_d = ((in_f.texcoord.xyxy * float4(0.0892857164, 0.0892857164, 0.125, 0.125)) + float4(0.0219999999, 0.0219999999, (-0.0500000007), 0));
          ...
          u_xlat1_d.xy = tex2D(_MainTex2, u_xlat2_d.xy).zy;
          u_xlat0_d.x = (u_xlat1_d.y + 0.100000001);
          u_xlat2_d.xy = (_Time.xx + float2(0.200000003, 0.600000024));
          u_xlat2_d.xy = (u_xlat2_d.xy * float2(float2(_Value1, _Value1)));
          u_xlatb12.xy = bool4(u_xlat2_d.xyxy >= (-u_xlat2_d.xyxy)).xy;
          u_xlat3.xy = frac(abs(u_xlat2_d.xy));
          u_xlat2_d.z = (u_xlatb12.x)?(u_xlat3.x):((-u_xlat3.x));
          u_xlat2_d.w = (u_xlatb12.y)?(u_xlat3.y):((-u_xlat3.y));
          u_xlat2_d = (u_xlat2_d * float4(0.125, 0.125, 8, 8));
          u_xlat12.xy = floor(u_xlat2_d.zw);
          u_xlat3.x = ((u_xlat12.x * 0.125) + u_xlat5.x);
          u_xlatb5.xz = bool4(u_xlat2_d.xxyy >= (-u_xlat2_d.xxyy)).xz;
          u_xlat2_d.xy = frac(abs(u_xlat2_d.xy));
          u_xlat5.x = (u_xlatb5.x)?(u_xlat2_d.x):((-u_xlat2_d.x));
          u_xlat5.z = (u_xlatb5.z)?(u_xlat2_d.y):((-u_xlat2_d.y));
          u_xlat5.xz = (u_xlat5.xz * float2(8, 8));
          u_xlat5.xz = floor(u_xlat5.xz);
          u_xlat5.x = (((-u_xlat5.x) * 0.125) + u_xlat5.y);
          u_xlat3.y = (u_xlat5.x + 1);
          u_xlat2_d.xy = tex2D(_MainTex2, u_xlat3.xy).zy;
          u_xlat2_d.z = (u_xlat0_d.x + u_xlat2_d.y);
          u_xlat1_d.z = float(0.100000001);
          u_xlat1_d.w = float(0.100000001);
          ...
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999));
          u_xlat5.x = (((-u_xlat5.z) * 0.125) + u_xlat0_d.y);
          u_xlat2_d.x = ((u_xlat12.y * 0.125) + u_xlat0_d.x);
          u_xlat2_d.y = (u_xlat5.x + 1);
          u_xlat0_d.xy = tex2D(_MainTex2, u_xlat2_d.xy).zy;
          u_xlat0_d.z = (u_xlat1_d.z + u_xlat0_d.y);
          u_xlat0_d.xyz = (u_xlat0_d.xyz + u_xlat1_d.xyw);
          u_xlat1_d.xy = ((u_xlat0_d.yy * float2(0.015625, 0.015625)) + in_f.texcoord.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat15 = ((-_Alpha) + 1);
          u_xlat16_4.x = ((u_xlat1_d.w * u_xlat15) + (-0.0500000007));
          u_xlat15 = (u_xlat15 * u_xlat1_d.w);
          u_xlat0_d.xyz = ((u_xlat0_d.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat1_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat15;
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.y = (u_xlat0_d.x + 1);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat2.xy).y;
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat2.xy).y;
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat1_d.xy).y;
          u_xlat16_0 = (u_xlat10_4 + u_xlat16_0);
          u_xlat0_d.xy = ((float2(u_xlat16_0, u_xlat16_0) * float2(0.015625, 0.015625)) + in_f.texcoord.xy);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.w = (u_xlatb12.y)?(u_xlat3.y):((-u_xlat3.y));
          u_xlat2 = (u_xlat2 * float4(0.125, 0.125, 8, 8));
          u_xlat12_d.xy = floor(u_xlat2.zw);
          u_xlat3.x = ((u_xlat12_d.x * 0.125) + u_xlat5.x);
          u_xlatb5.xz = bool4(u_xlat2.xxyy >= (-u_xlat2.xxyy)).xz;
          u_xlat2.xy = frac(abs(u_xlat2.xy));
          u_xlat5.x = (u_xlatb5.x)?(u_xlat2.x):((-u_xlat2.x));
          u_xlat5.z = (u_xlatb5.z)?(u_xlat2.y):((-u_xlat2.y));
          ...
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.714285731, 0.714285731)) + float2(0.0219999999, 0.0219999999));
          u_xlat5.x = (((-u_xlat5.z) * 0.125) + u_xlat0_d.y);
          u_xlat2.x = ((u_xlat12_d.y * 0.125) + u_xlat0_d.x);
          u_xlat2.y = (u_xlat5.x + 1);
          u_xlat0_d.xy = tex2D(_MainTex2, u_xlat2.xy).zy;
          u_xlat0_d.z = (u_xlat1_d.z + u_xlat0_d.y);
          u_xlat0_d.xyz = (u_xlat0_d.xyz + u_xlat1_d.xyw);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.y = (u_xlat0_d.x + 1);
          u_xlat10_0 = tex2D(_MainTex2, u_xlat2_d.xy).y;
          u_xlat1_d.xy = (_Time.xx + float2(0.200000003, 0.600000024));
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(float2(_Value1, _Value1)));
          u_xlatb9.xy = bool4(u_xlat1_d.xyxy >= (-u_xlat1_d.xyxy)).xy;
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat2_d.xy).y;
          u_xlat16_0 = (u_xlat10_4 + u_xlat10_0);
          ...
          u_xlat10_4 = tex2D(_MainTex2, u_xlat1_d.xy).y;
          u_xlat16_0 = (u_xlat10_4 + u_xlat16_0);
          u_xlat0_d.xy = ((float2(u_xlat16_0, u_xlat16_0) * float2(0.015625, 0.015625)) + in_f.texcoord1.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
          u_xlat4.x = ((-_Alpha) + 1);
