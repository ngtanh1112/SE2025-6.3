  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4_d = dot(u_xlat2.xyz, float3(0.298999995, 0.587000012, 0.114));
          u_xlat4_d = (u_xlat4_d * _Value5);
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.x) + u_xlat4_d);
          u_xlat4_d = ((_Value2 * 0.5) + _Distortion);
          u_xlat0_d.x = ((-u_xlat0_d.x) + u_xlat4_d);
          u_xlat4_d = (float(1) / _Value2);
          u_xlat0_d.x = (u_xlat4_d * u_xlat0_d.x);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat4_d = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat8 = (((-u_xlat4_d) * u_xlat0_d.x) + 1);
          u_xlat0_d.x = ((u_xlat4_d * u_xlat0_d.x) + (-u_xlat8));
          u_xlat0_d.x = ((-abs(u_xlat0_d.x)) + 1);
          u_xlat0_d.x = (abs(u_xlat0_d.x) * _Value3);
          u_xlat1_d.xyz = ((u_xlat10_1.xyz * in_f.texcoord3.xyz) + u_xlat0_d.xxx);
          u_xlat4_d = ((-_Alpha) + 1);
          u_xlat1_d.w = (u_xlat4_d * u_xlat2.w);
          u_xlat0_d.w = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = float(1);
          u_xlat0_d.y = float(1);
          u_xlat0_d.z = float(1);
          u_xlat0_d = ((-u_xlat1_d) + u_xlat0_d);
          u_xlat0_d = ((float4(float4(_Value4, _Value4, _Value4, _Value4)) * u_xlat0_d) + u_xlat1_d);
          u_xlat16_3.x = (u_xlat0_d.w + (-0.0500000007));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4 = dot(u_xlat2_d.xyz, float3(0.298999995, 0.587000012, 0.114));
          u_xlat4 = (u_xlat4 * _Value5);
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.x) + u_xlat4);
          u_xlat4 = ((_Value2 * 0.5) + _Distortion);
          u_xlat0_d.x = ((-u_xlat0_d.x) + u_xlat4);
          u_xlat4 = (float(1) / _Value2);
          u_xlat0_d.x = (u_xlat4 * u_xlat0_d.x);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat4 = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat8 = (((-u_xlat4) * u_xlat0_d.x) + 1);
          u_xlat0_d.x = ((u_xlat4 * u_xlat0_d.x) + (-u_xlat8));
          u_xlat0_d.x = ((-abs(u_xlat0_d.x)) + 1);
          u_xlat0_d.x = (abs(u_xlat0_d.x) * _Value3);
          u_xlat1_d.xyz = ((u_xlat10_1.xyz * in_f.texcoord3.xyz) + u_xlat0_d.xxx);
          u_xlat4 = ((-_Alpha) + 1);
          u_xlat1_d.w = (u_xlat4 * u_xlat2_d.w);
          u_xlat0_d.w = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = float(1);
          u_xlat0_d.y = float(1);
          u_xlat0_d.z = float(1);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.298999995, 0.587000012, 0.114));
          u_xlat0_d.x = (u_xlat0_d.x * _Value5);
          u_xlat10_2 = tex2D(_MainTex2, in_f.texcoord.xy).x;
          u_xlat0_d.x = ((u_xlat10_2 * in_f.texcoord3.x) + u_xlat0_d.x);
          u_xlat2 = ((_Value2 * 0.5) + _Distortion);
          u_xlat0_d.x = ((-u_xlat0_d.x) + u_xlat2);
          u_xlat2 = (float(1) / _Value2);
          u_xlat0_d.x = (u_xlat2 * u_xlat0_d.x);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat2 = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat4_d = (((-u_xlat2) * u_xlat0_d.x) + 1);
          u_xlat0_d.x = ((u_xlat2 * u_xlat0_d.x) + (-u_xlat4_d));
          u_xlat0_d.x = ((-abs(u_xlat0_d.x)) + 1);
          u_xlat0_d.x = (abs(u_xlat0_d.x) * _Value3);
          u_xlat2 = ((-_Alpha) + 1);
          u_xlat2 = (u_xlat2 * u_xlat0_d.w);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat2) + (-u_xlat2));
          u_xlat0_d.x = ((_Value4 * u_xlat0_d.x) + u_xlat2);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4 = (u_xlat4 * _Value5);
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord2.x) + u_xlat4);
          u_xlat4 = ((_Value2 * 0.5) + _Distortion);
          u_xlat0_d.x = ((-u_xlat0_d.x) + u_xlat4);
          u_xlat4 = (float(1) / _Value2);
          u_xlat0_d.x = (u_xlat4 * u_xlat0_d.x);
          ...
          u_xlat4 = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat8_d = (((-u_xlat4) * u_xlat0_d.x) + 1);
          u_xlat0_d.x = ((u_xlat4 * u_xlat0_d.x) + (-u_xlat8_d));
          u_xlat0_d.x = ((-abs(u_xlat0_d.x)) + 1);
          u_xlat0_d.x = (abs(u_xlat0_d.x) * _Value3);
          u_xlat1_d.xyz = ((u_xlat10_1.xyz * in_f.texcoord2.xyz) + u_xlat0_d.xxx);
          u_xlat4 = ((-_Alpha) + 1);
          u_xlat1_d.w = (u_xlat4 * u_xlat2.w);
          u_xlat0_d.w = (u_xlat0_d.x * u_xlat1_d.w);
          u_xlat0_d.x = float(1);
          u_xlat0_d.y = float(1);
          u_xlat0_d.z = float(1);
          u_xlat0_d = ((-u_xlat1_d) + u_xlat0_d);
          u_xlat0_d = ((float4(float4(_Value4, _Value4, _Value4, _Value4)) * u_xlat0_d) + u_xlat1_d);
          u_xlat16_3_d.x = (u_xlat0_d.w + (-0.0500000007));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((-u_xlat1_d) + u_xlat0_d);
          u_xlat0_d = ((float4(float4(_Value4, _Value4, _Value4, _Value4)) * u_xlat0_d) + u_xlat1_d);
          u_xlat16_3 = (u_xlat0_d.w + (-0.0500000007));
          u_xlat0_d.xyz = (u_xlat0_d.www * u_xlat0_d.xyz);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord1.xy);
          u_xlat0_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat0_d.x = dot(u_xlat0_d.xyz, float3(0.298999995, 0.587000012, 0.114));
          u_xlat0_d.x = (u_xlat0_d.x * _Value5);
          u_xlat10_2 = tex2D(_MainTex2, in_f.texcoord1.xy).x;
          u_xlat0_d.x = ((u_xlat10_2 * in_f.texcoord3.x) + u_xlat0_d.x);
          u_xlat2_d = ((_Value2 * 0.5) + _Distortion);
          u_xlat0_d.x = ((-u_xlat0_d.x) + u_xlat2_d);
          u_xlat2_d = (float(1) / _Value2);
          u_xlat0_d.x = (u_xlat2_d * u_xlat0_d.x);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat2_d = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat4 = (((-u_xlat2_d) * u_xlat0_d.x) + 1);
          u_xlat0_d.x = ((u_xlat2_d * u_xlat0_d.x) + (-u_xlat4));
          u_xlat0_d.x = ((-abs(u_xlat0_d.x)) + 1);
          u_xlat0_d.x = (abs(u_xlat0_d.x) * _Value3);
          u_xlat2_d = ((-_Alpha) + 1);
          u_xlat2_d = (u_xlat2_d * u_xlat0_d.w);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat2_d) + (-u_xlat2_d));
          u_xlat0_d.x = ((_Value4 * u_xlat0_d.x) + u_xlat2_d);
          u_xlat16_1 = (u_xlat0_d.x + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
