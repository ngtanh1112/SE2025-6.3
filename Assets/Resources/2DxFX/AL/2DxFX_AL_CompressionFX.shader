  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat6_d * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * _Distortion);
          u_xlat6_d = (u_xlat0_d.y * u_xlat0_d.y);
          u_xlat3 = (u_xlat6_d * u_xlat0_d.y);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = (in_f.texcoord1.xyxy * float4(24, 19, 38, 14));
          u_xlat0_d = floor(u_xlat0_d);
          u_xlat0_d = (u_xlat0_d * float4(4, 4, 4, 4));
          u_xlat1_d.xy = (_Time.xy + float2(0.100000001, 0.100000001));
          u_xlat1_d.xy = ((u_xlat1_d.xy * float2(12, 12)) + float2(50, 50));
