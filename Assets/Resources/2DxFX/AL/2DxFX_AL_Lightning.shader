  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_2.x = ((u_xlat0_d.w * u_xlat1_d.x) + (-0.0500000007));
          u_xlat15 = (u_xlat0_d.w * u_xlat1_d.x);
          u_xlatb1 = (u_xlat16_2.x<0);
          if(((int(u_xlatb1) * (-1))!=0))
          {
              discard;
          }
          ...
          u_xlat1_d.x = (_Time.x + 0.200000003);
          u_xlat6_d = (u_xlat1_d.x * _Value1);
          u_xlat1_d.x = (u_xlat1_d.x + _Time.x);
          u_xlat1_d.x = (u_xlat1_d.x + 0.600000024);
          u_xlat1_d.x = (u_xlat1_d.x * _Value1);
          u_xlatb18 = (u_xlat6_d>=(-u_xlat6_d));
          u_xlat4_d.x = frac(abs(u_xlat6_d));
          u_xlat6_d = (u_xlat6_d * 0.125);
          u_xlat18 = (u_xlatb18)?(u_xlat4_d.x):((-u_xlat4_d.x));
          u_xlat18 = (u_xlat18 * 8);
          u_xlat18 = floor(u_xlat18);
          u_xlat4_d.x = ((u_xlat18 * 0.125) + u_xlat11.x);
          u_xlatb18 = (u_xlat6_d>=(-u_xlat6_d));
          u_xlat6_d = frac(abs(u_xlat6_d));
          u_xlat6_d = (u_xlatb18)?(u_xlat6_d):((-u_xlat6_d));
          u_xlat6_d = (u_xlat6_d * 8);
          u_xlat6_d = floor(u_xlat6_d);
          u_xlat6_d = (((-u_xlat6_d) * 0.125) + u_xlat11.y);
          u_xlat4_d.y = (u_xlat6_d + 1);
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat4_d.xy).xyz;
          u_xlat16_3.xyz = (u_xlat10_3.xyz + u_xlat10_4.xyz);
          u_xlatb6 = (u_xlat1_d.x>=(-u_xlat1_d.x));
          u_xlat18 = frac(abs(u_xlat1_d.x));
          u_xlat1_d.y = (u_xlatb6)?(u_xlat18):((-u_xlat18));
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(0.125, 8));
          u_xlat6_d = floor(u_xlat1_d.y);
          u_xlat4_d.x = ((u_xlat6_d * 0.125) + u_xlat11.x);
          u_xlatb6 = (u_xlat1_d.x>=(-u_xlat1_d.x));
          u_xlat1_d.x = frac(abs(u_xlat1_d.x));
          u_xlat1_d.x = (u_xlatb6)?(u_xlat1_d.x):((-u_xlat1_d.x));
          u_xlat1_d.x = (u_xlat1_d.x * 8);
          u_xlat1_d.x = floor(u_xlat1_d.x);
          u_xlat1_d.x = (((-u_xlat1_d.x) * 0.125) + u_xlat11.y);
          u_xlat4_d.y = (u_xlat1_d.x + 1);
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat4_d.xy).xyz;
          u_xlat16_1.xyz = (u_xlat10_1.xyz + u_xlat16_3.xyz);
          u_xlat0_d.xyz = ((u_xlat16_1.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat0_d.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(0.125, 8));
          u_xlat6_d = floor(u_xlat1_d.y);
          u_xlat4.x = ((u_xlat6_d * 0.125) + u_xlat11.x);
          u_xlatb6 = (u_xlat1_d.x>=(-u_xlat1_d.x));
          u_xlat1_d.x = frac(abs(u_xlat1_d.x));
          u_xlat1_d.x = (u_xlatb6)?(u_xlat1_d.x):((-u_xlat1_d.x));
          u_xlat1_d.x = (u_xlat1_d.x * 8);
          u_xlat1_d.x = floor(u_xlat1_d.x);
          u_xlat1_d.x = (((-u_xlat1_d.x) * 0.125) + u_xlat11.y);
          u_xlat4.y = (u_xlat1_d.x + 1);
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz;
          u_xlat16_1.xyz = (u_xlat10_1.xyz + u_xlat16_3.xyz);
          u_xlat0_d.xyz = ((u_xlat16_1.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat0_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat15;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat16_2_d.x = ((u_xlat0_d.w * u_xlat1_d.x) + (-0.0500000007));
          u_xlat15 = (u_xlat0_d.w * u_xlat1_d.x);
          u_xlatb1 = (u_xlat16_2_d.x<0);
          if(((int(u_xlatb1) * (-1))!=0))
          {
              discard;
          }
          u_xlat1_d.x = (_Time.x * _Value1);
          u_xlat6 = (u_xlat1_d.x * 0.125);
          ...
          u_xlat10_3.xyz = tex2D(_MainTex2, u_xlat3.xy).xyz;
          u_xlat1_d.x = (_Time.x + 0.200000003);
          u_xlat6 = (u_xlat1_d.x * _Value1);
          u_xlat1_d.x = (u_xlat1_d.x + _Time.x);
          u_xlat1_d.x = (u_xlat1_d.x + 0.600000024);
          u_xlat1_d.x = (u_xlat1_d.x * _Value1);
          u_xlatb18 = (u_xlat6>=(-u_xlat6));
          u_xlat4.x = frac(abs(u_xlat6));
          ...
          u_xlat4.y = (u_xlat6 + 1);
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz;
          u_xlat16_3_d.xyz = (u_xlat10_3.xyz + u_xlat10_4.xyz);
          u_xlatb6 = (u_xlat1_d.x>=(-u_xlat1_d.x));
          u_xlat18 = frac(abs(u_xlat1_d.x));
          u_xlat1_d.y = (u_xlatb6)?(u_xlat18):((-u_xlat18));
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(0.125, 8));
          u_xlat6 = floor(u_xlat1_d.y);
          ...
          u_xlat4.y = (u_xlat1_d.x + 1);
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat4.xy).xyz;
          u_xlat16_1_d.xyz = (u_xlat10_1.xyz + u_xlat16_3_d.xyz);
          u_xlat0_d.xyz = ((u_xlat16_1_d.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat0_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          out_f.color.w = u_xlat15;
