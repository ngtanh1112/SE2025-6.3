  ...
  SubShader
  {
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      */
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlatb1 = (u_xlat0_d.w<0.949999988);
          u_xlat1_d.x = (u_xlatb1)?(0):(u_xlat0_d.w);
          u_xlat4 = ((u_xlat0_d.w * u_xlat1_d.x) + (-0.5));
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      */
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb1 = (u_xlat0_d.x<0.949999988);
          u_xlat1_d = (u_xlatb1)?(0):(u_xlat0_d.x);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat1_d) + (-0.5));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      */
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb1 = (u_xlat0_d.w<0.949999988);
          u_xlat1_d = (u_xlatb1)?(0):(u_xlat0_d.w);
          u_xlat1_d = ((u_xlat0_d.w * u_xlat1_d) + (-0.5));
          u_xlat0_d.xyz = (u_xlat0_d.www * u_xlat0_d.xyz);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      */
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = (in_f.texcoord1.xy * float2(_Offset, _Offset));
          u_xlat0_d.xy = round(u_xlat0_d.xy);
          u_xlat0_d.xy = (u_xlat0_d.xy / float2(_Offset, _Offset));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
