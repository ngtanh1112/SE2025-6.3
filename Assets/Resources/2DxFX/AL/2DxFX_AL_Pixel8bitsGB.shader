  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((-_Alpha) + 1);
          u_xlat7.x = (_Size * 64);
          u_xlat14.xy = (u_xlat7.xx * in_f.texcoord.xy);
          ...
          u_xlatb14 = (u_xlat1_d.w<0.949999988);
          ...
          u_xlat4_d.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.103822999, (-0.328509003), (-0.0740879923)));
          u_xlat4_d.x = dot(u_xlat4_d.xyz, u_xlat4_d.xyz);
          u_xlat5.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.314432025, (-0.493039042), (-0.0196830016)));
          u_xlat14.x = dot(u_xlat5.xyz, u_xlat5.xyz);
          u_xlat4_d.y = min(u_xlat14.x, 1000);
          u_xlatb14 = (u_xlat14.x<1000);
          ...
          u_xlatb14 = (u_xlat4_d.x<u_xlat4_d.y);
          u_xlat4_d.z = 1000;
          u_xlat4_d.yz = (int(u_xlatb14))?(u_xlat4_d.xy):(u_xlat4_d.yz);
          u_xlat6_d.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.00219699973, (-0.0795070007), (-0.0506530032)));
          u_xlat1_d.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-2.69999982E-05, (-0.00409599999), (-0.0359370038)));
          u_xlat1_d.x = dot(u_xlat1_d.xyz, u_xlat1_d.xyz);
          u_xlat4_d.x = dot(u_xlat6_d.xyz, u_xlat6_d.xyz);
          u_xlatb21 = (u_xlat4_d.x<u_xlat4_d.y);
          u_xlat1_d.yz = (int(u_xlatb21))?(u_xlat4_d.xy):(u_xlat4_d.yz);
          u_xlatb22 = (u_xlat1_d.x<u_xlat1_d.y);
          u_xlat1_d.xy = (int(u_xlatb22))?(u_xlat1_d.xy):(u_xlat1_d.yz);
          u_xlat1_d.xy = sqrt(u_xlat1_d.xy);
          u_xlat1_d.x = (u_xlat1_d.y + u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.y / u_xlat1_d.x);
          u_xlat1_d.x = (u_xlat1_d.x + 1);
          u_xlatb7 = (u_xlat1_d.x<u_xlat7.x);
          u_xlat1_d.xyz = lerp(float3(0, 0, 0), u_xlat5.xyz, float3(bool3(u_xlatb14, u_xlatb14, u_xlatb14)));
          u_xlat3.xyz = (int(u_xlatb14))?(float3(0.469999999, 0.689999998, 0.419999987)):(u_xlat5.xyz);
          u_xlat1_d.xyz = (int(u_xlatb21))?(u_xlat3.xyz):(u_xlat1_d.xyz);
          u_xlat3.xyz = (int(u_xlatb21))?(float3(0.129999995, 0.430000007, 0.370000005)):(u_xlat3.xyz);
          u_xlat1_d.xyz = (int(u_xlatb22))?(u_xlat3.xyz):(u_xlat1_d.xyz);
          u_xlat3.xyz = (int(u_xlatb22))?(float3(0.0299999993, 0.159999996, 0.330000013)):(u_xlat3.xyz);
          u_xlat7.xyz = (int(u_xlatb7))?(u_xlat1_d.xyz):(u_xlat3.xyz);
          u_xlat7.xyz = (float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * u_xlat7.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat7.x = (((-u_xlat14.x) * 2) + u_xlat7.x);
          u_xlat3.xyz = (u_xlat1_d.xyz * u_xlat1_d.xyz);
          u_xlat4.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.103822999, (-0.328509003), (-0.0740879923)));
          ...
          u_xlat3.xyz = (int(u_xlatb22))?(float3(0.0299999993, 0.159999996, 0.330000013)):(u_xlat3.xyz);
          u_xlat7.xyz = (int(u_xlatb7))?(u_xlat1_d.xyz):(u_xlat3.xyz);
          u_xlat7.xyz = (u_xlat0_d.xxx * u_xlat7.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.z = 1000;
          u_xlat4.yz = (int(u_xlatb14))?(u_xlat4.xy):(u_xlat4.yz);
          u_xlat6.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-0.00219699973, (-0.0795070007), (-0.0506530032)));
          u_xlat1_d.xyz = ((u_xlat3.xyz * u_xlat1_d.xyz) + float3(-2.69999982E-05, (-0.00409599999), (-0.0359370038)));
          u_xlat1_d.x = dot(u_xlat1_d.xyz, u_xlat1_d.xyz);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xyz = (int(u_xlatb22))?(float3(0.0299999993, 0.159999996, 0.330000013)):(u_xlat3.xyz);
          u_xlat7.xyz = (int(u_xlatb7))?(u_xlat1_d.xyz):(u_xlat3.xyz);
          u_xlat0_d.xyz = (u_xlat0_d.xxx * u_xlat7.xyz);
