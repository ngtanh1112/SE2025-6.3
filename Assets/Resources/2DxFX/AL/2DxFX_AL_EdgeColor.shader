  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((u_xlat10_1 * in_f.texcoord3) + u_xlat0_d);
          ...
          u_xlat16_7.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
          ...
          out_f.color.xyz = (float3(u_xlat16_3, u_xlat16_3, u_xlat16_3) * u_xlat16_7.xyz);
          return out_f;
      }
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = (u_xlat16_0 * float4(0.5, 0.5, 0.5, 0.5));
          u_xlat16_0.x = length(u_xlat16_0);
          u_xlat0_d.x = (u_xlat16_0.x * _ColorX.w);
          u_xlat10_4 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat0_d.x = ((u_xlat10_4 * in_f.texcoord3.w) + u_xlat0_d.x);
          u_xlat4_d = ((-_Alpha) + 1);
          u_xlat16_3 = ((u_xlat0_d.x * u_xlat4_d) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_3<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_2 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.zw);
          u_xlat16_1_d = ((-u_xlat10_1) + u_xlat10_2);
          u_xlat16_0 = (abs(u_xlat16_0) + abs(u_xlat16_1_d));
          u_xlat16_0 = (u_xlat16_0 * float4(0.5, 0.5, 0.5, 0.5));
          u_xlat16_0.x = length(u_xlat16_0);
          u_xlat0_d = (u_xlat16_0.xxxx * _ColorX);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat0_d = ((u_xlat10_1 * in_f.texcoord2) + u_xlat0_d);
          u_xlat1_d.x = ((-_Alpha) + 1);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = (in_f.texcoord1.xyxy + float4(0, 0.015625, 0, (-0.015625)));
          u_xlat10_1 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.zw);
          u_xlat16_0 = ((-u_xlat10_0) + u_xlat10_1);
          u_xlat1_d = (in_f.texcoord1.xyxy + float4(0.015625, 0, (-0.015625), 0));
          u_xlat10_2 = tex2D(_MainTex, u_xlat1_d.xy);
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.zw);
          u_xlat16_1 = ((-u_xlat10_1) + u_xlat10_2);
          u_xlat16_0 = (abs(u_xlat16_0) + abs(u_xlat16_1));
          ...
          u_xlat0_d.x = ((u_xlat10_4 * in_f.texcoord3.w) + u_xlat0_d.x);
          u_xlat4 = ((-_Alpha) + 1);
          u_xlat16_3 = ((u_xlat0_d.x * u_xlat4) + (-0.0500000007));
          u_xlatb0 = (u_xlat16_3<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
