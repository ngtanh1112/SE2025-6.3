Shader "2DxFX/AL/Offset"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = (in_f.texcoord.xy + float2(_OffsetX, _OffsetY));
          u_xlat1_d.x = (u_xlat0_d.x * _ZoomX);
          u_xlat1_d.y = (u_xlat0_d.y * _ZoomY);
          u_xlatb0.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          u_xlat6_d.xy = frac(abs(u_xlat1_d.xy));
          u_xlat0_d.x = (u_xlatb0.x)?(u_xlat6_d.x):((-u_xlat6_d.x));
          u_xlat0_d.y = (u_xlatb0.y)?(u_xlat6_d.y):((-u_xlat6_d.y));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.y = (u_xlat0_d.y * _ZoomY);
          u_xlatb0.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          u_xlat6.xy = frac(abs(u_xlat1_d.xy));
          u_xlat0_d.x = (u_xlatb0.x)?(u_xlat6.x):((-u_xlat6.x));
          u_xlat0_d.y = (u_xlatb0.y)?(u_xlat6.y):((-u_xlat6.y));
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = (in_f.texcoord1.xy + float2(_OffsetX, _OffsetY));
          u_xlat1_d.x = (u_xlat0_d.x * _ZoomX);
          u_xlat1_d.y = (u_xlat0_d.y * _ZoomY);
          u_xlatb0.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          u_xlat6.xy = frac(abs(u_xlat1_d.xy));
