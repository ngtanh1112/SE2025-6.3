  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.x = (u_xlat0_d + (-0.0500000007));
          u_xlatb2 = (u_xlat16_1.x<0);
          if(((int(u_xlatb2) * (-1))!=0))
          {
              discard;
          }
          u_xlat2.xyz = (float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * _ColorX.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_1.x = (u_xlat0_d.x + (-0.0500000007));
          u_xlatb2 = (u_xlat16_1.x<0);
          if(((int(u_xlatb2) * (-1))!=0))
          {
              discard;
          ...
          u_xlat2_d.x = dot(u_xlat2_d.xyz, u_xlat2_d.xyz);
          u_xlat2_d.x = tex2D(_LightTexture0, u_xlat2_d.xx).x;
          u_xlat16_1.xyz = (u_xlat2_d.xxx * _LightColor0.xyz);
          u_xlat2_d.xyz = (u_xlat0_d.xxx * _ColorX.xyz);
          out_f.color.w = u_xlat0_d.x;
          u_xlat16_1.xyz = (u_xlat16_1.xyz * u_xlat2_d.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat0_d = ((u_xlat10_0 * in_f.texcoord2.w) + (-_Alpha));
          u_xlat16_1_d.x = (u_xlat0_d + (-0.0500000007));
          u_xlatb3 = (u_xlat16_1_d.x<0);
          if(((int(u_xlatb3) * (-1))!=0))
          {
              discard;
          }
          u_xlat3.xy = (in_f.texcoord3.xy / in_f.texcoord3.ww);
          u_xlat10_3.xyz = tex2D(_LightBuffer, u_xlat3.xy).xyz;
          u_xlat16_1_d.xyz = max(u_xlat10_3.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005));
          u_xlat16_1_d.xyz = log2(u_xlat16_1_d.xyz);
          u_xlat3.xyz = ((-u_xlat16_1_d.xyz) + in_f.texcoord5.xyz);
          u_xlat2.xyz = (float3(u_xlat0_d, u_xlat0_d, u_xlat0_d) * _ColorX.xyz);
          out_f.color.w = u_xlat0_d;
          out_f.color.xyz = (u_xlat3.xyz * u_xlat2.xyz);
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = (u_xlat0_d.xxx * _ColorX.xyz);
