  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = ((u_xlat0_d.xx * float2(140, 8)) + in_f.texcoord.yy);
          u_xlat3.yz = sin(u_xlat3.xy);
          u_xlat3.x = cos(u_xlat3.x);
          u_xlat3.xy = (u_xlat3.xy * float2(_Distortion, _Distortion));
          u_xlat9 = (u_xlat3.z * 0.00499999989);
          u_xlat6_d = ((u_xlat3.y * 0.00899999961) + u_xlat9);
          u_xlat1_d.x = (u_xlat6_d + in_f.texcoord.x);
          u_xlat0_d.x = ((u_xlat0_d.x * 8) + u_xlat1_d.x);
          u_xlat0_d.x = cos(u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * 0.00499999989);
          u_xlat0_d.x = ((u_xlat3.x * 0.00899999961) + u_xlat0_d.x);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = ((float2(u_xlat0_d, u_xlat0_d) * float2(140, 8)) + in_f.texcoord.yy);
          u_xlat3.yz = sin(u_xlat3.xy);
          u_xlat3.x = cos(u_xlat3.x);
          u_xlat3.xy = (u_xlat3.xy * float2(_Distortion, _Distortion));
          u_xlat9 = (u_xlat3.z * 0.00499999989);
          u_xlat6_d = ((u_xlat3.y * 0.00899999961) + u_xlat9);
          u_xlat1_d.x = (u_xlat6_d + in_f.texcoord.x);
          u_xlat0_d = ((u_xlat0_d * 8) + u_xlat1_d.x);
          u_xlat0_d = cos(u_xlat0_d);
          u_xlat0_d = (u_xlat0_d * 0.00499999989);
          u_xlat0_d = ((u_xlat3.x * 0.00899999961) + u_xlat0_d);
          u_xlat1_d.y = (u_xlat0_d + in_f.texcoord.y);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat3.xy = (u_xlat3.xy * float2(_Distortion, _Distortion));
          u_xlat9 = (u_xlat3.z * 0.00499999989);
          u_xlat6 = ((u_xlat3.y * 0.00899999961) + u_xlat9);
          u_xlat1_d.x = (u_xlat6 + in_f.texcoord.x);
          u_xlat0_d.x = ((u_xlat0_d.x * 8) + u_xlat1_d.x);
          u_xlat0_d.x = cos(u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * 0.00499999989);
          u_xlat0_d.x = ((u_xlat3.x * 0.00899999961) + u_xlat0_d.x);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = (_Time.x * _Speed);
          u_xlat3_d.xy = ((float2(u_xlat0_d, u_xlat0_d) * float2(140, 8)) + in_f.texcoord1.yy);
          u_xlat3_d.yz = sin(u_xlat3_d.xy);
          u_xlat3_d.x = cos(u_xlat3_d.x);
          u_xlat3_d.xy = (u_xlat3_d.xy * float2(_Distortion, _Distortion));
          u_xlat9_d = (u_xlat3_d.z * 0.00499999989);
          u_xlat6 = ((u_xlat3_d.y * 0.00899999961) + u_xlat9_d);
          u_xlat1_d.x = (u_xlat6 + in_f.texcoord1.x);
          u_xlat0_d = ((u_xlat0_d * 8) + u_xlat1_d.x);
          u_xlat0_d = cos(u_xlat0_d);
          u_xlat0_d = (u_xlat0_d * 0.00499999989);
          u_xlat0_d = ((u_xlat3_d.x * 0.00899999961) + u_xlat0_d);
          u_xlat1_d.y = (u_xlat0_d + in_f.texcoord1.y);
          u_xlat10_0 = tex2D(_MainTex, u_xlat1_d.xy).w;
          u_xlat0_d = ((u_xlat10_0 * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_2 = (u_xlat0_d + (-0.0500000007));
          u_xlatb0 = (u_xlat16_2<0);
