  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat13.xy = (in_f.texcoord.xy * float2(0.125, 0.125));
          u_xlat7 = (((-u_xlat7) * 0.125) + u_xlat13.y);
          u_xlat3.y = (u_xlat7 + 1);
          u_xlatb7 = (u_xlat1_d.x>=(-u_xlat1_d.x));
          ...
          u_xlat1_d.xy = (_Time.xx + float2(0.200000003, 0.800000012));
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(float2(_Value1, _Value1)));
          u_xlatb4.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          u_xlat16.xy = frac(abs(u_xlat1_d.xy));
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(0.125, 0.125));
          u_xlat4_d.x = (u_xlatb4.x)?(u_xlat16.x):((-u_xlat16.x));
          u_xlat4_d.y = (u_xlatb4.y)?(u_xlat16.y):((-u_xlat16.y));
          u_xlat4_d.xy = (u_xlat4_d.xy * float2(8, 8));
          u_xlat4_d.xy = floor(u_xlat4_d.xy);
          u_xlat2.xy = ((u_xlat4_d.xy * float2(0.125, 0.125)) + u_xlat13.xx);
          u_xlatb4.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          ...
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(8, 8));
          u_xlat1_d.xy = floor(u_xlat1_d.xy);
          u_xlat1_d.xy = (((-u_xlat1_d.xy) * float2(0.125, 0.125)) + u_xlat13.yy);
          u_xlat2.zw = (u_xlat1_d.xy + float2(1, 1));
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat2.xz).xyz;
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat2.yw).xyz;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.xy = (u_xlat4.xy * float2(8, 8));
          u_xlat4.xy = floor(u_xlat4.xy);
          u_xlat2_d.xy = ((u_xlat4.xy * float2(0.125, 0.125)) + u_xlat13.xx);
          u_xlatb4.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          u_xlat1_d.xy = frac(abs(u_xlat1_d.xy));
          ...
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat2_d.xz).xyz;
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat2_d.yw).xyz;
          u_xlat16_1.xyz = (u_xlat10_1.xyz + u_xlat10_3.xyz);
          u_xlat16_1.xyz = (u_xlat10_4.xyz + u_xlat16_1.xyz);
          u_xlat0_d.xyz = ((u_xlat16_1.xyz * float3(float3(_Value2, _Value2, _Value2))) + u_xlat0_d.xyz);
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat0_d.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4.xy = (u_xlat4.xy * float2(8, 8));
          u_xlat4.xy = floor(u_xlat4.xy);
          u_xlat2.xy = ((u_xlat4.xy * float2(0.125, 0.125)) + u_xlat13.xx);
          u_xlatb4.xy = bool4(u_xlat1_d.xyxx >= (-u_xlat1_d.xyxx)).xy;
          u_xlat1_d.xy = frac(abs(u_xlat1_d.xy));
          float3 hlslcc_movcTemp = u_xlat1_d;
          hlslcc_movcTemp.x = (u_xlatb4.x)?(u_xlat1_d.x):((-u_xlat1_d.x));
          ...
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat2.xz).xyz;
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat2.yw).xyz;
          u_xlat16_1_d.xyz = (u_xlat10_1.xyz + u_xlat10_3.xyz);
          u_xlat16_1_d.xyz = (u_xlat10_4.xyz + u_xlat16_1_d.xyz);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = (u_xlat1_d.xy * float2(8, 8));
          u_xlat1_d.xy = floor(u_xlat1_d.xy);
          u_xlat1_d.xy = (((-u_xlat1_d.xy) * float2(0.125, 0.125)) + u_xlat11.yy);
          u_xlat2.zw = (u_xlat1_d.xy + float2(1, 1));
          u_xlat10_1.xyz = tex2D(_MainTex2, u_xlat2.xz).xyz;
          u_xlat10_4.xyz = tex2D(_MainTex2, u_xlat2.yw).xyz;
          u_xlat16_1.xyz = (u_xlat10_1.xyz + u_xlat10_3.xyz);
