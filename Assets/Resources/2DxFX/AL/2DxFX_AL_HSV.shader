  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat18 = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlat16_1 = (u_xlat18 + (-0.0500000007));
          u_xlatb2 = (u_xlat16_1<0);
          if(((int(u_xlatb2) * (-1))!=0))
          {
              discard;
          }
          u_xlat2 = (_HueShift * 0.0174532942);
          u_xlat3.x = cos(u_xlat2);
          u_xlat2 = sin(u_xlat2);
          u_xlat8.x = (_Sat * _Val);
          u_xlat14 = (u_xlat3.x * u_xlat8.x);
          u_xlat2 = (u_xlat2 * u_xlat8.x);
          u_xlat1_d = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat8.xy = ((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz));
          u_xlat4_d.xy = ((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw);
          u_xlat8.x = ((u_xlat2 * 1.25) + u_xlat8.x);
          u_xlat14 = (((-u_xlat2) * 1.04999995) + u_xlat8.y);
          u_xlat14 = (u_xlat0_d.y * u_xlat14);
          u_xlat8.x = ((u_xlat8.x * u_xlat0_d.x) + u_xlat14);
          u_xlat14 = (((-u_xlat2) * 0.202999994) + u_xlat4_d.y);
          u_xlat20 = ((u_xlat2 * 0.0350000001) + u_xlat4_d.x);
          u_xlat4_d.z = ((u_xlat14 * u_xlat0_d.z) + u_xlat8.x);
          ...
          u_xlat8.x = ((u_xlat2 * 0.167999998) + u_xlat8.x);
          u_xlat14 = ((u_xlat2 * 0.330000013) + u_xlat3.x);
          u_xlat14 = (u_xlat0_d.y * u_xlat14);
          u_xlat8.x = ((u_xlat8.x * u_xlat0_d.x) + u_xlat14);
          u_xlat3.xz = (((-float2(u_xlat2, u_xlat2)) * float2(0.497000009, 0.328000009)) + u_xlat3.yz);
          u_xlat2 = ((u_xlat2 * 0.291999996) + u_xlat3.y);
          u_xlat4_d.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat8.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat0_d.x = ((u_xlat20 * u_xlat0_d.y) + u_xlat0_d.x);
          u_xlat4_d.y = ((u_xlat2 * u_xlat0_d.z) + u_xlat0_d.x);
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat4_d.xyz);
          out_f.color.w = u_xlat18;
          u_xlat16_5.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.x = (_HueShift * 0.0174532942);
          u_xlat3.x = cos(u_xlat2_d.x);
          u_xlat2_d.x = sin(u_xlat2_d.x);
          u_xlat8.x = (_Sat * _Val);
          u_xlat14 = (u_xlat3.x * u_xlat8.x);
          u_xlat2_d.x = (u_xlat2_d.x * u_xlat8.x);
          u_xlat1_d = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat8.xy = ((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz));
          u_xlat4.xy = ((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw);
          u_xlat8.x = ((u_xlat2_d.x * 1.25) + u_xlat8.x);
          u_xlat14 = (((-u_xlat2_d.x) * 1.04999995) + u_xlat8.y);
          u_xlat14 = (u_xlat0_d.y * u_xlat14);
          u_xlat8.x = ((u_xlat8.x * u_xlat0_d.x) + u_xlat14);
          u_xlat14 = (((-u_xlat2_d.x) * 0.202999994) + u_xlat4.y);
          u_xlat20 = ((u_xlat2_d.x * 0.0350000001) + u_xlat4.x);
          u_xlat4.z = ((u_xlat14 * u_xlat0_d.z) + u_xlat8.x);
          u_xlat8.x = ((_Val * 0.298999995) + u_xlat3.x);
          u_xlat3.xyz = ((float3(float3(_Val, _Val, _Val)) * float3(0.587000012, 0.114, 0.298999995)) + (-u_xlat3.yzw));
          u_xlat8.x = ((u_xlat2_d.x * 0.167999998) + u_xlat8.x);
          u_xlat14 = ((u_xlat2_d.x * 0.330000013) + u_xlat3.x);
          u_xlat14 = (u_xlat0_d.y * u_xlat14);
          u_xlat8.x = ((u_xlat8.x * u_xlat0_d.x) + u_xlat14);
          u_xlat3.xz = (((-u_xlat2_d.xx) * float2(0.497000009, 0.328000009)) + u_xlat3.yz);
          u_xlat2_d.x = ((u_xlat2_d.x * 0.291999996) + u_xlat3.y);
          u_xlat4.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat8.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat0_d.x = ((u_xlat20 * u_xlat0_d.y) + u_xlat0_d.x);
          u_xlat4.y = ((u_xlat2_d.x * u_xlat0_d.z) + u_xlat0_d.x);
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat4.xyz);
          out_f.color.w = u_xlat18;
          ...
          u_xlat18 = dot(u_xlat2_d.xyz, u_xlat2_d.xyz);
          u_xlat18 = tex2D(_LightTexture0, float2(u_xlat18, u_xlat18)).x;
          u_xlat16_5.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * _LightColor0.xyz);
          u_xlat16_5.xyz = (u_xlat0_d.xyz * u_xlat16_5.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat18 = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord2.xyz);
          u_xlat16_1_d = (u_xlat18 + (-0.0500000007));
          u_xlatb2 = (u_xlat16_1_d<0);
          if(((int(u_xlatb2) * (-1))!=0))
          {
              discard;
          }
          ...
          u_xlat8_d.x = (_Sat * _Val);
          u_xlat14 = (u_xlat3.x * u_xlat8_d.x);
          u_xlat2.x = (u_xlat2.x * u_xlat8_d.x);
          u_xlat1_d = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (float4(u_xlat14, u_xlat14, u_xlat14, u_xlat14) * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat8_d.xy = ((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz));
          u_xlat4.xy = ((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw);
          u_xlat8_d.x = ((u_xlat2.x * 1.25) + u_xlat8_d.x);
          u_xlat14 = (((-u_xlat2.x) * 1.04999995) + u_xlat8_d.y);
          u_xlat14 = (u_xlat0_d.y * u_xlat14);
          u_xlat8_d.x = ((u_xlat8_d.x * u_xlat0_d.x) + u_xlat14);
          u_xlat14 = (((-u_xlat2.x) * 0.202999994) + u_xlat4.y);
          u_xlat20 = ((u_xlat2.x * 0.0350000001) + u_xlat4.x);
          u_xlat4.z = ((u_xlat14 * u_xlat0_d.z) + u_xlat8_d.x);
          u_xlat8_d.x = ((_Val * 0.298999995) + u_xlat3.x);
          u_xlat3.xyz = ((float3(float3(_Val, _Val, _Val)) * float3(0.587000012, 0.114, 0.298999995)) + (-u_xlat3.yzw));
          u_xlat8_d.x = ((u_xlat2.x * 0.167999998) + u_xlat8_d.x);
          u_xlat14 = ((u_xlat2.x * 0.330000013) + u_xlat3.x);
          u_xlat14 = (u_xlat0_d.y * u_xlat14);
          u_xlat8_d.x = ((u_xlat8_d.x * u_xlat0_d.x) + u_xlat14);
          u_xlat3.xz = (((-u_xlat2.xx) * float2(0.497000009, 0.328000009)) + u_xlat3.yz);
          u_xlat2.x = ((u_xlat2.x * 0.291999996) + u_xlat3.y);
          u_xlat4.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat8_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat0_d.x = ((u_xlat20 * u_xlat0_d.y) + u_xlat0_d.x);
          u_xlat4.y = ((u_xlat2.x * u_xlat0_d.z) + u_xlat0_d.x);
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat4.xyz);
          out_f.color.w = u_xlat18;
          u_xlat2.xy = (in_f.texcoord3.xy / in_f.texcoord3.ww);
          u_xlat10_2.xyz = tex2D(_LightBuffer, u_xlat2.xy).xyz;
          u_xlat16_5.xyz = max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005));
          u_xlat16_5.xyz = log2(u_xlat16_5.xyz);
          u_xlat2.xyz = ((-u_xlat16_5.xyz) + in_f.texcoord5.xyz);
          out_f.color.xyz = (u_xlat0_d.xyz * u_xlat2.xyz);
          return out_f;
      }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat15 = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          ...
          u_xlat1_d = (float4(u_xlat12, u_xlat12, u_xlat12, u_xlat12) * float4(0.412999988, 0.300000012, 0.588, 0.885999978));
          u_xlat3 = (float4(u_xlat12, u_xlat12, u_xlat12, u_xlat12) * float4(0.700999975, 0.587000012, 0.114, 0.298999995));
          u_xlat7.xy = ((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz));
          u_xlat4_d.xy = ((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw);
          u_xlat7.x = ((u_xlat2 * 1.25) + u_xlat7.x);
          u_xlat12 = (((-u_xlat2) * 1.04999995) + u_xlat7.y);
          u_xlat12 = (u_xlat0_d.y * u_xlat12);
          u_xlat7.x = ((u_xlat7.x * u_xlat0_d.x) + u_xlat12);
          u_xlat12 = (((-u_xlat2) * 0.202999994) + u_xlat4_d.y);
          u_xlat17 = ((u_xlat2 * 0.0350000001) + u_xlat4_d.x);
          u_xlat4_d.z = ((u_xlat12 * u_xlat0_d.z) + u_xlat7.x);
          u_xlat7.x = ((_Val * 0.298999995) + u_xlat3.x);
          u_xlat3.xyz = ((float3(float3(_Val, _Val, _Val)) * float3(0.587000012, 0.114, 0.298999995)) + (-u_xlat3.yzw));
          u_xlat7.x = ((u_xlat2 * 0.167999998) + u_xlat7.x);
          u_xlat12 = ((u_xlat2 * 0.330000013) + u_xlat3.x);
          u_xlat12 = (u_xlat0_d.y * u_xlat12);
          u_xlat7.x = ((u_xlat7.x * u_xlat0_d.x) + u_xlat12);
          u_xlat3.xz = (((-float2(u_xlat2, u_xlat2)) * float2(0.497000009, 0.328000009)) + u_xlat3.yz);
          u_xlat2 = ((u_xlat2 * 0.291999996) + u_xlat3.y);
          u_xlat4_d.x = ((u_xlat3.x * u_xlat0_d.z) + u_xlat7.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat3.z);
          u_xlat0_d.x = ((u_xlat17 * u_xlat0_d.y) + u_xlat0_d.x);
          u_xlat4_d.y = ((u_xlat2 * u_xlat0_d.z) + u_xlat0_d.x);
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat4_d.xyz);
