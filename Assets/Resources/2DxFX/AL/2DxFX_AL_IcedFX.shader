  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb5 = (u_xlat16_2.x<0);
          if(((int(u_xlatb5) * (-1))!=0))
          {
              discard;
          }
          u_xlat5 = ((_Time.x * 22.5) + 1.10000002);
          u_xlat9 = (((-in_f.texcoord.x) * 5) + u_xlat5);
          u_xlat3.xyz = ((in_f.texcoord.xyy * float3(5, 5, 12.5)) + float3(u_xlat5, u_xlat5, u_xlat5));
          ...
          u_xlat16_9.x = dot(u_xlat10_0.xzy, float3(0.200000003, 0.200000003, 0.400000006));
          ...
          u_xlat16_0 = dot(u_xlat10_0.xyz, float3(0.212599993, 0.715200007, 0.0722000003));
          u_xlat4_d = ((-u_xlat12) + 1);
          u_xlat16_8 = (((-u_xlat16_0) * 0.115896732) + 1);
          u_xlat16_5 = (u_xlat16_0 * u_xlat16_0);
          u_xlat16_8 = ((u_xlat16_5 * 2.58329701) + u_xlat16_8);
          u_xlat16_3.xyz = float3(((float3(u_xlat16_0, u_xlat16_0, u_xlat16_0) * float3(0.616473019, 3.36968088, 0.0891224965)) + float3(0.860117733, 1, 0.317398727)));
          u_xlat16_9.xy = float2((float2(u_xlat16_0, u_xlat16_0) * float2(2.4000001, 1.5999999)));
          u_xlat16_9.xy = (u_xlat16_9.xy * u_xlat16_9.xy);
          u_xlat16_3.xyz = ((float3(u_xlat16_5, u_xlat16_5, u_xlat16_5) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat16_3.xyz);
          u_xlat16_0 = (u_xlat16_3.z / u_xlat16_8);
          u_xlat16_8 = (u_xlat16_3.x / u_xlat16_3.y);
          u_xlat16_5 = (u_xlat16_8 + u_xlat16_8);
          u_xlat0_d.z = (u_xlat16_8 * 3);
          u_xlat16_5 = (((-u_xlat16_0) * 8) + u_xlat16_5);
          u_xlat0_d.x = (u_xlat16_0 + u_xlat16_0);
          u_xlat16_5 = (u_xlat16_5 + 4);
          u_xlat0_d.xz = (u_xlat0_d.xz / float2(u_xlat16_5, u_xlat16_5));
          u_xlat5 = ((-u_xlat0_d.z) + 1);
          u_xlat5 = ((-u_xlat0_d.x) + u_xlat5);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat7.x = (u_xlat5 * u_xlat0_d.x);
          u_xlat7.y = (u_xlat0_d.z * u_xlat0_d.x);
          u_xlat0_d.xz = (u_xlat7.xy / float2(_Distortion, _Distortion));
          u_xlat3.yz = (u_xlat16_9.xy * u_xlat0_d.xz);
          u_xlat16_0 = (u_xlat16_9.y * u_xlat16_9.y);
          u_xlat16_0 = (u_xlat16_0 * u_xlat16_9.y);
          u_xlat3.x = (u_xlat16_0 * u_xlat3.y);
          u_xlat0_d.xyz = ((u_xlat3.xyz * float3(u_xlat12, u_xlat12, u_xlat12)) + float3(u_xlat4_d, u_xlat4_d, u_xlat4_d));
          ...
          u_xlat16_14 = dot(in_f.texcoord1.xyz, _WorldSpaceLightPos0.xyz);
          u_xlat16_14 = max(u_xlat16_14, 0);
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = (u_xlat16_0 * u_xlat16_9.y);
          u_xlat3.x = (u_xlat16_0 * u_xlat3.y);
          u_xlat0_d.xyz = ((u_xlat3.xyz * float3(u_xlat12, u_xlat12, u_xlat12)) + float3(u_xlat4, u_xlat4, u_xlat4));
          ...
          u_xlat16_2.xyz = (float3(u_xlat12, u_xlat12, u_xlat12) * _LightColor0.xyz);
          ...
          u_xlat16_14 = dot(in_f.texcoord1.xyz, u_xlat0_d.xyz);
          u_xlat16_14 = max(u_xlat16_14, 0);
          out_f.color.xyz = (float3(u_xlat16_14, u_xlat16_14, u_xlat16_14) * u_xlat16_2.xyz);
          return out_f;
      }
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat5 = clamp(u_xlat5, 0, 1);
          u_xlat5 = (u_xlat5 + u_xlat9);
          u_xlat12_d = ((u_xlat5 * u_xlat10_0.w) + (-_Alpha));
          u_xlat16_0 = dot(u_xlat10_0.xyz, float3(0.212599993, 0.715200007, 0.0722000003));
          u_xlat4 = ((-u_xlat12_d) + 1);
          u_xlat16_8 = (((-u_xlat16_0) * 0.115896732) + 1);
          u_xlat16_5 = (u_xlat16_0 * u_xlat16_0);
          u_xlat16_8 = ((u_xlat16_5 * 2.58329701) + u_xlat16_8);
          u_xlat16_3_d.xyz = float3(((float3(u_xlat16_0, u_xlat16_0, u_xlat16_0) * float3(0.616473019, 3.36968088, 0.0891224965)) + float3(0.860117733, 1, 0.317398727)));
          u_xlat16_9.xy = float2((float2(u_xlat16_0, u_xlat16_0) * float2(2.4000001, 1.5999999)));
          u_xlat16_9.xy = (u_xlat16_9.xy * u_xlat16_9.xy);
          u_xlat16_3_d.xyz = ((float3(u_xlat16_5, u_xlat16_5, u_xlat16_5) * float3(2.05825949, 11.3303223, 0.672770679)) + u_xlat16_3_d.xyz);
          u_xlat16_0 = (u_xlat16_3_d.z / u_xlat16_8);
          u_xlat16_8 = (u_xlat16_3_d.x / u_xlat16_3_d.y);
          u_xlat16_5 = (u_xlat16_8 + u_xlat16_8);
          u_xlat0_d.z = (u_xlat16_8 * 3);
          u_xlat16_5 = (((-u_xlat16_0) * 8) + u_xlat16_5);
          u_xlat0_d.x = (u_xlat16_0 + u_xlat16_0);
          ...
          u_xlat16_0 = (u_xlat16_0 * u_xlat16_9.y);
          u_xlat3.x = (u_xlat16_0 * u_xlat3.y);
          u_xlat0_d.xyz = ((u_xlat3.xyz * float3(u_xlat12_d, u_xlat12_d, u_xlat12_d)) + float3(u_xlat4, u_xlat4, u_xlat4));
          u_xlat0_d.xyz = (u_xlat1_d.xxx * u_xlat0_d.xyz);
          out_f.color.w = u_xlat1_d.x;
