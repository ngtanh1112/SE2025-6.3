Shader "2DxFX/AL/SkyCloud"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = ((in_f.texcoord.xy * float2(float2(_Zoom, _Zoom))) + float2(_OffsetX, _OffsetY));
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy);
          u_xlat0_d = (u_xlat10_0 * in_f.texcoord3);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat9 = ((u_xlat0_d.w * u_xlat10_1.w) + (-_Alpha));
          u_xlat0_d.xyz = (((-u_xlat0_d.xyz) * float3(_Intensity, _Intensity, _Intensity)) + u_xlat10_1.xyz);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = ((in_f.texcoord1.xy * float2(float2(_Zoom, _Zoom))) + float2(_OffsetX, _OffsetY));
          u_xlat10_0 = tex2D(_MainTex2, u_xlat0_d.xy).w;
          u_xlat0_d.x = (u_xlat10_0 * in_f.texcoord3.w);
