  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat4_d = ((u_xlat0_d.x * _OffsetY) + _WaveTimeY);
          u_xlat4_d = cos(u_xlat4_d);
          u_xlat0_d.y = ((u_xlat4_d * _DistanceY) + in_f.texcoord.y);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat6_d = ((u_xlat10_0.w * in_f.texcoord3.w) + (-_Alpha));
          ...
          u_xlat16_7 = (u_xlat6_d + (-0.0500000007));
          out_f.color.w = u_xlat6_d;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat9 = dot(u_xlat2_d.xyz, u_xlat2_d.xyz);
          u_xlat9 = tex2D(_LightTexture0, float2(u_xlat9, u_xlat9)).x;
          u_xlat16_1.xyz = (float3(u_xlat9, u_xlat9, u_xlat9) * _LightColor0.xyz);
          ...
          u_xlat16_10 = dot(in_f.texcoord1.xyz, u_xlat0_d.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat0_d.x = ((u_xlat0_d.x * _DistanceX) + in_f.texcoord.x);
          u_xlat6 = ((u_xlat0_d.x * _OffsetY) + _WaveTimeY);
          u_xlat6 = cos(u_xlat6);
          u_xlat0_d.y = ((u_xlat6 * _DistanceY) + in_f.texcoord.y);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat9 = ((u_xlat10_0.w * in_f.texcoord2.w) + (-_Alpha));
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord2.xyz);
          u_xlat0_d.xyz = (float3(u_xlat9, u_xlat9, u_xlat9) * u_xlat0_d.xyz);
          u_xlat16_1_d.x = (u_xlat9 + (-0.0500000007));
          out_f.color.w = u_xlat9;
          u_xlatb9 = (u_xlat16_1_d.x<0);
          if(((int(u_xlatb9) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = (u_xlat10_0.xyz * in_f.texcoord3.xyz);
          u_xlat0_d.xyz = (float3(u_xlat6_d, u_xlat6_d, u_xlat6_d) * u_xlat0_d.xyz);
          u_xlat16_1 = (u_xlat6_d + (-0.0500000007));
          u_xlatb6 = (u_xlat16_1<0);
          if(((int(u_xlatb6) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = ((in_f.texcoord1.y * _OffsetX) + _WaveTimeX);
          u_xlat0_d.x = sin(u_xlat0_d.x);
          u_xlat0_d.x = ((u_xlat0_d.x * _DistanceX) + in_f.texcoord1.x);
          u_xlat4 = ((u_xlat0_d.x * _OffsetY) + _WaveTimeY);
          u_xlat4 = cos(u_xlat4);
          u_xlat0_d.y = ((u_xlat4 * _DistanceY) + in_f.texcoord1.y);
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.w) + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d.x + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
