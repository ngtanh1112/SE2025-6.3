  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = (in_f.texcoord.xy * float2(1.29999995, 1.29999995));
          ...
          u_xlat2 = (((-u_xlat10_1) * in_f.texcoord3) + u_xlat0_d);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d = ((u_xlat0_d.wwww * u_xlat2) + u_xlat1_d);
          u_xlat12 = (u_xlat1_d.w * u_xlat0_d.w);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat12 * u_xlat1_d.x) + (-0.0500000007));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat1_d.xy = (in_f.texcoord.xy * float2(1.29999995, 1.29999995));
          u_xlat0_d = ((u_xlat1_d.xxxx * u_xlat0_d) + _Color1);
          u_xlat2_d = ((-_Color3) + _Color4);
          u_xlat2_d = ((u_xlat1_d.xxxx * u_xlat2_d) + _Color3);
          u_xlat0_d = (u_xlat0_d + (-u_xlat2_d));
          u_xlat0_d = ((u_xlat1_d.yyyy * u_xlat0_d) + u_xlat2_d);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2_d = (((-u_xlat10_1) * in_f.texcoord3) + u_xlat0_d);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord3);
          u_xlat0_d = ((u_xlat0_d.wwww * u_xlat2_d) + u_xlat1_d);
          u_xlat12 = (u_xlat1_d.w * u_xlat0_d.w);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat16_3.x = ((u_xlat12 * u_xlat1_d.x) + (-0.0500000007));
          u_xlat12 = (u_xlat12 * u_xlat1_d.x);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = ((-_Color1.w) + _Color2.w);
          u_xlat2.xy = (in_f.texcoord.xy * float2(1.29999995, 1.29999995));
          u_xlat0_d = ((u_xlat2.x * u_xlat0_d) + _Color1.w);
          u_xlat6_d = ((-_Color3.w) + _Color4.w);
          u_xlat2.x = ((u_xlat2.x * u_xlat6_d) + _Color3.w);
          u_xlat0_d = ((-u_xlat2.x) + u_xlat0_d);
          u_xlat0_d = ((u_xlat2.y * u_xlat0_d) + u_xlat2.x);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord.xy).w;
          u_xlat4_d = (((-u_xlat10_2) * in_f.texcoord3.w) + u_xlat0_d);
          u_xlat2.x = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d = ((u_xlat0_d * u_xlat4_d) + u_xlat2.x);
          u_xlat0_d = (u_xlat2.x * u_xlat0_d);
          u_xlat2.x = ((-_Alpha) + 1);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = ((u_xlat1_d.yyyy * u_xlat0_d) + u_xlat2);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2 = (((-u_xlat10_1) * in_f.texcoord2) + u_xlat0_d);
          u_xlat1_d = (u_xlat10_1 * in_f.texcoord2);
          u_xlat0_d = ((u_xlat0_d.wwww * u_xlat2) + u_xlat1_d);
          u_xlat12_d = (u_xlat1_d.w * u_xlat0_d.w);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat16_3_d.x = ((u_xlat12_d * u_xlat1_d.x) + (-0.0500000007));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat12 = (u_xlat1_d.w * u_xlat0_d.w);
          u_xlat1_d.x = ((-_Alpha) + 1);
          u_xlat16_3 = ((u_xlat12 * u_xlat1_d.x) + (-0.0500000007));
          u_xlat12 = (u_xlat12 * u_xlat1_d.x);
          u_xlat0_d.xyz = (float3(u_xlat12, u_xlat12, u_xlat12) * u_xlat0_d.xyz);
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = ((-_Color1.w) + _Color2.w);
          u_xlat2_d.xy = (in_f.texcoord1.xy * float2(1.29999995, 1.29999995));
          u_xlat0_d = ((u_xlat2_d.x * u_xlat0_d) + _Color1.w);
          u_xlat6 = ((-_Color3.w) + _Color4.w);
          u_xlat2_d.x = ((u_xlat2_d.x * u_xlat6) + _Color3.w);
          u_xlat0_d = ((-u_xlat2_d.x) + u_xlat0_d);
          u_xlat0_d = ((u_xlat2_d.y * u_xlat0_d) + u_xlat2_d.x);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord1.xy).w;
          u_xlat4 = (((-u_xlat10_2) * in_f.texcoord3.w) + u_xlat0_d);
          u_xlat2_d.x = (u_xlat10_2 * in_f.texcoord3.w);
          u_xlat0_d = ((u_xlat0_d * u_xlat4) + u_xlat2_d.x);
          u_xlat0_d = (u_xlat2_d.x * u_xlat0_d);
