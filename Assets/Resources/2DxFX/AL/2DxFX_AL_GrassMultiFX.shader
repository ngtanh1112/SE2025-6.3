  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlatb5 = (abs(u_xlat0_d.x)>=(-abs(u_xlat0_d.x)));
          ...
          u_xlat0_d = ((u_xlat10_0 * in_f.texcoord3) + float4(-0.194999993, (-0.194999993), (-0.194999993), (-0.00999999978)));
          u_xlat1_d = (in_f.texcoord.xyxy + float4(0.200000003, 0.00999999978, 0.400000006, 0.0199999996));
          u_xlat6_d.xz = (u_xlat1_d.yw / float2(_Distortion, _Distortion));
          u_xlat1_d.xy = ((u_xlat6_d.xz * float2(_Wind2, _Wind3)) + u_xlat1_d.xz);
          u_xlatb11.xy = bool4(abs(u_xlat1_d.xyxy) >= (-abs(u_xlat1_d.xyxy))).xy;
          u_xlat1_d.xy = frac(abs(u_xlat1_d.xy));
          float4 hlslcc_movcTemp = u_xlat1_d;
          hlslcc_movcTemp.x = (u_xlatb11.x)?(u_xlat1_d.x):((-u_xlat1_d.x));
          hlslcc_movcTemp.y = (u_xlatb11.y)?(u_xlat1_d.y):((-u_xlat1_d.y));
          ...
          u_xlat1_d = ((u_xlat10_1 * in_f.texcoord3) + float4(-0.0649999976, (-0.0649999976), (-0.0649999976), (-0.00999999978)));
          u_xlat2 = ((u_xlat10_2 * in_f.texcoord3) + float4(-0.129999995, (-0.129999995), (-0.129999995), (-0.00999999978)));
          u_xlat3 = ((-u_xlat2.w) + 1);
          ...
          u_xlat6_d.x = (u_xlat1_d.y / _Distortion);
          u_xlat1_d.x = ((u_xlat6_d.x * _Wind4) + u_xlat1_d.x);
          u_xlatb6 = (abs(u_xlat1_d.x)>=(-abs(u_xlat1_d.x)));
          u_xlat1_d.x = frac(abs(u_xlat1_d.x));
          u_xlat1_d.z = (u_xlatb6)?(u_xlat1_d.x):((-u_xlat1_d.x));
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.zw);
          u_xlat2 = ((u_xlat10_1 * in_f.texcoord3) + float4(0, 0, 0, (-0.00999999978)));
          u_xlat1_d.x = ((u_xlat10_1.w * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat2 = (u_xlat1_d.xxxx * u_xlat2);
          u_xlat1_d.x = ((-u_xlat1_d.x) + 1);
          u_xlat0_d = ((u_xlat0_d * u_xlat1_d.xxxx) + u_xlat2);
          u_xlat15 = (u_xlat0_d.w + (-_Alpha));
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          u_xlat16_4.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
          u_xlat16_19 = (u_xlat15 + (-0.0500000007));
          out_f.color.w = u_xlat15;
          u_xlatb0 = (u_xlat16_19<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.yw);
          u_xlat1_d = ((u_xlat10_1 * in_f.texcoord3) + float4(-0.0649999976, (-0.0649999976), (-0.0649999976), (-0.00999999978)));
          u_xlat2_d = ((u_xlat10_2 * in_f.texcoord3) + float4(-0.129999995, (-0.129999995), (-0.129999995), (-0.00999999978)));
          u_xlat3 = ((-u_xlat2_d.w) + 1);
          u_xlat2_d = (u_xlat2_d.wwww * u_xlat2_d);
          u_xlat0_d = ((u_xlat0_d * float4(u_xlat3, u_xlat3, u_xlat3, u_xlat3)) + u_xlat2_d);
          u_xlat2_d.x = ((-u_xlat1_d.w) + 1);
          u_xlat1_d = (u_xlat1_d.wwww * u_xlat1_d);
          u_xlat0_d = ((u_xlat0_d * u_xlat2_d.xxxx) + u_xlat1_d);
          u_xlat1_d.xyw = (in_f.texcoord.xyy + float3(0.600000024, 0.0299999993, 0.0299999993));
          u_xlat6_d.x = (u_xlat1_d.y / _Distortion);
          u_xlat1_d.x = ((u_xlat6_d.x * _Wind4) + u_xlat1_d.x);
          u_xlatb6 = (abs(u_xlat1_d.x)>=(-abs(u_xlat1_d.x)));
          ...
          u_xlat1_d.z = (u_xlatb6)?(u_xlat1_d.x):((-u_xlat1_d.x));
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.zw);
          u_xlat2_d = ((u_xlat10_1 * in_f.texcoord3) + float4(0, 0, 0, (-0.00999999978)));
          u_xlat1_d.x = ((u_xlat10_1.w * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat2_d = (u_xlat1_d.xxxx * u_xlat2_d);
          u_xlat1_d.x = ((-u_xlat1_d.x) + 1);
          u_xlat0_d = ((u_xlat0_d * u_xlat1_d.xxxx) + u_xlat2_d);
          u_xlat15 = (u_xlat0_d.w + (-_Alpha));
          u_xlat0_d.xyz = (float3(u_xlat15, u_xlat15, u_xlat15) * u_xlat0_d.xyz);
          u_xlat16_4.x = (u_xlat15 + (-0.0500000007));
          out_f.color.w = u_xlat15;
          u_xlatb15 = (u_xlat16_4.x<0);
          if(((int(u_xlatb15) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.x = (in_f.texcoord.y / _Distortion);
          u_xlat0_d.x = ((u_xlat0_d.x * _Wind) + in_f.texcoord.x);
          u_xlatb3 = (abs(u_xlat0_d.x)>=(-abs(u_xlat0_d.x)));
          u_xlat0_d.x = frac(abs(u_xlat0_d.x));
          u_xlat0_d.x = (u_xlatb3)?(u_xlat0_d.x):((-u_xlat0_d.x));
          u_xlat0_d.y = in_f.texcoord.y;
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat1_d = (in_f.texcoord.xyxy + float4(0.200000003, 0.00999999978, 0.400000006, 0.0199999996));
          u_xlat3.xy = (u_xlat1_d.yw / float2(_Distortion, _Distortion));
          u_xlat3.xy = ((u_xlat3.xy * float2(_Wind2, _Wind3)) + u_xlat1_d.xz);
          u_xlatb1.xy = bool4(abs(u_xlat3.xyxx) >= (-abs(u_xlat3.xyxx))).xy;
          u_xlat3.xy = frac(abs(u_xlat3.xy));
          u_xlat1_d.x = (u_xlatb1.x)?(u_xlat3.x):((-u_xlat3.x));
          u_xlat1_d.y = (u_xlatb1.y)?(u_xlat3.y):((-u_xlat3.y));
          u_xlat1_d.zw = (in_f.texcoord.yy + float2(0.00999999978, 0.0199999996));
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.xz).w;
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.yw).w;
          u_xlat6_d = ((u_xlat10_6 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat3.x = ((u_xlat10_3 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat9 = ((-u_xlat3.x) + 1);
          u_xlat3.x = (u_xlat3.x * u_xlat3.x);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat9) + u_xlat3.x);
          u_xlat3.x = ((-u_xlat6_d) + 1);
          u_xlat6_d = (u_xlat6_d * u_xlat6_d);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat3.x) + u_xlat6_d);
          u_xlat1_d.xyw = (in_f.texcoord.xyy + float3(0.600000024, 0.0299999993, 0.0299999993));
          u_xlat3.x = (u_xlat1_d.y / _Distortion);
          u_xlat3.x = ((u_xlat3.x * _Wind4) + u_xlat1_d.x);
          u_xlatb6 = (abs(u_xlat3.x)>=(-abs(u_xlat3.x)));
          u_xlat3.x = frac(abs(u_xlat3.x));
          u_xlat1_d.z = (u_xlatb6)?(u_xlat3.x):((-u_xlat3.x));
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.zw).w;
          u_xlat3.x = ((u_xlat10_3 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat6_d = ((-u_xlat3.x) + 1);
          u_xlat3.x = (u_xlat3.x * u_xlat3.x);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat6_d) + u_xlat3.x);
          u_xlat0_d.x = (u_xlat0_d.x + (-_Alpha));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.y = in_f.texcoord.y;
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy);
          u_xlat0_d = ((u_xlat10_0 * in_f.texcoord2) + float4(-0.194999993, (-0.194999993), (-0.194999993), (-0.00999999978)));
          u_xlat1_d = (in_f.texcoord.xyxy + float4(0.200000003, 0.00999999978, 0.400000006, 0.0199999996));
          u_xlat6.xz = (u_xlat1_d.yw / float2(_Distortion, _Distortion));
          u_xlat1_d.xy = ((u_xlat6.xz * float2(_Wind2, _Wind3)) + u_xlat1_d.xz);
          u_xlatb11.xy = bool4(abs(u_xlat1_d.xyxy) >= (-abs(u_xlat1_d.xyxy))).xy;
          u_xlat1_d.xy = frac(abs(u_xlat1_d.xy));
          float4 hlslcc_movcTemp = u_xlat1_d;
          hlslcc_movcTemp.x = (u_xlatb11.x)?(u_xlat1_d.x):((-u_xlat1_d.x));
          ...
          u_xlat10_2 = tex2D(_MainTex, u_xlat1_d.xz);
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.yw);
          u_xlat1_d = ((u_xlat10_1 * in_f.texcoord2) + float4(-0.0649999976, (-0.0649999976), (-0.0649999976), (-0.00999999978)));
          u_xlat2 = ((u_xlat10_2 * in_f.texcoord2) + float4(-0.129999995, (-0.129999995), (-0.129999995), (-0.00999999978)));
          u_xlat3 = ((-u_xlat2.w) + 1);
          u_xlat2 = (u_xlat2.wwww * u_xlat2);
          u_xlat0_d = ((u_xlat0_d * float4(u_xlat3, u_xlat3, u_xlat3, u_xlat3)) + u_xlat2);
          u_xlat2.x = ((-u_xlat1_d.w) + 1);
          ...
          u_xlat0_d = ((u_xlat0_d * u_xlat2.xxxx) + u_xlat1_d);
          u_xlat1_d.xyw = (in_f.texcoord.xyy + float3(0.600000024, 0.0299999993, 0.0299999993));
          u_xlat6.x = (u_xlat1_d.y / _Distortion);
          u_xlat1_d.x = ((u_xlat6.x * _Wind4) + u_xlat1_d.x);
          u_xlatb6 = (abs(u_xlat1_d.x)>=(-abs(u_xlat1_d.x)));
          u_xlat1_d.x = frac(abs(u_xlat1_d.x));
          u_xlat1_d.z = (u_xlatb6)?(u_xlat1_d.x):((-u_xlat1_d.x));
          u_xlat10_1 = tex2D(_MainTex, u_xlat1_d.zw);
          u_xlat2 = ((u_xlat10_1 * in_f.texcoord2) + float4(0, 0, 0, (-0.00999999978)));
          u_xlat1_d.x = ((u_xlat10_1.w * in_f.texcoord2.w) + (-0.00999999978));
          u_xlat2 = (u_xlat1_d.xxxx * u_xlat2);
          u_xlat1_d.x = ((-u_xlat1_d.x) + 1);
          u_xlat0_d = ((u_xlat0_d * u_xlat1_d.xxxx) + u_xlat2);
          u_xlat15 = (u_xlat0_d.w + (-_Alpha));
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.x = (in_f.texcoord1.y / _Distortion);
          u_xlat0_d.x = ((u_xlat0_d.x * _Wind) + in_f.texcoord1.x);
          u_xlatb3 = (abs(u_xlat0_d.x)>=(-abs(u_xlat0_d.x)));
          u_xlat0_d.x = frac(abs(u_xlat0_d.x));
          u_xlat0_d.x = (u_xlatb3)?(u_xlat0_d.x):((-u_xlat0_d.x));
          u_xlat0_d.y = in_f.texcoord1.y;
          u_xlat10_0 = tex2D(_MainTex, u_xlat0_d.xy).w;
          u_xlat0_d.x = ((u_xlat10_0 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat1_d = (in_f.texcoord1.xyxy + float4(0.200000003, 0.00999999978, 0.400000006, 0.0199999996));
          u_xlat3_d.xy = (u_xlat1_d.yw / float2(_Distortion, _Distortion));
          u_xlat3_d.xy = ((u_xlat3_d.xy * float2(_Wind2, _Wind3)) + u_xlat1_d.xz);
          u_xlatb1.xy = bool4(abs(u_xlat3_d.xyxx) >= (-abs(u_xlat3_d.xyxx))).xy;
          u_xlat3_d.xy = frac(abs(u_xlat3_d.xy));
          u_xlat1_d.x = (u_xlatb1.x)?(u_xlat3_d.x):((-u_xlat3_d.x));
          u_xlat1_d.y = (u_xlatb1.y)?(u_xlat3_d.y):((-u_xlat3_d.y));
          u_xlat1_d.zw = (in_f.texcoord1.yy + float2(0.00999999978, 0.0199999996));
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.xz).w;
          u_xlat10_6 = tex2D(_MainTex, u_xlat1_d.yw).w;
          u_xlat6 = ((u_xlat10_6 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat3_d.x = ((u_xlat10_3 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat9_d = ((-u_xlat3_d.x) + 1);
          u_xlat3_d.x = (u_xlat3_d.x * u_xlat3_d.x);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat9_d) + u_xlat3_d.x);
          u_xlat3_d.x = ((-u_xlat6) + 1);
          u_xlat6 = (u_xlat6 * u_xlat6);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat3_d.x) + u_xlat6);
          u_xlat1_d.xyw = (in_f.texcoord1.xyy + float3(0.600000024, 0.0299999993, 0.0299999993));
          u_xlat3_d.x = (u_xlat1_d.y / _Distortion);
          u_xlat3_d.x = ((u_xlat3_d.x * _Wind4) + u_xlat1_d.x);
          u_xlatb6 = (abs(u_xlat3_d.x)>=(-abs(u_xlat3_d.x)));
          u_xlat3_d.x = frac(abs(u_xlat3_d.x));
          u_xlat1_d.z = (u_xlatb6)?(u_xlat3_d.x):((-u_xlat3_d.x));
          u_xlat10_3 = tex2D(_MainTex, u_xlat1_d.zw).w;
          u_xlat3_d.x = ((u_xlat10_3 * in_f.texcoord3.w) + (-0.00999999978));
          u_xlat6 = ((-u_xlat3_d.x) + 1);
          u_xlat3_d.x = (u_xlat3_d.x * u_xlat3_d.x);
          u_xlat0_d.x = ((u_xlat0_d.x * u_xlat6) + u_xlat3_d.x);
          u_xlat0_d.x = (u_xlat0_d.x + (-_Alpha));
          u_xlat16_2 = (u_xlat0_d.x + (-0.0500000007));
          u_xlatb0 = (u_xlat16_2<0);
          if(((int(u_xlatb0) * (-1))!=0))
