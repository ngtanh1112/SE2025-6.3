  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = ((-_Value2) + _Value1);
          u_xlat0_d.x = ((-u_xlat6_d.x) + u_xlat0_d.x);
          u_xlat6_d.x = ((-u_xlat6_d.x) + in_f.texcoord.x);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat6_d.x);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat6_d.x = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat6_d.x);
          u_xlat6_d.x = (in_f.texcoord.x + (-0.0500000007));
          u_xlat6_d.x = (u_xlat6_d.x * 5);
          u_xlat6_d.x = clamp(u_xlat6_d.x, 0, 1);
          u_xlat12 = ((u_xlat6_d.x * (-2)) + 3);
          u_xlat6_d.x = (u_xlat6_d.x * u_xlat6_d.x);
          u_xlat6_d.x = (u_xlat6_d.x * u_xlat12);
          u_xlat6_d.x = (u_xlat6_d.x * _Value1);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2.xyz = (((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + float3(1, 0, 0));
          u_xlat3 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat2.xyz = ((float3(_Value4, _Value4, _Value4) * u_xlat2.xyz) + u_xlat3.xyz);
          u_xlat4_d.xyz = ((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat2.xyz));
          u_xlat6_d.xyz = ((u_xlat6_d.xxx * u_xlat4_d.xyz) + u_xlat2.xyz);
          u_xlat2.xyz = ((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat6_d.xyz));
          u_xlat3.xyz = ((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2.xyz) + u_xlat6_d.xyz);
          u_xlat6_d.x = ((-_Value5) + 1);
          u_xlat2.w = (-u_xlat6_d.x);
          u_xlat2.xyz = float3((-float3(_Value3, _Value3, _Value3)));
          u_xlat1_d = ((u_xlat10_1 * in_f.texcoord3) + u_xlat2);
          u_xlat1_d = ((-u_xlat3) + u_xlat1_d);
          u_xlat0_d = ((u_xlat0_d.xxxx * u_xlat1_d) + u_xlat3);
          u_xlat18 = (u_xlat0_d.w + (-_Alpha));
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat0_d.xyz);
          u_xlat16_5.xyz = (u_xlat0_d.xyz * _LightColor0.xyz);
          u_xlat16_23 = (u_xlat18 + (-0.0500000007));
          out_f.color.w = u_xlat18;
          u_xlatb0 = (u_xlat16_23<0);
          if(((int(u_xlatb0) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6_d.x = (u_xlat6_d.x * _Value1);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2_d.xyz = (((-u_xlat10_1.xyz) * in_f.texcoord3.xyz) + float3(1, 0, 0));
          u_xlat3 = (u_xlat10_1 * in_f.texcoord3);
          u_xlat2_d.xyz = ((float3(_Value4, _Value4, _Value4) * u_xlat2_d.xyz) + u_xlat3.xyz);
          u_xlat4.xyz = ((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat2_d.xyz));
          u_xlat6_d.xyz = ((u_xlat6_d.xxx * u_xlat4.xyz) + u_xlat2_d.xyz);
          u_xlat2_d.xyz = ((u_xlat10_1.xyz * in_f.texcoord3.xyz) + (-u_xlat6_d.xyz));
          u_xlat3.xyz = ((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2_d.xyz) + u_xlat6_d.xyz);
          u_xlat6_d.x = ((-_Value5) + 1);
          u_xlat2_d.w = (-u_xlat6_d.x);
          u_xlat2_d.xyz = float3((-float3(_Value3, _Value3, _Value3)));
          u_xlat1_d = ((u_xlat10_1 * in_f.texcoord3) + u_xlat2_d);
          u_xlat1_d = ((-u_xlat3) + u_xlat1_d);
          u_xlat0_d = ((u_xlat0_d.xxxx * u_xlat1_d) + u_xlat3);
          u_xlat18 = (u_xlat0_d.w + (-_Alpha));
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat0_d.xyz);
          u_xlat16_5.x = (u_xlat18 + (-0.0500000007));
          out_f.color.w = u_xlat18;
          u_xlatb18 = (u_xlat16_5.x<0);
    ...
    Pass // ind: 3, name: PREPASS
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = (_Value2 + _Value1);
          u_xlat2 = ((-_Value2) + _Value1);
          u_xlat0_d = ((-u_xlat2) + u_xlat0_d);
          u_xlat2 = ((-u_xlat2) + in_f.texcoord.x);
          ...
          u_xlat0_d = ((u_xlat10_2 * in_f.texcoord3.w) + u_xlat0_d);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat6.x = ((-u_xlat6.x) + in_f.texcoord.x);
          u_xlat0_d.x = (float(1) / u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat6.x);
          u_xlat0_d.x = clamp(u_xlat0_d.x, 0, 1);
          u_xlat6.x = ((u_xlat0_d.x * (-2)) + 3);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat0_d.x);
          u_xlat0_d.x = (u_xlat0_d.x * u_xlat6.x);
          u_xlat6.x = (in_f.texcoord.x + (-0.0500000007));
          u_xlat6.x = (u_xlat6.x * 5);
          u_xlat6.x = clamp(u_xlat6.x, 0, 1);
          u_xlat12_d = ((u_xlat6.x * (-2)) + 3);
          u_xlat6.x = (u_xlat6.x * u_xlat6.x);
          u_xlat6.x = (u_xlat6.x * u_xlat12_d);
          u_xlat6.x = (u_xlat6.x * _Value1);
          u_xlat10_1 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat2.xyz = (((-u_xlat10_1.xyz) * in_f.texcoord2.xyz) + float3(1, 0, 0));
          u_xlat3 = (u_xlat10_1 * in_f.texcoord2);
          u_xlat2.xyz = ((float3(_Value4, _Value4, _Value4) * u_xlat2.xyz) + u_xlat3.xyz);
          u_xlat4.xyz = ((u_xlat10_1.xyz * in_f.texcoord2.xyz) + (-u_xlat2.xyz));
          u_xlat6.xyz = ((u_xlat6.xxx * u_xlat4.xyz) + u_xlat2.xyz);
          u_xlat2.xyz = ((u_xlat10_1.xyz * in_f.texcoord2.xyz) + (-u_xlat6.xyz));
          u_xlat3.xyz = ((float3(float3(_Value1, _Value1, _Value1)) * u_xlat2.xyz) + u_xlat6.xyz);
          u_xlat6.x = ((-_Value5) + 1);
          u_xlat2.w = (-u_xlat6.x);
          u_xlat2.xyz = float3((-float3(_Value3, _Value3, _Value3)));
          u_xlat1_d = ((u_xlat10_1 * in_f.texcoord2) + u_xlat2);
          u_xlat1_d = ((-u_xlat3) + u_xlat1_d);
          u_xlat0_d = ((u_xlat0_d.xxxx * u_xlat1_d) + u_xlat3);
          u_xlat18 = (u_xlat0_d.w + (-_Alpha));
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat0_d.xyz);
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat18 = (u_xlat0_d.w + (-_Alpha));
          u_xlat0_d.xyz = (float3(u_xlat18, u_xlat18, u_xlat18) * u_xlat0_d.xyz);
          u_xlat16_5 = (u_xlat18 + (-0.0500000007));
          u_xlatb18 = (u_xlat16_5<0);
          if(((int(u_xlatb18) * (-1))!=0))
          {
              discard;
          }
    ...
    Pass // ind: 6, name: ShadowCaster
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          u_xlat0_d = (_Value2 + _Value1);
          u_xlat2_d = ((-_Value2) + _Value1);
          u_xlat0_d = ((-u_xlat2_d) + u_xlat0_d);
          u_xlat2_d = ((-u_xlat2_d) + in_f.texcoord1.x);
          u_xlat0_d = (float(1) / u_xlat0_d);
          u_xlat0_d = (u_xlat0_d * u_xlat2_d);
          u_xlat0_d = clamp(u_xlat0_d, 0, 1);
          u_xlat2_d = ((u_xlat0_d * (-2)) + 3);
          u_xlat0_d = (u_xlat0_d * u_xlat0_d);
          u_xlat0_d = (u_xlat0_d * u_xlat2_d);
          u_xlat2_d = ((-_Value5) + 1);
          u_xlat0_d = ((-u_xlat2_d) * u_xlat0_d);
          u_xlat10_2 = tex2D(_MainTex, in_f.texcoord1.xy).w;
          u_xlat0_d = ((u_xlat10_2 * in_f.texcoord3.w) + u_xlat0_d);
          u_xlat0_d = (u_xlat0_d + (-_Alpha));
          u_xlat16_1 = (u_xlat0_d + (-0.0500000007));
          u_xlatb0 = (u_xlat16_1<0);
