  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_2.x = ((u_xlat1_d.w * in_f.texcoord3.w) + (-0.0500000007));
          u_xlatb12 = (u_xlat16_2.x<0);
          if(((int(u_xlatb12) * (-1))!=0))
          {
              discard;
          }
          u_xlat12 = dot(in_f.texcoord.xy, float2(12.9898005, 78.2330017));
          u_xlat12 = sin(u_xlat12);
          u_xlat12 = (u_xlat12 * 43758.5469);
          u_xlat3.x = (_Time.x + 1);
          u_xlat12 = (u_xlat12 * u_xlat3.x);
          u_xlat12 = frac(u_xlat12);
          u_xlat3.xyz = ((-u_xlat10_0.xyz) + float3(u_xlat12, u_xlat12, u_xlat12));
          u_xlat1_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat3.xyz) + u_xlat10_0.xyz);
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat10_0 = tex2D(_MainTex, in_f.texcoord.xy);
          u_xlat1_d.w = (u_xlat10_0.w + (-_Alpha));
          u_xlat16_2_d.x = ((u_xlat1_d.w * in_f.texcoord2.w) + (-0.0500000007));
          u_xlatb12 = (u_xlat16_2_d.x<0);
          if(((int(u_xlatb12) * (-1))!=0))
          {
              discard;
          }
          u_xlat12_d = dot(in_f.texcoord.xy, float2(12.9898005, 78.2330017));
          u_xlat12_d = sin(u_xlat12_d);
          u_xlat12_d = (u_xlat12_d * 43758.5469);
          u_xlat3.x = (_Time.x + 1);
          u_xlat12_d = (u_xlat12_d * u_xlat3.x);
          u_xlat12_d = frac(u_xlat12_d);
          u_xlat3.xyz = ((-u_xlat10_0.xyz) + float3(u_xlat12_d, u_xlat12_d, u_xlat12_d));
          u_xlat1_d.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat3.xyz) + u_xlat10_0.xyz);
