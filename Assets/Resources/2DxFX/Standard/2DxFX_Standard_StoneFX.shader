Shader "2DxFX/Standard/StoneFX"
{
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      {
          OUT_Data_Frag out_f;
          u_xlat0_d.xy = (((-in_f.texcoord.xy) * float2(30, 30)) + float2(46.0999985, 46.0999985));
          ...
          u_xlat0_d.xy = (u_xlat1_d.yx + u_xlat0_d.xy);
          u_xlat0_d.xy = (u_xlat1_d.zw + u_xlat0_d.xy);
          u_xlat0_d.xy = (u_xlat0_d.xy + float2(5, 5));
          u_xlat4.xy = (u_xlat0_d.xy * float2(0.200000003, 0.200000003));
          u_xlat4.xy = floor(u_xlat4.xy);
          u_xlat0_d.xy = ((u_xlat0_d.xy * float2(0.200000003, 0.200000003)) + (-u_xlat4.xy));
          ...
          u_xlat10_1.xyz = tex2D(_MainTex, in_f.texcoord.yx).xyz;
          u_xlat16_4 = dot(u_xlat10_1.xyz, float3(11.1999998, 8.39999962, 4.19999981));
          ...
          u_xlat1_d.y = 0;
          u_xlat2.xy = (u_xlat1_d.xy + in_f.texcoord.xy);
          ...
          u_xlatb4 = (0.600000024<u_xlat2.x);
          u_xlat2.x = (u_xlatb4)?(0.600000024):(u_xlat2.x);
          u_xlatb4 = (u_xlat2.x<0.200000003);
          u_xlat2.x = (u_xlatb4)?(0.200000003):(u_xlat2.x);
          u_xlat0_d.x = (((-u_xlat0_d.x) * 0.125) + u_xlat2.x);
          u_xlat0_d.xyz = ((-u_xlat10_1.xyz) + u_xlat0_d.xxx);
          out_f.color.xyz = ((float3(_Distortion, _Distortion, _Distortion) * u_xlat0_d.xyz) + u_xlat10_1.xyz);
